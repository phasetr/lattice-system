...
expect_pass vocabulary-policy "$ROOT/scripts/check-policy.sh" "$ROOT/fixtures/policy-future-phase"
...
expect_pass vocabulary-base-snapshot-registry "$ROOT/scripts/check-registry.sh" "$ROOT/fixtures/base-diff/vocabulary-base"
expect_pass vocabulary-good-snapshot-registry "$ROOT/scripts/check-registry.sh" "$ROOT/fixtures/base-diff/vocabulary-good"
expect_pass vocabulary-type-regression-snapshot-registry "$ROOT/scripts/check-registry.sh" "$ROOT/fixtures/base-diff/vocabulary-type-regression"
...
expect_pass vocabulary-type-freeze "$ROOT/scripts/check-base-diff.sh" --fixture-dirs "$ROOT/fixtures/base-diff/vocabulary-base" "$ROOT/fixtures/base-diff/vocabulary-good"
expect_fail vocabulary-type-only-drift --diagnostic "vocabulary type OID regressed" "$ROOT/scripts/check-base-diff.sh" --fixture-dirs "$ROOT/fixtures/base-diff/vocabulary-good" "$ROOT/fixtures/base-diff/vocabulary-type-regression"
