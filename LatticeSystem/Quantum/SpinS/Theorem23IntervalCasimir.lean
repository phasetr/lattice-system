...
import LatticeSystem.Quantum.SpinS.Theorem23DominancePredictedCasimirTransfer
import LatticeSystem.Quantum.SpinS.Theorem23LocalCoefficient

/-!
# Tasaki §2.5 Theorem 2.3 interval Casimir API

This module contains the dominance-form predicted-Casimir interval-chain
wrappers split from `Theorem23Interval.lean`. The direct lowered site-sum
