...
/-!
# `−8 · ⟨Φ_Néel⟩.re = (|Λ|·N)² − (2·‖biw‖)²` unconditionally

Combines PR #3256 + PR #3201 (`−2·⟨Φ_Néel⟩.re = gap.re`).
...
/-- **`−8·⟨Φ_Néel⟩.re = (|Λ|·N)² − (2·‖biw‖)²`** unconditionally. -/
theorem heisenbergToyHamiltonianS_neg_eight_neel_expectation_re_eq_card_sq_sub_two_biw_norm_sq
