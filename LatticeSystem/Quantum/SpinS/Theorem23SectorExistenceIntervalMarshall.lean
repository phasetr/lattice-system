...
/-!
# Tasaki §2.5 Theorem 2.3 lowered-Marshall predicted-GS interval chain

This module contains the lowered-vector-Marshall predicted-GS energy interval
chain, split as a stable suffix from `Theorem23SectorExistenceInterval.lean`.
The parent module keeps the off-`A`/on-`A` dominance and lowered-site-sum
predicted-GS interval chains; this Marshall-form chain reuses the
lowered-site-sum chain.
