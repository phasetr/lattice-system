...
/-!
# Tasaki §2.5 Theorem 2.3 outside-ground conditional wrappers

This module contains the conditional left-endpoint predicted-GS final-wrapper
suffix split from `Theorem23OutsideGround.lean`. The base outside-ground module
keeps the outside-sector lower-bound callbacks, sector-minimality bridge, and
common-energy final packaging, while this module packages the older
canonical-orientation conditional boundaries.
