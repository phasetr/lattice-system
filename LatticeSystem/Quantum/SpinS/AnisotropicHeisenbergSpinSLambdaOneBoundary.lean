...
import LatticeSystem.Quantum.SpinS.AnisotropicHeisenbergSpinSLambdaOneBoundaryCore
...
theorem anisotropicHeisenbergS_eigenspace_finrank_le_two_at_global_min_path_lambda_one_D_pos_general
  ...
  obtain ⟨c, hc⟩ :=
    exists_strict_diag_bound_dressedAxisSwappedAnisotropicHeisenbergSReMatrix A J 1 D_t N
  have hraw :=
    anisotropicHeisenbergS_eigenspace_finrank_le_two_at_global_min_lambda_one_D_pos_general
      ...
      hc hA_ne hB_ne hN hJ_star hD_t_star
  rw [hfst]
