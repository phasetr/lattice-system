...
the site-sum and Casimir-nonvanishing common-energy links. This module keeps
the adjacent common-energy successor steps; the predecessor (raising-direction)
common-energy steps are split into
`Theorem23CommonEnergyPredecessor.lean`.
