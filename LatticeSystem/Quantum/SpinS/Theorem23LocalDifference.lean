...
of `Theorem23LocalCoefficient.lean`. The lowered site-sum dominance layer
is isolated in `Theorem23LocalDifferenceSiteSum.lean`, the
raising-direction site-sum layer is isolated in
`Theorem23LocalDifferenceRaising.lean`, and the final
