...
/-!
# Tasaki §2.5 Theorem 2.3 unpacked joint interval-chain wrapper

This module contains the unpacked lowered-joint cross-ladder predicted-GS
interval-chain wrapper, split as a stable suffix from
`Theorem23IntervalJoint.lean`. The parent joint interval-chain module keeps
the joint sublattice-component, lowered-joint magSubspace-component, and
lowered-joint cross-ladder-component wrappers. Splitting the unpacked variant
out lets the parent elaborate without replaying it.
