...
/-!
# `4·gap.re = (|Λ|·N)² − (2·biw.re)²` unconditionally

Real-axis variant of PR #3256 using PR #3294 (`‖biw‖ = |biw.re|`).
...
/-- **`4·gap.re = (|Λ|·N)² − (2·biw.re)²`** unconditionally. -/
theorem heisenbergToyHamiltonianS_four_variational_gap_re_eq_card_sq_sub_two_biw_re_sq
  ...
  have h_norm := heisenbergToyHamiltonianS_four_variational_gap_re_eq_card_sq_sub_two_biw_norm_sq
    (Λ := Λ) (A := A) (N := N)
