...
Dual companion of PR #3176 (`(pmA).re ≤ avg ↔ |A| ≤ |¬A| ∨ N = 0`).
Combines PR #3157 (`(pmA).re − avg = biw.re`) with PR #3155
(`0 ≤ biw.re ↔ |¬A| ≤ |A| ∨ N = 0`):
...
theorem bipartiteToyMinEnergyPredicted_re_ge_avg_complement_re_iff_uncond
    (A : Λ → Bool) (N : ℕ) :
