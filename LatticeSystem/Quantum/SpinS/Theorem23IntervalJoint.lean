...
This module contains the joint-component, lowered-joint, and cross-ladder
interval-chain wrappers split from `Theorem23Interval.lean`. Keeping this
suffix separate lets the basic interval-chain wrappers elaborate without
replaying the later cross-ladder API layer. The unpacked lowered-joint
cross-ladder wrapper is split further into
`Theorem23IntervalJointUnpacked.lean`.
-/
