...
/-- **Spin-231/2 trimer ground-state energy** (γ-5 step 1681):
`singleClusterGSEnergyS 2 231 = -26796 = -S(1+zS)` for `S = 231/2, z = 2`. -/
@[simp] theorem singleClusterGSEnergyS_two_twohundredthirtyone :
    singleClusterGSEnergyS 2 231 = (-26796 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-231/2 trimer maximum-Casimir-sector energy** (γ-5 step 1681):
`singleClusterMaxEnergyS 2 231 = 53361/2 = zS²` for `S = 231/2, z = 2`. -/
@[simp] theorem singleClusterMaxEnergyS_two_twohundredthirtyone :
    singleClusterMaxEnergyS 2 231 = (53361 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-231/2 quartet ground-state energy** (γ-5 step 1682):
`singleClusterGSEnergyS 3 231 = -160545/4 = -S(1+zS)` for `S = 231/2, z = 3`. -/
@[simp] theorem singleClusterGSEnergyS_three_twohundredthirtyone :
    singleClusterGSEnergyS 3 231 = (-160545 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-231/2 quartet maximum-Casimir-sector energy** (γ-5 step 1682):
`singleClusterMaxEnergyS 3 231 = 160083/4 = zS²` for `S = 231/2, z = 3`. -/
@[simp] theorem singleClusterMaxEnergyS_three_twohundredthirtyone :
    singleClusterMaxEnergyS 3 231 = (160083 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-231/2 pentamer ground-state energy** (γ-5 step 1683):
`singleClusterGSEnergyS 4 231 = -106953/2 = -S(1+zS)` for `S = 231/2, z = 4`. -/
@[simp] theorem singleClusterGSEnergyS_four_twohundredthirtyone :
    singleClusterGSEnergyS 4 231 = (-106953 / 2 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-231/2 pentamer maximum-Casimir-sector energy** (γ-5 step 1683):
`singleClusterMaxEnergyS 4 231 = 53361 = zS²` for `S = 231/2, z = 4`. -/
@[simp] theorem singleClusterMaxEnergyS_four_twohundredthirtyone :
    singleClusterMaxEnergyS 4 231 = (53361 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-231/2 hexamer ground-state energy** (γ-5 step 1684):
`singleClusterGSEnergyS 5 231 = -267267/4 = -S(1+zS)` for `S = 231/2, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_twohundredthirtyone :
    singleClusterGSEnergyS 5 231 = (-267267 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-231/2 hexamer maximum-Casimir-sector energy** (γ-5 step 1684):
`singleClusterMaxEnergyS 5 231 = 266805/4 = zS²` for `S = 231/2, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_twohundredthirtyone :
    singleClusterMaxEnergyS 5 231 = (266805 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-231/2 heptamer ground-state energy** (γ-5 step 1685):
`singleClusterGSEnergyS 6 231 = -80157 = -S(1+zS)` for `S = 231/2, z = 6`. -/
@[simp] theorem singleClusterGSEnergyS_six_twohundredthirtyone :
    singleClusterGSEnergyS 6 231 = (-80157 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-231/2 heptamer maximum-Casimir-sector energy** (γ-5 step 1685):
`singleClusterMaxEnergyS 6 231 = 160083/2 = zS²` for `S = 231/2, z = 6`. -/
@[simp] theorem singleClusterMaxEnergyS_six_twohundredthirtyone :
    singleClusterMaxEnergyS 6 231 = (160083 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring
