...
/-- **`(2·biw.re)² ≤ (|Λ|·N)²`** unconditionally. Doubled form of PR #3319. -/
theorem bipartiteImbalanceWeight_two_re_sq_le_card_sq
    [Nonempty Λ] (A : Λ → Bool) (N : ℕ) :
    (2 * (bipartiteImbalanceWeight (Λ := Λ) A N).re) ^ 2 ≤
