...
/-!
# Tasaki §2.5 Theorem 2.3 dominance predicted-Casimir transfer API

This module contains the successor predicted-Casimir transfer wrappers split
from `Theorem23Dominance.lean`. The base dominance module keeps the direct
dominance-to-common-energy wrappers, while this module packages the additional
fact that the successor representative keeps the predicted total-Casimir
identity.
