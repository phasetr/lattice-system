...
/-!
# Tasaki §2.5 Theorem 2.3 interval-Casimir site-sum suffix

This module contains the direct lowered site-sum and lowered Marshall
predicted-Casimir interval-chain wrappers split from
`Theorem23IntervalCasimir.lean`. The base interval-Casimir module keeps the
dominance-form predicted-Casimir interval chains.
