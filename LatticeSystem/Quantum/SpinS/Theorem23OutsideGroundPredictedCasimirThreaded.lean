...
/-!
# Tasaki §2.5 Theorem 2.3 outside-ground threaded predicted-Casimir API

This module contains the left-endpoint threaded predicted-Casimir final-wrapper
suffix for the Tasaki §2.5 Theorem 2.3 proof chain. It imports the source
predicted-Casimir outside-ground boundary and keeps the threaded interval-chain
wrappers in a separate module consumed by the predicted-GS final wrappers.
-/
