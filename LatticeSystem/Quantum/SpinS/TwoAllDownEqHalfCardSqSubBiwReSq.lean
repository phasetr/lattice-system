...
Mirror of PR #3297. Combines PR #3199 (`⟨Φ_↑⟩.re = ⟨Φ_↓⟩.re`) +
PR #3297 (`2·⟨Φ_↑⟩.re = (|Λ|·N/2)² − biw.re²`).
...
/-- **`2·⟨Φ_↓⟩.re = (|Λ|·N/2)² − biw.re²`** unconditionally. Mirror of PR #3297. -/
theorem heisenbergToyHamiltonianS_two_allAligned_last_expectation_re_eq_half_card_sq_sub_biw_re_sq
  ...
  have h1 := heisenbergToyHamiltonianS_allAligned_zero_expectation_re_eq_last_expectation_re
    (Λ := Λ) (A := A) (N := N)
  have h2 := heisenbergToyHamiltonianS_two_allAligned_zero_expectation_re_eq_half_card_sq_sub_biw_re_sq
    (Λ := Λ) (A := A) (N := N)
  linarith
