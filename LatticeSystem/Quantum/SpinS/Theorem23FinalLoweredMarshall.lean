import LatticeSystem.Quantum.SpinS.Theorem23FinalLoweredSiteSum
import LatticeSystem.Quantum.SpinS.Theorem23SectorExistenceIntervalMarshall

/-!
# Tasaki §2.5 Theorem 2.3 final lowered-Marshall API

This module contains the lowered-vector-Marshall final wrappers split from
`Theorem23Final.lean`. The base final-boundary module keeps the
outside-ground final-boundary aliases, `Theorem23FinalLoweredSiteSum.lean`
keeps the direct lowered-site-sum final wrappers, and this module exposes
the final theorem boundary whose local positivity input is the Marshall
positivity of the lowered total-ladder vector.
