...
/-!
# Tasaki §2.5 Theorem 2.3 left-endpoint lowered-site-sum final wrappers

This module contains the left-endpoint threaded predicted-GS lowered-site-sum
final wrapper and the two lowered-site-sum named-callback abbrevs, split as a
stable suffix from `Theorem23FinalLoweredSiteSum.lean`. The parent module keeps
the source predicted-GS lowered-site-sum final wrappers (plain / sector- /
real-sector-minimality) that the named-callback abbrev reuses.
