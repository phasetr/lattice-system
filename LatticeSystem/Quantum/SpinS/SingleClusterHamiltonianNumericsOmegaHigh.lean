...
the `N = 199..214` in `SingleClusterHamiltonianNumericsApexHigh.lean`, and the `N ≥ 215` in `SingleClusterHamiltonianNumericsZenithHigh.lean`.
...
/-- **Spin-185/2 6-vertex (hexamer) ground-state energy** (γ-5 step 1408):
`singleClusterGSEnergyS 5 185 = -171495/4 = -S(1+zS)` for `S = 185/2, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_hundredeightyfive :
    singleClusterGSEnergyS 5 185 = (-171495 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-185/2 6-vertex (hexamer) maximum-Casimir-sector energy** (γ-5 step 1408):
`singleClusterMaxEnergyS 5 185 = 171125/4 = zS²` for `S = 185/2, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_hundredeightyfive :
    singleClusterMaxEnergyS 5 185 = (171125 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-185/2 7-vertex (heptamer) ground-state energy** (γ-5 step 1409):
`singleClusterGSEnergyS 6 185 = -51430 = -S(1+zS)` for `S = 185/2, z = 6`. -/
@[simp] theorem singleClusterGSEnergyS_six_hundredeightyfive :
    singleClusterGSEnergyS 6 185 = (-51430 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-185/2 7-vertex (heptamer) maximum-Casimir-sector energy** (γ-5 step 1409):
`singleClusterMaxEnergyS 6 185 = 102675/2 = zS²` for `S = 185/2, z = 6`. -/
@[simp] theorem singleClusterMaxEnergyS_six_hundredeightyfive :
    singleClusterMaxEnergyS 6 185 = (102675 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-93 2-vertex (dimer) ground-state energy** (γ-5 step 1410):
`singleClusterGSEnergyS 1 186 = -8742 = -S(S+1)` for `S = 93`. -/
@[simp] theorem singleClusterGSEnergyS_one_hundredeightysix :
    singleClusterGSEnergyS 1 186 = (-8742 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-93 2-vertex (dimer) maximum-Casimir-sector energy** (γ-5 step 1410):
`singleClusterMaxEnergyS 1 186 = 8649 = S²` for `S = 93`. -/
@[simp] theorem singleClusterMaxEnergyS_one_hundredeightysix :
    singleClusterMaxEnergyS 1 186 = (8649 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-93 3-vertex (trimer) ground-state energy** (γ-5 step 1411):
`singleClusterGSEnergyS 2 186 = -17391 = -S(1+zS)` for `S = 93, z = 2`. -/
@[simp] theorem singleClusterGSEnergyS_two_hundredeightysix :
    singleClusterGSEnergyS 2 186 = (-17391 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-93 3-vertex (trimer) maximum-Casimir-sector energy** (γ-5 step 1411):
`singleClusterMaxEnergyS 2 186 = 17298 = zS²` for `S = 93, z = 2`. -/
@[simp] theorem singleClusterMaxEnergyS_two_hundredeightysix :
    singleClusterMaxEnergyS 2 186 = (17298 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-93 4-vertex (quartet) ground-state energy** (γ-5 step 1412):
`singleClusterGSEnergyS 3 186 = -26040 = -S(1+zS)` for `S = 93, z = 3`. -/
@[simp] theorem singleClusterGSEnergyS_three_hundredeightysix :
    singleClusterGSEnergyS 3 186 = (-26040 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-93 4-vertex (quartet) maximum-Casimir-sector energy** (γ-5 step 1412):
`singleClusterMaxEnergyS 3 186 = 25947 = zS²` for `S = 93, z = 3`. -/
@[simp] theorem singleClusterMaxEnergyS_three_hundredeightysix :
    singleClusterMaxEnergyS 3 186 = (25947 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-93 5-vertex (pentamer) ground-state energy** (γ-5 step 1413):
`singleClusterGSEnergyS 4 186 = -34689 = -S(1+zS)` for `S = 93, z = 4`. -/
@[simp] theorem singleClusterGSEnergyS_four_hundredeightysix :
    singleClusterGSEnergyS 4 186 = (-34689 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-93 5-vertex (pentamer) maximum-Casimir-sector energy** (γ-5 step 1413):
`singleClusterMaxEnergyS 4 186 = 34596 = zS²` for `S = 93, z = 4`. -/
@[simp] theorem singleClusterMaxEnergyS_four_hundredeightysix :
    singleClusterMaxEnergyS 4 186 = (34596 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-93 6-vertex (hexamer) ground-state energy** (γ-5 step 1414):
`singleClusterGSEnergyS 5 186 = -43338 = -S(1+zS)` for `S = 93, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_hundredeightysix :
    singleClusterGSEnergyS 5 186 = (-43338 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-93 6-vertex (hexamer) maximum-Casimir-sector energy** (γ-5 step 1414):
`singleClusterMaxEnergyS 5 186 = 43245 = zS²` for `S = 93, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_hundredeightysix :
    singleClusterMaxEnergyS 5 186 = (43245 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-93 7-vertex (heptamer) ground-state energy** (γ-5 step 1415):
`singleClusterGSEnergyS 6 186 = -51987 = -S(1+zS)` for `S = 93, z = 6`. -/
@[simp] theorem singleClusterGSEnergyS_six_hundredeightysix :
    singleClusterGSEnergyS 6 186 = (-51987 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-93 7-vertex (heptamer) maximum-Casimir-sector energy** (γ-5 step 1415):
`singleClusterMaxEnergyS 6 186 = 51894 = zS²` for `S = 93, z = 6`. -/
@[simp] theorem singleClusterMaxEnergyS_six_hundredeightysix :
    singleClusterMaxEnergyS 6 186 = (51894 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-187/2 2-vertex (dimer) ground-state energy** (γ-5 step 1416):
`singleClusterGSEnergyS 1 187 = -35343/4 = -S(S+1)` for `S = 187/2`. -/
@[simp] theorem singleClusterGSEnergyS_one_hundredeightyseven :
    singleClusterGSEnergyS 1 187 = (-35343 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-187/2 2-vertex (dimer) maximum-Casimir-sector energy** (γ-5 step 1416):
`singleClusterMaxEnergyS 1 187 = 34969/4 = S²` for `S = 187/2`. -/
@[simp] theorem singleClusterMaxEnergyS_one_hundredeightyseven :
    singleClusterMaxEnergyS 1 187 = (34969 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-187/2 3-vertex (trimer) ground-state energy** (γ-5 step 1417):
`singleClusterGSEnergyS 2 187 = -17578 = -S(1+zS)` for `S = 187/2, z = 2`. -/
@[simp] theorem singleClusterGSEnergyS_two_hundredeightyseven :
    singleClusterGSEnergyS 2 187 = (-17578 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-187/2 3-vertex (trimer) maximum-Casimir-sector energy** (γ-5 step 1417):
`singleClusterMaxEnergyS 2 187 = 34969/2 = zS²` for `S = 187/2, z = 2`. -/
@[simp] theorem singleClusterMaxEnergyS_two_hundredeightyseven :
    singleClusterMaxEnergyS 2 187 = (34969 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-187/2 4-vertex (quartet) ground-state energy** (γ-5 step 1418):
`singleClusterGSEnergyS 3 187 = -105281/4 = -S(1+zS)` for `S = 187/2, z = 3`. -/
@[simp] theorem singleClusterGSEnergyS_three_hundredeightyseven :
    singleClusterGSEnergyS 3 187 = (-105281 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-187/2 4-vertex (quartet) maximum-Casimir-sector energy** (γ-5 step 1418):
`singleClusterMaxEnergyS 3 187 = 104907/4 = zS²` for `S = 187/2, z = 3`. -/
@[simp] theorem singleClusterMaxEnergyS_three_hundredeightyseven :
    singleClusterMaxEnergyS 3 187 = (104907 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-187/2 5-vertex (pentamer) ground-state energy** (γ-5 step 1419):
`singleClusterGSEnergyS 4 187 = -70125/2 = -S(1+zS)` for `S = 187/2, z = 4`. -/
@[simp] theorem singleClusterGSEnergyS_four_hundredeightyseven :
    singleClusterGSEnergyS 4 187 = (-70125 / 2 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-187/2 5-vertex (pentamer) maximum-Casimir-sector energy** (γ-5 step 1419):
`singleClusterMaxEnergyS 4 187 = 34969 = zS²` for `S = 187/2, z = 4`. -/
@[simp] theorem singleClusterMaxEnergyS_four_hundredeightyseven :
    singleClusterMaxEnergyS 4 187 = (34969 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-187/2 6-vertex (hexamer) ground-state energy** (γ-5 step 1420):
`singleClusterGSEnergyS 5 187 = -175219/4 = -S(1+zS)` for `S = 187/2, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_hundredeightyseven :
    singleClusterGSEnergyS 5 187 = (-175219 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-187/2 6-vertex (hexamer) maximum-Casimir-sector energy** (γ-5 step 1420):
`singleClusterMaxEnergyS 5 187 = 174845/4 = zS²` for `S = 187/2, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_hundredeightyseven :
    singleClusterMaxEnergyS 5 187 = (174845 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-187/2 7-vertex (heptamer) ground-state energy** (γ-5 step 1421):
`singleClusterGSEnergyS 6 187 = -52547 = -S(1+zS)` for `S = 187/2, z = 6`. -/
@[simp] theorem singleClusterGSEnergyS_six_hundredeightyseven :
    singleClusterGSEnergyS 6 187 = (-52547 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-187/2 7-vertex (heptamer) maximum-Casimir-sector energy** (γ-5 step 1421):
`singleClusterMaxEnergyS 6 187 = 104907/2 = zS²` for `S = 187/2, z = 6`. -/
@[simp] theorem singleClusterMaxEnergyS_six_hundredeightyseven :
    singleClusterMaxEnergyS 6 187 = (104907 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-94 2-vertex (dimer) ground-state energy** (γ-5 step 1422):
`singleClusterGSEnergyS 1 188 = -8930 = -S(S+1)` for `S = 94`. -/
@[simp] theorem singleClusterGSEnergyS_one_hundredeightyeight :
    singleClusterGSEnergyS 1 188 = (-8930 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-94 2-vertex (dimer) maximum-Casimir-sector energy** (γ-5 step 1422):
`singleClusterMaxEnergyS 1 188 = 8836 = S²` for `S = 94`. -/
@[simp] theorem singleClusterMaxEnergyS_one_hundredeightyeight :
    singleClusterMaxEnergyS 1 188 = (8836 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-94 3-vertex (trimer) ground-state energy** (γ-5 step 1423):
`singleClusterGSEnergyS 2 188 = -17766 = -S(1+zS)` for `S = 94, z = 2`. -/
@[simp] theorem singleClusterGSEnergyS_two_hundredeightyeight :
    singleClusterGSEnergyS 2 188 = (-17766 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-94 3-vertex (trimer) maximum-Casimir-sector energy** (γ-5 step 1423):
`singleClusterMaxEnergyS 2 188 = 17672 = zS²` for `S = 94, z = 2`. -/
@[simp] theorem singleClusterMaxEnergyS_two_hundredeightyeight :
    singleClusterMaxEnergyS 2 188 = (17672 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-94 4-vertex (quartet) ground-state energy** (γ-5 step 1424):
`singleClusterGSEnergyS 3 188 = -26602 = -S(1+zS)` for `S = 94, z = 3`. -/
@[simp] theorem singleClusterGSEnergyS_three_hundredeightyeight :
    singleClusterGSEnergyS 3 188 = (-26602 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-94 4-vertex (quartet) maximum-Casimir-sector energy** (γ-5 step 1424):
`singleClusterMaxEnergyS 3 188 = 26508 = zS²` for `S = 94, z = 3`. -/
@[simp] theorem singleClusterMaxEnergyS_three_hundredeightyeight :
    singleClusterMaxEnergyS 3 188 = (26508 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-94 5-vertex (pentamer) ground-state energy** (γ-5 step 1425):
`singleClusterGSEnergyS 4 188 = -35438 = -S(1+zS)` for `S = 94, z = 4`. -/
@[simp] theorem singleClusterGSEnergyS_four_hundredeightyeight :
    singleClusterGSEnergyS 4 188 = (-35438 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-94 5-vertex (pentamer) maximum-Casimir-sector energy** (γ-5 step 1425):
`singleClusterMaxEnergyS 4 188 = 35344 = zS²` for `S = 94, z = 4`. -/
@[simp] theorem singleClusterMaxEnergyS_four_hundredeightyeight :
    singleClusterMaxEnergyS 4 188 = (35344 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-94 6-vertex (hexamer) ground-state energy** (γ-5 step 1426):
`singleClusterGSEnergyS 5 188 = -44274 = -S(1+zS)` for `S = 94, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_hundredeightyeight :
    singleClusterGSEnergyS 5 188 = (-44274 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-94 6-vertex (hexamer) maximum-Casimir-sector energy** (γ-5 step 1426):
`singleClusterMaxEnergyS 5 188 = 44180 = zS²` for `S = 94, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_hundredeightyeight :
    singleClusterMaxEnergyS 5 188 = (44180 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-94 7-vertex (heptamer) ground-state energy** (γ-5 step 1427):
`singleClusterGSEnergyS 6 188 = -53110 = -S(1+zS)` for `S = 94, z = 6`. -/
@[simp] theorem singleClusterGSEnergyS_six_hundredeightyeight :
    singleClusterGSEnergyS 6 188 = (-53110 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-94 7-vertex (heptamer) maximum-Casimir-sector energy** (γ-5 step 1427):
`singleClusterMaxEnergyS 6 188 = 53016 = zS²` for `S = 94, z = 6`. -/
@[simp] theorem singleClusterMaxEnergyS_six_hundredeightyeight :
    singleClusterMaxEnergyS 6 188 = (53016 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-189/2 2-vertex (dimer) ground-state energy** (γ-5 step 1428):
`singleClusterGSEnergyS 1 189 = -36099/4 = -S(S+1)` for `S = 189/2`. -/
@[simp] theorem singleClusterGSEnergyS_one_hundredeightynine :
    singleClusterGSEnergyS 1 189 = (-36099 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-189/2 2-vertex (dimer) maximum-Casimir-sector energy** (γ-5 step 1428):
`singleClusterMaxEnergyS 1 189 = 35721/4 = S²` for `S = 189/2`. -/
@[simp] theorem singleClusterMaxEnergyS_one_hundredeightynine :
    singleClusterMaxEnergyS 1 189 = (35721 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-189/2 3-vertex (trimer) ground-state energy** (γ-5 step 1429):
`singleClusterGSEnergyS 2 189 = -17955 = -S(1+zS)` for `S = 189/2, z = 2`. -/
@[simp] theorem singleClusterGSEnergyS_two_hundredeightynine :
    singleClusterGSEnergyS 2 189 = (-17955 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-189/2 3-vertex (trimer) maximum-Casimir-sector energy** (γ-5 step 1429):
`singleClusterMaxEnergyS 2 189 = 35721/2 = zS²` for `S = 189/2, z = 2`. -/
@[simp] theorem singleClusterMaxEnergyS_two_hundredeightynine :
    singleClusterMaxEnergyS 2 189 = (35721 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-189/2 4-vertex (quartet) ground-state energy** (γ-5 step 1430):
`singleClusterGSEnergyS 3 189 = -107541/4 = -S(1+zS)` for `S = 189/2, z = 3`. -/
@[simp] theorem singleClusterGSEnergyS_three_hundredeightynine :
    singleClusterGSEnergyS 3 189 = (-107541 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-189/2 4-vertex (quartet) maximum-Casimir-sector energy** (γ-5 step 1430):
`singleClusterMaxEnergyS 3 189 = 107163/4 = zS²` for `S = 189/2, z = 3`. -/
@[simp] theorem singleClusterMaxEnergyS_three_hundredeightynine :
    singleClusterMaxEnergyS 3 189 = (107163 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-189/2 5-vertex (pentamer) ground-state energy** (γ-5 step 1431):
`singleClusterGSEnergyS 4 189 = -71631/2 = -S(1+zS)` for `S = 189/2, z = 4`. -/
@[simp] theorem singleClusterGSEnergyS_four_hundredeightynine :
    singleClusterGSEnergyS 4 189 = (-71631 / 2 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-189/2 5-vertex (pentamer) maximum-Casimir-sector energy** (γ-5 step 1431):
`singleClusterMaxEnergyS 4 189 = 35721 = zS²` for `S = 189/2, z = 4`. -/
@[simp] theorem singleClusterMaxEnergyS_four_hundredeightynine :
    singleClusterMaxEnergyS 4 189 = (35721 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-189/2 6-vertex (hexamer) ground-state energy** (γ-5 step 1432):
`singleClusterGSEnergyS 5 189 = -178983/4 = -S(1+zS)` for `S = 189/2, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_hundredeightynine :
    singleClusterGSEnergyS 5 189 = (-178983 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-189/2 6-vertex (hexamer) maximum-Casimir-sector energy** (γ-5 step 1432):
`singleClusterMaxEnergyS 5 189 = 178605/4 = zS²` for `S = 189/2, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_hundredeightynine :
    singleClusterMaxEnergyS 5 189 = (178605 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-189/2 7-vertex (heptamer) ground-state energy** (γ-5 step 1433):
`singleClusterGSEnergyS 6 189 = -53676 = -S(1+zS)` for `S = 189/2, z = 6`. -/
@[simp] theorem singleClusterGSEnergyS_six_hundredeightynine :
    singleClusterGSEnergyS 6 189 = (-53676 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-189/2 7-vertex (heptamer) maximum-Casimir-sector energy** (γ-5 step 1433):
`singleClusterMaxEnergyS 6 189 = 107163/2 = zS²` for `S = 189/2, z = 6`. -/
@[simp] theorem singleClusterMaxEnergyS_six_hundredeightynine :
    singleClusterMaxEnergyS 6 189 = (107163 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-95 2-vertex (dimer) ground-state energy** (γ-5 step 1434):
`singleClusterGSEnergyS 1 190 = -9120 = -S(S+1)` for `S = 95`. -/
@[simp] theorem singleClusterGSEnergyS_one_hundredninety :
    singleClusterGSEnergyS 1 190 = (-9120 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-95 2-vertex (dimer) maximum-Casimir-sector energy** (γ-5 step 1434):
`singleClusterMaxEnergyS 1 190 = 9025 = S²` for `S = 95`. -/
@[simp] theorem singleClusterMaxEnergyS_one_hundredninety :
    singleClusterMaxEnergyS 1 190 = (9025 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-95 3-vertex (trimer) ground-state energy** (γ-5 step 1435):
`singleClusterGSEnergyS 2 190 = -18145 = -S(1+zS)` for `S = 95, z = 2`. -/
@[simp] theorem singleClusterGSEnergyS_two_hundredninety :
    singleClusterGSEnergyS 2 190 = (-18145 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-95 3-vertex (trimer) maximum-Casimir-sector energy** (γ-5 step 1435):
`singleClusterMaxEnergyS 2 190 = 18050 = zS²` for `S = 95, z = 2`. -/
@[simp] theorem singleClusterMaxEnergyS_two_hundredninety :
    singleClusterMaxEnergyS 2 190 = (18050 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-95 4-vertex (quartet) ground-state energy** (γ-5 step 1436):
`singleClusterGSEnergyS 3 190 = -27170 = -S(1+zS)` for `S = 95, z = 3`. -/
@[simp] theorem singleClusterGSEnergyS_three_hundredninety :
    singleClusterGSEnergyS 3 190 = (-27170 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-95 4-vertex (quartet) maximum-Casimir-sector energy** (γ-5 step 1436):
`singleClusterMaxEnergyS 3 190 = 27075 = zS²` for `S = 95, z = 3`. -/
@[simp] theorem singleClusterMaxEnergyS_three_hundredninety :
    singleClusterMaxEnergyS 3 190 = (27075 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-95 5-vertex (pentamer) ground-state energy** (γ-5 step 1437):
`singleClusterGSEnergyS 4 190 = -36195 = -S(1+zS)` for `S = 95, z = 4`. -/
@[simp] theorem singleClusterGSEnergyS_four_hundredninety :
    singleClusterGSEnergyS 4 190 = (-36195 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-95 5-vertex (pentamer) maximum-Casimir-sector energy** (γ-5 step 1437):
`singleClusterMaxEnergyS 4 190 = 36100 = zS²` for `S = 95, z = 4`. -/
@[simp] theorem singleClusterMaxEnergyS_four_hundredninety :
    singleClusterMaxEnergyS 4 190 = (36100 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-95 6-vertex (hexamer) ground-state energy** (γ-5 step 1438):
`singleClusterGSEnergyS 5 190 = -45220 = -S(1+zS)` for `S = 95, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_hundredninety :
    singleClusterGSEnergyS 5 190 = (-45220 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-95 6-vertex (hexamer) maximum-Casimir-sector energy** (γ-5 step 1438):
`singleClusterMaxEnergyS 5 190 = 45125 = zS²` for `S = 95, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_hundredninety :
    singleClusterMaxEnergyS 5 190 = (45125 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-95 7-vertex (heptamer) ground-state energy** (γ-5 step 1439):
`singleClusterGSEnergyS 6 190 = -54245 = -S(1+zS)` for `S = 95, z = 6`. -/
@[simp] theorem singleClusterGSEnergyS_six_hundredninety :
    singleClusterGSEnergyS 6 190 = (-54245 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-95 7-vertex (heptamer) maximum-Casimir-sector energy** (γ-5 step 1439):
`singleClusterMaxEnergyS 6 190 = 54150 = zS²` for `S = 95, z = 6`. -/
@[simp] theorem singleClusterMaxEnergyS_six_hundredninety :
    singleClusterMaxEnergyS 6 190 = (54150 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-191/2 2-vertex (dimer) ground-state energy** (γ-5 step 1440):
`singleClusterGSEnergyS 1 191 = -36863/4 = -S(S+1)` for `S = 191/2`. -/
@[simp] theorem singleClusterGSEnergyS_one_hundredninetyone :
    singleClusterGSEnergyS 1 191 = (-36863 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-191/2 2-vertex (dimer) maximum-Casimir-sector energy** (γ-5 step 1440):
`singleClusterMaxEnergyS 1 191 = 36481/4 = S²` for `S = 191/2`. -/
@[simp] theorem singleClusterMaxEnergyS_one_hundredninetyone :
    singleClusterMaxEnergyS 1 191 = (36481 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-191/2 3-vertex (trimer) ground-state energy** (γ-5 step 1441):
`singleClusterGSEnergyS 2 191 = -18336 = -S(1+zS)` for `S = 191/2, z = 2`. -/
@[simp] theorem singleClusterGSEnergyS_two_hundredninetyone :
    singleClusterGSEnergyS 2 191 = (-18336 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-191/2 3-vertex (trimer) maximum-Casimir-sector energy** (γ-5 step 1441):
`singleClusterMaxEnergyS 2 191 = 36481/2 = zS²` for `S = 191/2, z = 2`. -/
@[simp] theorem singleClusterMaxEnergyS_two_hundredninetyone :
    singleClusterMaxEnergyS 2 191 = (36481 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-191/2 4-vertex (quartet) ground-state energy** (γ-5 step 1442):
`singleClusterGSEnergyS 3 191 = -109825/4 = -S(1+zS)` for `S = 191/2, z = 3`. -/
@[simp] theorem singleClusterGSEnergyS_three_hundredninetyone :
    singleClusterGSEnergyS 3 191 = (-109825 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-191/2 4-vertex (quartet) maximum-Casimir-sector energy** (γ-5 step 1442):
`singleClusterMaxEnergyS 3 191 = 109443/4 = zS²` for `S = 191/2, z = 3`. -/
@[simp] theorem singleClusterMaxEnergyS_three_hundredninetyone :
    singleClusterMaxEnergyS 3 191 = (109443 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-191/2 5-vertex (pentamer) ground-state energy** (γ-5 step 1443):
`singleClusterGSEnergyS 4 191 = -73153/2 = -S(1+zS)` for `S = 191/2, z = 4`. -/
@[simp] theorem singleClusterGSEnergyS_four_hundredninetyone :
    singleClusterGSEnergyS 4 191 = (-73153 / 2 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-191/2 5-vertex (pentamer) maximum-Casimir-sector energy** (γ-5 step 1443):
`singleClusterMaxEnergyS 4 191 = 36481 = zS²` for `S = 191/2, z = 4`. -/
@[simp] theorem singleClusterMaxEnergyS_four_hundredninetyone :
    singleClusterMaxEnergyS 4 191 = (36481 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-191/2 6-vertex (hexamer) ground-state energy** (γ-5 step 1444):
`singleClusterGSEnergyS 5 191 = -182787/4 = -S(1+zS)` for `S = 191/2, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_hundredninetyone :
    singleClusterGSEnergyS 5 191 = (-182787 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-191/2 6-vertex (hexamer) maximum-Casimir-sector energy** (γ-5 step 1444):
`singleClusterMaxEnergyS 5 191 = 182405/4 = zS²` for `S = 191/2, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_hundredninetyone :
    singleClusterMaxEnergyS 5 191 = (182405 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-191/2 7-vertex (heptamer) ground-state energy** (γ-5 step 1445):
`singleClusterGSEnergyS 6 191 = -54817 = -S(1+zS)` for `S = 191/2, z = 6`. -/
@[simp] theorem singleClusterGSEnergyS_six_hundredninetyone :
    singleClusterGSEnergyS 6 191 = (-54817 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-191/2 7-vertex (heptamer) maximum-Casimir-sector energy** (γ-5 step 1445):
`singleClusterMaxEnergyS 6 191 = 109443/2 = zS²` for `S = 191/2, z = 6`. -/
@[simp] theorem singleClusterMaxEnergyS_six_hundredninetyone :
    singleClusterMaxEnergyS 6 191 = (109443 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-96 2-vertex (dimer) ground-state energy** (γ-5 step 1446):
`singleClusterGSEnergyS 1 192 = -9312 = -S(S+1)` for `S = 96`. -/
@[simp] theorem singleClusterGSEnergyS_one_hundredninetytwo :
    singleClusterGSEnergyS 1 192 = (-9312 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-96 2-vertex (dimer) maximum-Casimir-sector energy** (γ-5 step 1446):
`singleClusterMaxEnergyS 1 192 = 9216 = S²` for `S = 96`. -/
@[simp] theorem singleClusterMaxEnergyS_one_hundredninetytwo :
    singleClusterMaxEnergyS 1 192 = (9216 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-96 3-vertex (trimer) ground-state energy** (γ-5 step 1447):
`singleClusterGSEnergyS 2 192 = -18528 = -S(1+zS)` for `S = 96, z = 2`. -/
@[simp] theorem singleClusterGSEnergyS_two_hundredninetytwo :
    singleClusterGSEnergyS 2 192 = (-18528 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-96 3-vertex (trimer) maximum-Casimir-sector energy** (γ-5 step 1447):
`singleClusterMaxEnergyS 2 192 = 18432 = zS²` for `S = 96, z = 2`. -/
@[simp] theorem singleClusterMaxEnergyS_two_hundredninetytwo :
    singleClusterMaxEnergyS 2 192 = (18432 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-96 4-vertex (quartet) ground-state energy** (γ-5 step 1448):
`singleClusterGSEnergyS 3 192 = -27744 = -S(1+zS)` for `S = 96, z = 3`. -/
@[simp] theorem singleClusterGSEnergyS_three_hundredninetytwo :
    singleClusterGSEnergyS 3 192 = (-27744 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-96 4-vertex (quartet) maximum-Casimir-sector energy** (γ-5 step 1448):
`singleClusterMaxEnergyS 3 192 = 27648 = zS²` for `S = 96, z = 3`. -/
@[simp] theorem singleClusterMaxEnergyS_three_hundredninetytwo :
    singleClusterMaxEnergyS 3 192 = (27648 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-96 5-vertex (pentamer) ground-state energy** (γ-5 step 1449):
`singleClusterGSEnergyS 4 192 = -36960 = -S(1+zS)` for `S = 96, z = 4`. -/
@[simp] theorem singleClusterGSEnergyS_four_hundredninetytwo :
    singleClusterGSEnergyS 4 192 = (-36960 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-96 5-vertex (pentamer) maximum-Casimir-sector energy** (γ-5 step 1449):
`singleClusterMaxEnergyS 4 192 = 36864 = zS²` for `S = 96, z = 4`. -/
@[simp] theorem singleClusterMaxEnergyS_four_hundredninetytwo :
    singleClusterMaxEnergyS 4 192 = (36864 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-96 6-vertex (hexamer) ground-state energy** (γ-5 step 1450):
`singleClusterGSEnergyS 5 192 = -46176 = -S(1+zS)` for `S = 96, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_hundredninetytwo :
    singleClusterGSEnergyS 5 192 = (-46176 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-96 6-vertex (hexamer) maximum-Casimir-sector energy** (γ-5 step 1450):
`singleClusterMaxEnergyS 5 192 = 46080 = zS²` for `S = 96, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_hundredninetytwo :
    singleClusterMaxEnergyS 5 192 = (46080 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-96 7-vertex (heptamer) ground-state energy** (γ-5 step 1451):
`singleClusterGSEnergyS 6 192 = -55392 = -S(1+zS)` for `S = 96, z = 6`. -/
@[simp] theorem singleClusterGSEnergyS_six_hundredninetytwo :
    singleClusterGSEnergyS 6 192 = (-55392 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-96 7-vertex (heptamer) maximum-Casimir-sector energy** (γ-5 step 1451):
`singleClusterMaxEnergyS 6 192 = 55296 = zS²` for `S = 96, z = 6`. -/
@[simp] theorem singleClusterMaxEnergyS_six_hundredninetytwo :
    singleClusterMaxEnergyS 6 192 = (55296 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-193/2 2-vertex (dimer) ground-state energy** (γ-5 step 1452):
`singleClusterGSEnergyS 1 193 = -37635/4 = -S(S+1)` for `S = 193/2`. -/
@[simp] theorem singleClusterGSEnergyS_one_hundredninetythree :
    singleClusterGSEnergyS 1 193 = (-37635 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-193/2 2-vertex (dimer) maximum-Casimir-sector energy** (γ-5 step 1452):
`singleClusterMaxEnergyS 1 193 = 37249/4 = S²` for `S = 193/2`. -/
@[simp] theorem singleClusterMaxEnergyS_one_hundredninetythree :
    singleClusterMaxEnergyS 1 193 = (37249 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-193/2 3-vertex (trimer) ground-state energy** (γ-5 step 1453):
`singleClusterGSEnergyS 2 193 = -18721 = -S(1+zS)` for `S = 193/2, z = 2`. -/
@[simp] theorem singleClusterGSEnergyS_two_hundredninetythree :
    singleClusterGSEnergyS 2 193 = (-18721 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-193/2 3-vertex (trimer) maximum-Casimir-sector energy** (γ-5 step 1453):
`singleClusterMaxEnergyS 2 193 = 37249/2 = zS²` for `S = 193/2, z = 2`. -/
@[simp] theorem singleClusterMaxEnergyS_two_hundredninetythree :
    singleClusterMaxEnergyS 2 193 = (37249 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-193/2 4-vertex (quartet) ground-state energy** (γ-5 step 1454):
`singleClusterGSEnergyS 3 193 = -112133/4 = -S(1+zS)` for `S = 193/2, z = 3`. -/
@[simp] theorem singleClusterGSEnergyS_three_hundredninetythree :
    singleClusterGSEnergyS 3 193 = (-112133 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-193/2 4-vertex (quartet) maximum-Casimir-sector energy** (γ-5 step 1454):
`singleClusterMaxEnergyS 3 193 = 111747/4 = zS²` for `S = 193/2, z = 3`. -/
@[simp] theorem singleClusterMaxEnergyS_three_hundredninetythree :
    singleClusterMaxEnergyS 3 193 = (111747 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-193/2 5-vertex (pentamer) ground-state energy** (γ-5 step 1455):
`singleClusterGSEnergyS 4 193 = -74691/2 = -S(1+zS)` for `S = 193/2, z = 4`. -/
@[simp] theorem singleClusterGSEnergyS_four_hundredninetythree :
    singleClusterGSEnergyS 4 193 = (-74691 / 2 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-193/2 5-vertex (pentamer) maximum-Casimir-sector energy** (γ-5 step 1455):
`singleClusterMaxEnergyS 4 193 = 37249 = zS²` for `S = 193/2, z = 4`. -/
@[simp] theorem singleClusterMaxEnergyS_four_hundredninetythree :
    singleClusterMaxEnergyS 4 193 = (37249 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-193/2 6-vertex (hexamer) ground-state energy** (γ-5 step 1456):
`singleClusterGSEnergyS 5 193 = -186631/4 = -S(1+zS)` for `S = 193/2, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_hundredninetythree :
    singleClusterGSEnergyS 5 193 = (-186631 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-193/2 6-vertex (hexamer) maximum-Casimir-sector energy** (γ-5 step 1456):
`singleClusterMaxEnergyS 5 193 = 186245/4 = zS²` for `S = 193/2, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_hundredninetythree :
    singleClusterMaxEnergyS 5 193 = (186245 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-193/2 7-vertex (heptamer) ground-state energy** (γ-5 step 1457):
`singleClusterGSEnergyS 6 193 = -55970 = -S(1+zS)` for `S = 193/2, z = 6`. -/
@[simp] theorem singleClusterGSEnergyS_six_hundredninetythree :
    singleClusterGSEnergyS 6 193 = (-55970 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-193/2 7-vertex (heptamer) maximum-Casimir-sector energy** (γ-5 step 1457):
`singleClusterMaxEnergyS 6 193 = 111747/2 = zS²` for `S = 193/2, z = 6`. -/
@[simp] theorem singleClusterMaxEnergyS_six_hundredninetythree :
    singleClusterMaxEnergyS 6 193 = (111747 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-97 2-vertex (dimer) ground-state energy** (γ-5 step 1458):
`singleClusterGSEnergyS 1 194 = -9506 = -S(S+1)` for `S = 97`. -/
@[simp] theorem singleClusterGSEnergyS_one_hundredninetyfour :
    singleClusterGSEnergyS 1 194 = (-9506 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-97 2-vertex (dimer) maximum-Casimir-sector energy** (γ-5 step 1458):
`singleClusterMaxEnergyS 1 194 = 9409 = S²` for `S = 97`. -/
@[simp] theorem singleClusterMaxEnergyS_one_hundredninetyfour :
    singleClusterMaxEnergyS 1 194 = (9409 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-97 3-vertex (trimer) ground-state energy** (γ-5 step 1459):
`singleClusterGSEnergyS 2 194 = -18915 = -S(1+zS)` for `S = 97, z = 2`. -/
@[simp] theorem singleClusterGSEnergyS_two_hundredninetyfour :
    singleClusterGSEnergyS 2 194 = (-18915 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-97 3-vertex (trimer) maximum-Casimir-sector energy** (γ-5 step 1459):
`singleClusterMaxEnergyS 2 194 = 18818 = zS²` for `S = 97, z = 2`. -/
@[simp] theorem singleClusterMaxEnergyS_two_hundredninetyfour :
    singleClusterMaxEnergyS 2 194 = (18818 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-97 4-vertex (quartet) ground-state energy** (γ-5 step 1460):
`singleClusterGSEnergyS 3 194 = -28324 = -S(1+zS)` for `S = 97, z = 3`. -/
@[simp] theorem singleClusterGSEnergyS_three_hundredninetyfour :
    singleClusterGSEnergyS 3 194 = (-28324 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-97 4-vertex (quartet) maximum-Casimir-sector energy** (γ-5 step 1460):
`singleClusterMaxEnergyS 3 194 = 28227 = zS²` for `S = 97, z = 3`. -/
@[simp] theorem singleClusterMaxEnergyS_three_hundredninetyfour :
    singleClusterMaxEnergyS 3 194 = (28227 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-97 5-vertex (pentamer) ground-state energy** (γ-5 step 1461):
`singleClusterGSEnergyS 4 194 = -37733 = -S(1+zS)` for `S = 97, z = 4`. -/
@[simp] theorem singleClusterGSEnergyS_four_hundredninetyfour :
    singleClusterGSEnergyS 4 194 = (-37733 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-97 5-vertex (pentamer) maximum-Casimir-sector energy** (γ-5 step 1461):
`singleClusterMaxEnergyS 4 194 = 37636 = zS²` for `S = 97, z = 4`. -/
@[simp] theorem singleClusterMaxEnergyS_four_hundredninetyfour :
    singleClusterMaxEnergyS 4 194 = (37636 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-97 6-vertex (hexamer) ground-state energy** (γ-5 step 1462):
`singleClusterGSEnergyS 5 194 = -47142 = -S(1+zS)` for `S = 97, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_hundredninetyfour :
    singleClusterGSEnergyS 5 194 = (-47142 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-97 6-vertex (hexamer) maximum-Casimir-sector energy** (γ-5 step 1462):
`singleClusterMaxEnergyS 5 194 = 47045 = zS²` for `S = 97, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_hundredninetyfour :
    singleClusterMaxEnergyS 5 194 = (47045 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-97 7-vertex (heptamer) ground-state energy** (γ-5 step 1463):
`singleClusterGSEnergyS 6 194 = -56551 = -S(1+zS)` for `S = 97, z = 6`. Closes spin-97 row. -/
@[simp] theorem singleClusterGSEnergyS_six_hundredninetyfour :
    singleClusterGSEnergyS 6 194 = (-56551 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-97 7-vertex (heptamer) maximum-Casimir-sector energy** (γ-5 step 1463):
`singleClusterMaxEnergyS 6 194 = 56454 = zS²` for `S = 97, z = 6`. Closes spin-97 row. -/
@[simp] theorem singleClusterMaxEnergyS_six_hundredninetyfour :
    singleClusterMaxEnergyS 6 194 = (56454 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-195/2 2-vertex (dimer) ground-state energy** (γ-5 step 1464):
`singleClusterGSEnergyS 1 195 = -38415/4 = -S(S+1)` for `S = 195/2, z = 1`. -/
@[simp] theorem singleClusterGSEnergyS_one_hundredninetyfive :
    singleClusterGSEnergyS 1 195 = (-38415 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-195/2 2-vertex (dimer) maximum-Casimir-sector energy** (γ-5 step 1464):
`singleClusterMaxEnergyS 1 195 = 38025/4 = S²` for `S = 195/2, z = 1`. -/
@[simp] theorem singleClusterMaxEnergyS_one_hundredninetyfive :
    singleClusterMaxEnergyS 1 195 = (38025 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-195/2 3-vertex (trimer) ground-state energy** (γ-5 step 1465):
`singleClusterGSEnergyS 2 195 = -19110 = -S(1+zS)` for `S = 195/2, z = 2`. -/
@[simp] theorem singleClusterGSEnergyS_two_hundredninetyfive :
    singleClusterGSEnergyS 2 195 = (-19110 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-195/2 3-vertex (trimer) maximum-Casimir-sector energy** (γ-5 step 1465):
`singleClusterMaxEnergyS 2 195 = 38025/2 = zS²` for `S = 195/2, z = 2`. -/
@[simp] theorem singleClusterMaxEnergyS_two_hundredninetyfive :
    singleClusterMaxEnergyS 2 195 = (38025 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-195/2 4-vertex (quartet) ground-state energy** (γ-5 step 1466):
`singleClusterGSEnergyS 3 195 = -114465/4 = -S(1+zS)` for `S = 195/2, z = 3`. -/
@[simp] theorem singleClusterGSEnergyS_three_hundredninetyfive :
    singleClusterGSEnergyS 3 195 = (-114465 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-195/2 4-vertex (quartet) maximum-Casimir-sector energy** (γ-5 step 1466):
`singleClusterMaxEnergyS 3 195 = 114075/4 = zS²` for `S = 195/2, z = 3`. -/
@[simp] theorem singleClusterMaxEnergyS_three_hundredninetyfive :
    singleClusterMaxEnergyS 3 195 = (114075 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-195/2 5-vertex (pentamer) ground-state energy** (γ-5 step 1467):
`singleClusterGSEnergyS 4 195 = -76245/2 = -S(1+zS)` for `S = 195/2, z = 4`. -/
@[simp] theorem singleClusterGSEnergyS_four_hundredninetyfive :
    singleClusterGSEnergyS 4 195 = (-76245 / 2 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-195/2 5-vertex (pentamer) maximum-Casimir-sector energy** (γ-5 step 1467):
`singleClusterMaxEnergyS 4 195 = 38025 = zS²` for `S = 195/2, z = 4`. -/
@[simp] theorem singleClusterMaxEnergyS_four_hundredninetyfive :
    singleClusterMaxEnergyS 4 195 = (38025 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-195/2 6-vertex (hexamer) ground-state energy** (γ-5 step 1468):
`singleClusterGSEnergyS 5 195 = -190515/4 = -S(1+zS)` for `S = 195/2, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_hundredninetyfive :
    singleClusterGSEnergyS 5 195 = (-190515 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-195/2 6-vertex (hexamer) maximum-Casimir-sector energy** (γ-5 step 1468):
`singleClusterMaxEnergyS 5 195 = 190125/4 = zS²` for `S = 195/2, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_hundredninetyfive :
    singleClusterMaxEnergyS 5 195 = (190125 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-195/2 7-vertex (heptamer) ground-state energy** (γ-5 step 1469):
`singleClusterGSEnergyS 6 195 = -57135 = -S(1+zS)` for `S = 195/2, z = 6`. Closes spin-195/2 row. -/
@[simp] theorem singleClusterGSEnergyS_six_hundredninetyfive :
    singleClusterGSEnergyS 6 195 = (-57135 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-195/2 7-vertex (heptamer) maximum-Casimir-sector energy** (γ-5 step 1469):
`singleClusterMaxEnergyS 6 195 = 114075/2 = zS²` for `S = 195/2, z = 6`. Closes spin-195/2 row. -/
@[simp] theorem singleClusterMaxEnergyS_six_hundredninetyfive :
    singleClusterMaxEnergyS 6 195 = (114075 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-98 2-vertex (dimer) ground-state energy** (γ-5 step 1470):
`singleClusterGSEnergyS 1 196 = -9702 = -S(S+1)` for `S = 98, z = 1`. -/
@[simp] theorem singleClusterGSEnergyS_one_hundredninetysix :
    singleClusterGSEnergyS 1 196 = (-9702 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-98 2-vertex (dimer) maximum-Casimir-sector energy** (γ-5 step 1470):
`singleClusterMaxEnergyS 1 196 = 9604 = S²` for `S = 98, z = 1`. -/
@[simp] theorem singleClusterMaxEnergyS_one_hundredninetysix :
    singleClusterMaxEnergyS 1 196 = (9604 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-98 3-vertex (trimer) ground-state energy** (γ-5 step 1471):
`singleClusterGSEnergyS 2 196 = -19306 = -S(1+zS)` for `S = 98, z = 2`. -/
@[simp] theorem singleClusterGSEnergyS_two_hundredninetysix :
    singleClusterGSEnergyS 2 196 = (-19306 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-98 3-vertex (trimer) maximum-Casimir-sector energy** (γ-5 step 1471):
`singleClusterMaxEnergyS 2 196 = 19208 = zS²` for `S = 98, z = 2`. -/
@[simp] theorem singleClusterMaxEnergyS_two_hundredninetysix :
    singleClusterMaxEnergyS 2 196 = (19208 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-98 4-vertex (quartet) ground-state energy** (γ-5 step 1472):
`singleClusterGSEnergyS 3 196 = -28910 = -S(1+zS)` for `S = 98, z = 3`. -/
@[simp] theorem singleClusterGSEnergyS_three_hundredninetysix :
    singleClusterGSEnergyS 3 196 = (-28910 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-98 4-vertex (quartet) maximum-Casimir-sector energy** (γ-5 step 1472):
`singleClusterMaxEnergyS 3 196 = 28812 = zS²` for `S = 98, z = 3`. -/
@[simp] theorem singleClusterMaxEnergyS_three_hundredninetysix :
    singleClusterMaxEnergyS 3 196 = (28812 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-98 5-vertex (pentamer) ground-state energy** (γ-5 step 1473):
`singleClusterGSEnergyS 4 196 = -38514 = -S(1+zS)` for `S = 98, z = 4`. -/
@[simp] theorem singleClusterGSEnergyS_four_hundredninetysix :
    singleClusterGSEnergyS 4 196 = (-38514 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-98 5-vertex (pentamer) maximum-Casimir-sector energy** (γ-5 step 1473):
`singleClusterMaxEnergyS 4 196 = 38416 = zS²` for `S = 98, z = 4`. -/
@[simp] theorem singleClusterMaxEnergyS_four_hundredninetysix :
    singleClusterMaxEnergyS 4 196 = (38416 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-98 6-vertex (hexamer) ground-state energy** (γ-5 step 1474):
`singleClusterGSEnergyS 5 196 = -48118 = -S(1+zS)` for `S = 98, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_hundredninetysix :
    singleClusterGSEnergyS 5 196 = (-48118 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-98 6-vertex (hexamer) maximum-Casimir-sector energy** (γ-5 step 1474):
`singleClusterMaxEnergyS 5 196 = 48020 = zS²` for `S = 98, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_hundredninetysix :
    singleClusterMaxEnergyS 5 196 = (48020 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-98 7-vertex (heptamer) ground-state energy** (γ-5 step 1475):
`singleClusterGSEnergyS 6 196 = -57722 = -S(1+zS)` for `S = 98, z = 6`. Closes spin-98 row. -/
@[simp] theorem singleClusterGSEnergyS_six_hundredninetysix :
    singleClusterGSEnergyS 6 196 = (-57722 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-98 7-vertex (heptamer) maximum-Casimir-sector energy** (γ-5 step 1475):
`singleClusterMaxEnergyS 6 196 = 57624 = zS²` for `S = 98, z = 6`. Closes spin-98 row. -/
@[simp] theorem singleClusterMaxEnergyS_six_hundredninetysix :
    singleClusterMaxEnergyS 6 196 = (57624 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-197/2 2-vertex (dimer) ground-state energy** (γ-5 step 1476):
`singleClusterGSEnergyS 1 197 = -39203/4 = -S(S+1)` for `S = 197/2, z = 1`. -/
@[simp] theorem singleClusterGSEnergyS_one_hundredninetyseven :
    singleClusterGSEnergyS 1 197 = (-39203 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-197/2 2-vertex (dimer) maximum-Casimir-sector energy** (γ-5 step 1476):
`singleClusterMaxEnergyS 1 197 = 38809/4 = S²` for `S = 197/2, z = 1`. -/
@[simp] theorem singleClusterMaxEnergyS_one_hundredninetyseven :
    singleClusterMaxEnergyS 1 197 = (38809 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-197/2 3-vertex (trimer) ground-state energy** (γ-5 step 1477):
`singleClusterGSEnergyS 2 197 = -19503 = -S(1+zS)` for `S = 197/2, z = 2`. -/
@[simp] theorem singleClusterGSEnergyS_two_hundredninetyseven :
    singleClusterGSEnergyS 2 197 = (-19503 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-197/2 3-vertex (trimer) maximum-Casimir-sector energy** (γ-5 step 1477):
`singleClusterMaxEnergyS 2 197 = 38809/2 = zS²` for `S = 197/2, z = 2`. -/
@[simp] theorem singleClusterMaxEnergyS_two_hundredninetyseven :
    singleClusterMaxEnergyS 2 197 = (38809 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-197/2 4-vertex (quartet) ground-state energy** (γ-5 step 1478):
`singleClusterGSEnergyS 3 197 = -116821/4 = -S(1+zS)` for `S = 197/2, z = 3`. -/
@[simp] theorem singleClusterGSEnergyS_three_hundredninetyseven :
    singleClusterGSEnergyS 3 197 = (-116821 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-197/2 4-vertex (quartet) maximum-Casimir-sector energy** (γ-5 step 1478):
`singleClusterMaxEnergyS 3 197 = 116427/4 = zS²` for `S = 197/2, z = 3`. -/
@[simp] theorem singleClusterMaxEnergyS_three_hundredninetyseven :
    singleClusterMaxEnergyS 3 197 = (116427 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-197/2 5-vertex (pentamer) ground-state energy** (γ-5 step 1479):
`singleClusterGSEnergyS 4 197 = -77815/2 = -S(1+zS)` for `S = 197/2, z = 4`. -/
@[simp] theorem singleClusterGSEnergyS_four_hundredninetyseven :
    singleClusterGSEnergyS 4 197 = (-77815 / 2 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-197/2 5-vertex (pentamer) maximum-Casimir-sector energy** (γ-5 step 1479):
`singleClusterMaxEnergyS 4 197 = 38809 = zS²` for `S = 197/2, z = 4`. -/
@[simp] theorem singleClusterMaxEnergyS_four_hundredninetyseven :
    singleClusterMaxEnergyS 4 197 = (38809 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-197/2 6-vertex (hexamer) ground-state energy** (γ-5 step 1480):
`singleClusterGSEnergyS 5 197 = -194439/4 = -S(1+zS)` for `S = 197/2, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_hundredninetyseven :
    singleClusterGSEnergyS 5 197 = (-194439 / 4 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-197/2 6-vertex (hexamer) maximum-Casimir-sector energy** (γ-5 step 1480):
`singleClusterMaxEnergyS 5 197 = 194045/4 = zS²` for `S = 197/2, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_hundredninetyseven :
    singleClusterMaxEnergyS 5 197 = (194045 / 4 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-197/2 7-vertex (heptamer) ground-state energy** (γ-5 step 1481):
`singleClusterGSEnergyS 6 197 = -58312 = -S(1+zS)` for `S = 197/2, z = 6`. Closes spin-197/2 row. -/
@[simp] theorem singleClusterGSEnergyS_six_hundredninetyseven :
    singleClusterGSEnergyS 6 197 = (-58312 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-197/2 7-vertex (heptamer) maximum-Casimir-sector energy** (γ-5 step 1481):
`singleClusterMaxEnergyS 6 197 = 116427/2 = zS²` for `S = 197/2, z = 6`. Closes spin-197/2 row. -/
@[simp] theorem singleClusterMaxEnergyS_six_hundredninetyseven :
    singleClusterMaxEnergyS 6 197 = (116427 / 2 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring
...
/-- **Spin-99 3-vertex (trimer) ground-state energy** (γ-5 step 1483):
`singleClusterGSEnergyS 2 198 = -19701 = -S(1+zS)` for `S = 99, z = 2`. -/
@[simp] theorem singleClusterGSEnergyS_two_hundredninetyeight :
    singleClusterGSEnergyS 2 198 = (-19701 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-99 3-vertex (trimer) maximum-Casimir-sector energy** (γ-5 step 1483):
`singleClusterMaxEnergyS 2 198 = 19602 = zS²` for `S = 99, z = 2`. -/
@[simp] theorem singleClusterMaxEnergyS_two_hundredninetyeight :
    singleClusterMaxEnergyS 2 198 = (19602 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-99 4-vertex (quartet) ground-state energy** (γ-5 step 1484):
`singleClusterGSEnergyS 3 198 = -29502 = -S(1+zS)` for `S = 99, z = 3`. -/
@[simp] theorem singleClusterGSEnergyS_three_hundredninetyeight :
    singleClusterGSEnergyS 3 198 = (-29502 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-99 4-vertex (quartet) maximum-Casimir-sector energy** (γ-5 step 1484):
`singleClusterMaxEnergyS 3 198 = 29403 = zS²` for `S = 99, z = 3`. -/
@[simp] theorem singleClusterMaxEnergyS_three_hundredninetyeight :
    singleClusterMaxEnergyS 3 198 = (29403 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-99 5-vertex (pentamer) ground-state energy** (γ-5 step 1485):
`singleClusterGSEnergyS 4 198 = -39303 = -S(1+zS)` for `S = 99, z = 4`. -/
@[simp] theorem singleClusterGSEnergyS_four_hundredninetyeight :
    singleClusterGSEnergyS 4 198 = (-39303 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-99 5-vertex (pentamer) maximum-Casimir-sector energy** (γ-5 step 1485):
`singleClusterMaxEnergyS 4 198 = 39204 = zS²` for `S = 99, z = 4`. -/
@[simp] theorem singleClusterMaxEnergyS_four_hundredninetyeight :
    singleClusterMaxEnergyS 4 198 = (39204 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-99 6-vertex (hexamer) ground-state energy** (γ-5 step 1486):
`singleClusterGSEnergyS 5 198 = -49104 = -S(1+zS)` for `S = 99, z = 5`. -/
@[simp] theorem singleClusterGSEnergyS_five_hundredninetyeight :
    singleClusterGSEnergyS 5 198 = (-49104 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-99 6-vertex (hexamer) maximum-Casimir-sector energy** (γ-5 step 1486):
`singleClusterMaxEnergyS 5 198 = 49005 = zS²` for `S = 99, z = 5`. -/
@[simp] theorem singleClusterMaxEnergyS_five_hundredninetyeight :
    singleClusterMaxEnergyS 5 198 = (49005 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring

/-- **Spin-99 7-vertex (heptamer) ground-state energy** (γ-5 step 1487):
`singleClusterGSEnergyS 6 198 = -58905 = -S(1+zS)` for `S = 99, z = 6`. Closes spin-99 row. -/
@[simp] theorem singleClusterGSEnergyS_six_hundredninetyeight :
    singleClusterGSEnergyS 6 198 = (-58905 : ℂ) := by
  unfold singleClusterGSEnergyS
  push_cast
  ring

/-- **Spin-99 7-vertex (heptamer) maximum-Casimir-sector energy** (γ-5 step 1487):
`singleClusterMaxEnergyS 6 198 = 58806 = zS²` for `S = 99, z = 6`. Closes spin-99 row. -/
@[simp] theorem singleClusterMaxEnergyS_six_hundredninetyeight :
    singleClusterMaxEnergyS 6 198 = (58806 : ℂ) := by
  unfold singleClusterMaxEnergyS
  push_cast
  ring
