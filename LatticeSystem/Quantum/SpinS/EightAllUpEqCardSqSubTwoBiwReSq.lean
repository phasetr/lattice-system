...
Real-axis variant of PR #3257 using PR #3294 (`‖biw‖ = |biw.re|`):

  `8·⟨Φ_↑⟩.re = (|Λ|·N)² − (2·biw.re)²`
...
/-- **`8·⟨Φ_↑⟩.re = (|Λ|·N)² − (2·biw.re)²`** unconditionally. -/
theorem heisenbergToyHamiltonianS_eight_allAligned_zero_expectation_re_eq_card_sq_sub_two_biw_re_sq
  ...
  have h_norm := heisenbergToyHamiltonianS_eight_allAligned_zero_expectation_re_eq_card_sq_sub_two_biw_norm_sq
    (Λ := Λ) (A := A) (N := N)
