...
This module contains the predicted-Casimir adjacent common-energy
specializations and ladder-image packages split from `Theorem23.lean`. The
base module keeps the site-sum and Casimir-nonvanishing common-energy links,
while this module packages the predicted-Casimir endpoint-mismatch discharge
and ladder-image Casimir preservation outputs consumed by the dominance and
sector-existence layers.
