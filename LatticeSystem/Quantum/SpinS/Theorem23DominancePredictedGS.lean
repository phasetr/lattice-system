...
It keeps the three adjacent predicted-GS successor common-energy steps; the
adjacent predicted-GS predecessor common-energy step is split into
`Theorem23DominancePredictedGSPredecessor.lean`.
