...
Mirror of PR #3200. From PR #3206 (`⟨Φ_↓⟩.re + ⟨Φ_Néel⟩.re = 0`):
...
/-- **`2·⟨Φ_↓⟩.re = (⟨Φ_↓⟩ − ⟨Φ_Néel⟩).re`** unconditionally. Mirror of PR #3200. -/
theorem heisenbergToyHamiltonianS_two_allAligned_last_expectation_re_eq_variational_gap_re
