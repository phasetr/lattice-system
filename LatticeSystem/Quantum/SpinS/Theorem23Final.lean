...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 threaded predicted-GS full-admissible-reach
boundary**: this replaces the outside-sector ground-energy lower family in the
threaded public predecessor-difference boundary by the full-space admissible
reach callback.

The direct full-admissible-reach bridge supplies the outside-sector
ground-energy lower family, which is fed into the source common-energy final
boundary together with the explicit admissible-sector non-emptiness callback. -/
abbrev
    tasaki_2_5_theorem_2_3_of_threaded_predictedGS_of_unpacked_reembedded_real_source_weight_predecessor_difference_pos_of_full_admissible_reach
    (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 threaded predicted-GS iterated-ladder
full-reach boundary**: this public threaded boundary accepts left and right
iterated total-spin ladder non-zeroness callbacks instead of an outside-sector
ground-energy lower family. -/
abbrev
    tasaki_2_5_theorem_2_3_of_threaded_predictedGS_of_unpacked_reembedded_real_source_weight_predecessor_difference_pos_of_iterated_ladder_full_reach
    (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 threaded predicted-GS iterated-ladder Casimir
full-reach boundary**: this public threaded boundary accepts left and right
Casimir ladder-avoidance callbacks instead of an outside-sector ground-energy
lower family. -/
abbrev
    tasaki_2_5_theorem_2_3_of_threaded_predictedGS_of_unpacked_reembedded_real_source_weight_predecessor_difference_pos_of_iterated_ladder_casimir_full_reach
    (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 threaded predicted-GS side-admissible-reach
boundary**: this public threaded boundary accepts separate left and right
outside-sector reach callbacks instead of an outside-sector ground-energy lower
family. -/
abbrev
    tasaki_2_5_theorem_2_3_of_threaded_predictedGS_of_unpacked_reembedded_real_source_weight_predecessor_difference_pos_of_side_admissible_reach
    (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 threaded saturated eigen-source boundary**:
this non-discharged threaded final boundary accepts saturated-Heisenberg source
callbacks together with saturated-Casimir source callbacks while keeping
admissible-sector non-emptiness explicit.  The saturated eigen-source
outside-ground bridge supplies the lower family before the wrapper invokes the
source predicted-GS common-energy final boundary. -/
abbrev
    tasaki_2_5_theorem_2_3_of_threaded_predictedGS_of_unpacked_reembedded_real_source_weight_predecessor_difference_pos_of_saturated_eigen_sources
    [Nonempty V] (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 threaded saturated source-energy boundary**:
this non-discharged threaded final boundary accepts scalar saturated
source-energy callbacks together with saturated-Casimir source callbacks while
keeping admissible-sector non-emptiness explicit.  The saturated source-energy
outside-ground bridge supplies the lower family before the wrapper invokes the
source predicted-GS common-energy final boundary. -/
abbrev
    tasaki_2_5_theorem_2_3_of_threaded_predictedGS_of_unpacked_reembedded_real_source_weight_predecessor_difference_pos_of_saturated_source_energy
    [Nonempty V] (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 threaded saturated-joint reference boundary**:
this non-discharged threaded final boundary accepts sectorwise saturated joint
reference callbacks directly while keeping admissible-sector non-emptiness
explicit.  The saturated joint-reference outside-ground bridge supplies the
lower family before the wrapper invokes the source predicted-GS common-energy
final boundary. -/
abbrev
    tasaki_2_5_theorem_2_3_of_threaded_predictedGS_of_unpacked_reembedded_real_source_weight_predecessor_difference_pos_of_saturated_joint_references
    [Nonempty V] (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
  ...
  exact
    tasaki_2_5_theorem_2_3_of_source_predictedGS_common_energy_chain_and_outside_sector_ground_energy_lower_bound
      ...
      (tasaki23OutsideGroundEnergyLowerFamilyCallback_of_saturated_joint_references
        (V := V) A N c hJ_real hJ_real' hJ_pos hJ_nn hJ_sym
        hJ_bipartite hc_strict h_intermediate hleft_ref hright_ref)
      hJ_real_final hJ_real'_final hJ_sym_final hJ_nn_final
      hJ_bipartite_final hJ_pos_final hc_strict_final h_intermediate_final
      hA_nonempty hnotA_nonempty

set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 threaded saturated ladder-reference boundary**:
this non-discharged threaded final boundary accepts sectorwise saturated
ladder-reference callbacks directly while keeping admissible-sector
non-emptiness explicit.  The saturated ladder-reference outside-ground bridge
supplies the lower family before the wrapper invokes the source predicted-GS
common-energy final boundary. -/
abbrev
    tasaki_2_5_theorem_2_3_of_threaded_predictedGS_of_unpacked_reembedded_real_source_weight_predecessor_difference_pos_of_saturated_ladder_references
    [Nonempty V] (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 threaded saturated ladder-iterate reference
boundary**: this non-discharged threaded final boundary accepts sectorwise
singleton ladder-iterate reference callbacks directly while keeping
admissible-sector non-emptiness explicit.  The saturated ladder-iterate
reference outside-ground bridge supplies the lower family before the wrapper
invokes the source predicted-GS common-energy final boundary. -/
abbrev
    tasaki_2_5_theorem_2_3_of_threaded_predictedGS_of_unpacked_reembedded_real_source_weight_predecessor_difference_pos_of_saturated_ladder_iterate_references
    [Nonempty V] (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 threaded saturated ladder-iterate
Marshall-positive reference boundary**: this non-discharged threaded final
boundary accepts the concrete Marshall-positive reference callbacks directly
while keeping admissible-sector non-emptiness explicit.  The direct
Marshall-positive reference bridge supplies the lower family before the wrapper
invokes the source predicted-GS common-energy final boundary. -/
abbrev
    tasaki_2_5_theorem_2_3_of_threaded_predictedGS_of_unpacked_reembedded_real_source_weight_predecessor_difference_pos_of_saturated_ladder_iterate_marshall_positive_references
    [Nonempty V] (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 threaded saturated ladder-iterate
Marshall-positive coefficient boundary**: this non-discharged threaded final
boundary accepts the pointwise Marshall-positive coefficient callbacks directly
while keeping admissible-sector non-emptiness explicit.  The direct coefficient
bridge supplies the lower family before the wrapper invokes the source
predicted-GS common-energy final boundary. -/
abbrev
    tasaki_2_5_theorem_2_3_of_threaded_predictedGS_of_unpacked_reembedded_real_source_weight_predecessor_difference_pos_of_saturated_ladder_iterate_marshall_positive_coefficients
    [Nonempty V] (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 named-callback boundary from saturated
ladder-iterate Marshall-positive references**: the public named final boundary
can consume concrete Marshall-positive ladder-iterate reference callbacks
directly.  The direct Marshall-positive reference bridge supplies the
outside-ground lower-family input before the named final boundary is invoked. -/
abbrev
    tasaki_2_5_theorem_2_3_of_saturated_ladder_iterate_marshall_positive_references_named_callbacks
    [Nonempty V] (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 named-callback boundary from saturated
ladder-iterate Marshall-positive coefficients**: the public named final
boundary can consume pointwise Marshall-positive coefficient callbacks
directly.  The direct coefficient bridge supplies the outside-ground lower
family before the named final boundary is invoked. -/
abbrev
    tasaki_2_5_theorem_2_3_of_saturated_ladder_iterate_marshall_positive_coefficients_named_callbacks
    [Nonempty V] (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 left-endpoint named-callback boundary from
saturated ladder-iterate Marshall-positive references**: left-endpoint analogue
of
`tasaki_2_5_theorem_2_3_of_saturated_ladder_iterate_marshall_positive_references_named_callbacks`.
The direct Marshall-positive reference bridge supplies the outside-ground
lower-family callback before the left-endpoint named final boundary is invoked. -/
abbrev
    tasaki_2_5_theorem_2_3_of_left_endpoint_saturated_ladder_iterate_marshall_positive_references_named_callbacks
    [Nonempty V] (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 left-endpoint named-callback boundary from
saturated ladder-iterate Marshall-positive coefficients**: left-endpoint
analogue of
`tasaki_2_5_theorem_2_3_of_saturated_ladder_iterate_marshall_positive_coefficients_named_callbacks`.
The direct coefficient bridge supplies the outside-ground lower-family callback
before the left-endpoint named final boundary is invoked. -/
abbrev
    tasaki_2_5_theorem_2_3_of_left_endpoint_saturated_ladder_iterate_marshall_positive_coefficients_named_callbacks
    [Nonempty V] (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 predecessor-difference named-callback
full-admissible-reach boundary**: this public named boundary accepts the
full-space outside reach callback and feeds its direct lower-family bridge to
the uniform named-callback final theorem. -/
abbrev
    tasaki_2_5_theorem_2_3_of_full_admissible_reach_named_callbacks
    (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 left-endpoint predecessor-difference
named-callback full-admissible-reach boundary**: this is the left-endpoint
version of
`tasaki_2_5_theorem_2_3_of_full_admissible_reach_named_callbacks`. -/
abbrev
    tasaki_2_5_theorem_2_3_of_left_endpoint_full_admissible_reach_named_callbacks
    (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 predecessor-difference named-callback
iterated-ladder full-reach boundary**: this public named boundary accepts left
and right iterated total-spin ladder non-zeroness callbacks and feeds the
direct iterated-ladder lower-family bridge to the uniform named final theorem. -/
abbrev
    tasaki_2_5_theorem_2_3_of_iterated_ladder_full_reach_named_callbacks
    (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 left-endpoint predecessor-difference
named-callback iterated-ladder full-reach boundary**: this is the left-endpoint
version of
`tasaki_2_5_theorem_2_3_of_iterated_ladder_full_reach_named_callbacks`. -/
abbrev
    tasaki_2_5_theorem_2_3_of_left_endpoint_iterated_ladder_full_reach_named_callbacks
    (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 predecessor-difference named-callback
iterated-ladder Casimir full-reach boundary**: this public named boundary
accepts the left and right Casimir ladder-avoidance callbacks and feeds the
direct Casimir lower-family bridge to the uniform named final theorem. -/
abbrev
    tasaki_2_5_theorem_2_3_of_iterated_ladder_casimir_full_reach_named_callbacks
    (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 left-endpoint predecessor-difference
named-callback iterated-ladder Casimir full-reach boundary**: this is the
left-endpoint version of
`tasaki_2_5_theorem_2_3_of_iterated_ladder_casimir_full_reach_named_callbacks`. -/
abbrev
    tasaki_2_5_theorem_2_3_of_left_endpoint_iterated_ladder_casimir_full_reach_named_callbacks
    (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 predecessor-difference named-callback
side-admissible-reach boundary**: this public named boundary accepts the
separate left and right outside-sector reach callbacks and feeds the direct
side lower-family bridge to the uniform named final theorem. -/
abbrev
    tasaki_2_5_theorem_2_3_of_side_admissible_reach_named_callbacks
    (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
...
set_option linter.style.longLine false in
/-- **Tasaki §2.5 Theorem 2.3 left-endpoint predecessor-difference
named-callback side-admissible-reach boundary**: this is the left-endpoint
version of
`tasaki_2_5_theorem_2_3_of_side_admissible_reach_named_callbacks`. -/
abbrev
    tasaki_2_5_theorem_2_3_of_left_endpoint_side_admissible_reach_named_callbacks
    (A : V → Bool) {J : V → V → ℂ} (N : ℕ) (c : ℝ)
    (hBA :
      (Finset.univ.filter (fun x : V => (! A x) = true)).card ≤
        (Finset.univ.filter (fun x : V => A x = true)).card)
