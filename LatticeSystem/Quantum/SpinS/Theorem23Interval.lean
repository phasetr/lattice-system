...
into `Theorem23IntervalJoint.lean`, and the predicted-GS-aware local-comparison
suffix is split into `Theorem23IntervalPredictedGS.lean`, so this module can
stay focused on the adjacent common-energy machinery.
-/
