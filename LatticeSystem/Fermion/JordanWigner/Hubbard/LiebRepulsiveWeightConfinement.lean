...
conditional theorem (the full unconditional discharge has since been completed by PR-15c).
...
restriction via the degenerate `A = ∅`/`A = univ` cases, and adding the uniform disjunct) has
since been discharged by PR-15c. -/
