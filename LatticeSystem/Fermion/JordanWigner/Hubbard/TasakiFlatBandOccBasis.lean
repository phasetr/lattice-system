...
occupied mode creations on the vacuum.  These span the whole space (every rotated list-monomial
either reorders to an occupation monomial or vanishes on a repeated mode), and there are
