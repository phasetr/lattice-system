...
wrapper.  The third records the local predecessor raising-source
difference positivity used by the direct lowered-site-sum interval chain:
...
dominates the on-\(A\) predecessor sum.  This is only an API naming step;
