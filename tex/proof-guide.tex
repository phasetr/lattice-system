...
These identities are classical and appear in every standard quantum
mechanics textbook. Within the references assembled for this project,
the most directly relevant treatment of spin-$\tfrac{1}{2}$ operators
is Tasaki~\cite{Tasaki:QMB} (chapter on quantum spin systems). For a
cross-check of Pauli relations \textit{per se} we used
Nielsen--Chuang~\cite{NielsenChuang}, §2.1.3.
...
computational-basis setup; see Tasaki~\cite{Tasaki:QMB}, chapter on
spin chains, for the physical interpretation.
...
\paragraph{References.}
The 1D transverse-field Ising chain is a textbook example of an
interacting quantum spin system; see
Tasaki~\cite{Tasaki:QMB}, chapter on spin chains.
...
Springer, 2020. Primary reference for quantum spin systems and spin
chains in this project.
...
the standard Pauli relations (§2.1.3).
