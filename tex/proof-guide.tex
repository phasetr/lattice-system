...
Lean also packages this one-step result into the full coefficient chain.  The
new induction boundary
\[
\begin{gathered}
\texttt{tasaki23OutsideGroundSaturatedLadderIterate}\\
...
the Tasaki §2.5 Theorem~2.3 outside-ground boundary (Tasaki, Springer 2020,
§2.5 Theorem~2.3, p.~42).
