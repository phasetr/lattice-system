...
\end{gathered}
\]
then feeds these non-zeroness callbacks through the full-reach bridge and
passes the resulting lower family directly to the source predicted-GS
...
left and right Casimir-avoidance callbacks, then enters the same source
predicted-GS common-energy final boundary directly.
...
\end{gathered}
\]
It converts the saturated-Casimir callbacks to the full-reach lower family and
passes that lower family directly to the source predicted-GS common-energy
final boundary.
...
\end{gathered}
\]
It performs the ladder-span to saturated-Casimir conversion internally and then
passes the resulting lower family directly to the source predicted-GS
common-energy final boundary.
...
\end{gathered}
\]
It performs the joint-eigenspace to ladder-span conversion internally and then
passes the resulting lower family directly to the source predicted-GS
common-energy final boundary.
