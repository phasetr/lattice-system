...
decomposition; (b) proving the matching lower bound, equivalently
showing the spectrum is exhausted by joint Casimir sectors and that
no sector lies below the predicted value (variational principle /
spectral theorem). Both
