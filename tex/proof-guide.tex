...
bridge, the crossing-set bridge, the first-crossing bridge, and the
argmin-first-crossing bridge, and the first-crossing finrank bridge described
above, plus the path-global finrank bridge.  The remaining case~(ii) task is
to prove the path-global \(\texttt{finrank}\le2\) input along the case~(ii)
deformation path.
