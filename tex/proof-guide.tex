...
PF/min identification for the two bare axis-swapped parity blocks remains the
next case~(ii) input.
...
\(D=0\) variants, including raw-support wrappers at \(D=0\).  The remaining
case~(ii) task is PF/min identification for the shifted matrix on the two bare
axis-swapped parity blocks.
