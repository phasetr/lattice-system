...
\begin{itemize}
  ...
  \item Problem 2.5.b single-cluster transport bridge.  The declaration
        ...
        to the corresponding equivalence of spin-configuration spaces.  The
        theorems \texttt{reindex\_onSiteS\_siteEquiv} and
        ...
        \texttt{Finset.equivFin}, yields the named option-star identity
...
formal work is to pass from the transported finite option-star Hamiltonian to
each same-Hilbert-space graph-local star \(h_x\), so that the Problem~2.5.a
minimum-eigenvalue formula can be fed into the finite-sum lower-bound bridge.
