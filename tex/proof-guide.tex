...
otherwise (\texttt{tJ\_hop\_matrixElement\_eq\_zero\_of\_source}/\texttt{\_of\_target}) --- the
foundation for the per-term $\langle\hat K\rangle\geq0$ non-negativity.  Every off-diagonal
...
A.18 application, and the SU(2)-tower capstone that replaces the axiom.  The discharge lemmas add no
