...
modes}, $\hat n^\mu_{z,\uparrow}\hat n^\mu_{z,\downarrow}\Phi=0$.  The linear independence of the
$\mu$-occupation states and the resulting one-spin-per-index decomposition (eq.~(11.3.47)) and the
sign propagation (eqs.~(11.3.48)/(11.3.49)) toward the connectivity capstone are the subsequent PRs.
