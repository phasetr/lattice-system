...
\item \textbf{Theorem~2.4 status}.  The spin-$1/2$ strict case-(i) interior
  (\(-1<\lambda<1\), \(D>0\)) target uniqueness and zero-magnetization
  ...
  The case~(i) boundary, Tasaki's case~(ii) route, and broader spin-$S$
  axis-swap-unitary instances remain separate future extensions.
\end{itemize}
