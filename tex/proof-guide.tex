...
\item \textbf{Theorem~2.4 status}.  The spin-$1/2$ case-(i)
  (\(-1<\lambda<1\), \(D\ge 0\)) target uniqueness and zero-magnetization
  wrappers are live as
  ...
  \(\lambda=1\) edge of case~(i), Tasaki's case~(ii) route, and broader
  spin-$S$ axis-swap-unitary instances remain separate future extensions.
\end{itemize}
...
\(-1<\lambda<1\), \(D\ge0\).  The \(\lambda=1\) edge of case~(i), case~(ii),
and broader spin-\(S\) axis-swap-unitary extensions remain separate tasks.
