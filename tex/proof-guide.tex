...
block-PF/min bridge described above.  The remaining case~(ii) task is to prove
pathwise PF simplicity and PF/min identification for the two bare axis-swapped
parity blocks in the \(\lambda\ge1\), \(D\le0\) region.
