...
showing the spectrum is exhausted by magnetization and joint total/leaf
Casimir sectors, then applying the coupled leaf/center sector-energy
bridge. The older raw target $\operatorname{Re}\alpha\ge\alpha_{\rm pred}$
