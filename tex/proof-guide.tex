...
therefore reduce the block PF input to the remaining raw
total-Hamiltonian witness/zero classification.  PF/min identification and the
boundary move-set choices when a strict local coefficient vanishes remain
