...
and
\texttt{openChainHeisenbergHamiltonian\_two\_site\_mulVec\_basisVec\_singlet};
the all-down and triplet eigenvalues follow analogously).  The
ferromagnetic ($J<0$) ground state is the triply-degenerate triplet
$\{|{\uparrow}{\uparrow}\rangle,
|{\downarrow}{\downarrow}\rangle,
|{\uparrow}{\downarrow}\rangle + |{\downarrow}{\uparrow}\rangle\}$,
and the antiferromagnetic ($J>0$) ground state is the singlet —
matching Tasaki \S2.4 / \S2.5 for the simplest two-site case.
