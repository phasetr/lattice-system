...
directly to the saturated ladder-iterate outside-ground route.  The final API
wrapper
\[
\begin{gathered}
\texttt{tasaki\_2\_5\_theorem\_2\_3}\\
...
\end{gathered}
\]
passes this lower-family callback into
...
ladder-iterate predecessor-difference route.
