...
raising-direction site-sum layer is split into
\texttt{LatticeSystem/Quantum/SpinS/Theorem23LocalDifferenceRaising.lean}, and
...
\(\texttt{LatticeSystem.Quantum.SpinS.Theorem23LocalDifferenceRaising}\), and
