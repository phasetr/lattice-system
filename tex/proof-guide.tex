...
then feed this strict gap to the no-full-finrank bridge above.  Thus the
remaining case~(ii) input is the crossing contradiction callback itself.
...
no-full-finrank bridge, and the crossing-callback bridge described above.  The
remaining case~(ii) task is to prove the crossing contradiction callback.
