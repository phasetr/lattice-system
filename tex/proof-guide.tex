...
--- the seed of the eq.~(11.3.48) sign relation.  Reordering an arbitrary occupied pair to the front
(canonical/swap relative sign) and collecting the surviving $(D_0{-}2)$-occupied terms is the
