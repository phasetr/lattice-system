...
(a) constructing an actual joint-Casimir eigenvector at the GS sector
$(s_R, s_{\rm tot}) = (zN/2, (z-1)N/2)$ via Clebsch--Gordan decomposition,
and (b) discharging the explicit algebraic-closedness hypothesis if a more
constructive finite-dimensional spectral decomposition is later preferred.
The global lower-bound callback itself now follows from magnetization
extraction, joint-Casimir extraction inside the Hamiltonian/magnetization
submodule, and the coupled leaf/center sector-energy bridge. The remaining
GS-sector witness work still requires substantial multi-PR effort
(SU(2) representation theory or spin-$S$ Perron--Frobenius on the dressed
Hamiltonian extending the spin-$1/2$ work in
