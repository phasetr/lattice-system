...
spin, predicted Casimir, and admissible-sector interval API used by this
definition are factored into
...
\texttt{Theorem23.lean} module now starts from the endpoint mismatch
and interval-chain layer while importing that local API. The
...
\end{gathered}
\]
The interval-chain callbacks are isolated in
...
\(\texttt{Theorem23}\) keeps the main interval-chain development.
