...
satisfies eq.~(2.2.13)) is open. With eq.~(2.2.11) now proved
unconditionally (no axioms), the missing ingredient is a generic
\texttt{exp\_commute\_of\_commute} lifted to many-body operators.
