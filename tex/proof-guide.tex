...
The case~(ii) full \(\texttt{finrank}\le2\) input remains explicit.
...
has the conditional path/target bridge and the strict-gap bridge described
above, while the case~(ii) full \(\texttt{finrank}\le2\) replacement remains
the next task.
