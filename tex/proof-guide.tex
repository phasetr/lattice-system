...
\textbf{Step 91 (PR~\#2877)}: bridge identity in $\|\mathrm{biw}\|^2$
form in
...
(since $\mathrm{biw}$ is real, PR \#2825) into Step 90;
the natural form for Tasaki §2.5 Theorem 2.3 where the
predicted spin magnitude
