...
the predecessor-difference and raised/lowered site-sum tail split into
...
local predecessor-difference and adjacent-sector energy tail is isolated
in
\(\texttt{LatticeSystem.Quantum.SpinS.Theorem23LocalDifference}\), with
