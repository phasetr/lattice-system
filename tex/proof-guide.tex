...
The remaining case~(ii) shifted-matrix work is global entrywise
non-negativity/off-diagonal support, PF/min identification, and the boundary
...
reachability totality.  The remaining case~(ii) task is to prove global
entrywise non-negativity/off-diagonal support, handle the boundary move sets
where a strict local coefficient vanishes, and prove PF/min identification for
the shifted matrix on the two bare axis-swapped parity blocks.
