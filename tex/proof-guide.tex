...
$\hat c_{x,\downarrow}\hat c_{x,\uparrow}\Phi=0$) and is annihilated by $\hat C_\sigma(w)$ for
\emph{every} $w\in\operatorname{range}T=(\ker T)^\perp$.  The single-particle space is split by
