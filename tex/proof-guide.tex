...
Remaining: the operator lift $\hat H_{\rm tJ}(\texttt{tJExpansion}\,v)=\mu\cdot\texttt{tJExpansion}\,v$
(showing $\hat H_{\rm tJ}|\Phi_s\rangle$ sector-supported via $[\hat H_{\rm tJ},\hat N]=[\hat H_{\rm
tJ},\hat S^3]=0$ and hard-core preservation, then completeness), the total-spin
