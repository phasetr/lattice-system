...
\texttt{generalModeMonomial\_perm}).  Collecting the surviving $(D_0{-}2)$-occupied terms by removed
index pair is the subsequent PR.  The double-annihilation expansion and sign relation
