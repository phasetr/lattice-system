...
\end{Verbatim}
The first name records the balanced-cardinality arithmetic: when
...
a full Heisenberg eigenvector with total-Casimir eigenvalue zero.  The following
two
...
strictness.  Consequently the final packaged theorem assembles the consumer
...
The only missing ingredient is now precisely that strict outside-sector lower
bound from the MLM/Casimir ladder, not any strict-gap theorem from the
anisotropic deformation chain.  References: H.~Tasaki, \emph{Physics and
