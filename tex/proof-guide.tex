...
\texttt{LatticeSystem/Quantum/SpinS/Theorem23Local.lean}; the main
\texttt{Theorem23.lean} module now starts from the adjacent common-energy
chain while importing those APIs. The
