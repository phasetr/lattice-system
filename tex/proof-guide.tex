...
Remaining: identifying that ground state's total spin ($S_{\mathrm{tot}}=N_e/2$) by overlap with the
ferromagnetic state, and the SU(2)-tower capstone that replaces the axiom.
