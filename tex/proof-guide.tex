...
\end{gathered}
\]
feeds this real-coupling lower-family callback directly into the discharged
final predecessor-difference boundary, so the public discharged route no
longer exposes either the outside-sector lower-family hypothesis or the
saturated-energy real-scalar hypothesis.  The shorter named wrapper
\[
\begin{gathered}
\texttt{tasaki\_2\_5\_theorem\_2\_3}\\
\texttt{\_of\_saturated\_ladder\_iterate}\\
