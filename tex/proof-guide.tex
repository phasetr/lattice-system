...
axiom \texttt{hermitian\_eigenvalues}$_0$\texttt{\_monotone} (\texttt{Math/MatrixAnalysis/EigenvalueMonotone.lean}),
...
\texttt{mathlib} supports is proved axiom-free: A.4--A.6, A.9--A.11, A.13--A.20 (including the
simultaneous-diagonalization step of A.17, Perron--Frobenius for a real symmetric matrix A.18, and the
polar / singular-value decompositions A.19/A.20).  The remaining items---A.1, A.7/A.8, A.12, and the
operator-algebraic A.21--A.28 (Wigner, states, Banach--Alaoglu, ground states, GNS)---are recorded as
faithful documented axioms.  These
