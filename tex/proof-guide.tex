...
of \(\hat H_{\rm eff}\)'' is the same Perron--Frobenius notion. The necessary and
sufficient combinatorial criterion (Theorem 11.8, biconnected and not a simple
loop \(> 4\) sites) and the exchange-bond sufficient condition (Lemma 11.9)
follow in the book; their formalization is planned next.}
