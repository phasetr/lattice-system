...
local ladder and single-site calculation layer is factored into
\texttt{LatticeSystem/Quantum/SpinS/Theorem23Local.lean}.  The lowered
...
\(\texttt{LatticeSystem.Quantum.SpinS.Theorem23Predicted}\).  The
