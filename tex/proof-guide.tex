...
flat-supported occupation monomials with \emph{exactly} $D_0$ occupied modes.  The spin
representation (eq.~(11.3.47)) and the sign propagation (eqs.~(11.3.48)/(11.3.49)) toward the
connectivity capstone are the subsequent PRs.
