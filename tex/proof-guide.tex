...
configurations $\sigma:\Lambda\to\{\uparrow,\downarrow\}$ form a finite type, the span membership of
PR11 gives an explicit finite combination $\Phi=\sum_\sigma C(\sigma)\,\texttt{flatBandSpinConfigState}\,
\sigma$ (\texttt{flatBand\_groundState\_eq\_spinConfigStateSum}, via
\texttt{Submodule.mem\_span\_range\_iff\_exists\_fun}) --- the explicit $C(\sigma)$ form of
eqs.~(11.3.47)–(11.3.48).  The double-annihilation expansion and sign relation
