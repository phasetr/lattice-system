...
and one-hole Nagaoka discussion in Tasaki 1st edition, §11.2,
pp.~381--388.

\noindent\textbf{Theorem} (Tasaki 1st edition, §11.2, pp.~381--388).
...
Hubbard hard-core subspace: $H_{\mathrm{int}}\psi=0$ for no-double-occupancy states (Tasaki 1st ed., §11.2, pp.~381--388) & finite-dim & \emph{formalized} \\
