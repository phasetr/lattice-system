...
(\texttt{flatBandModeFockSubmodule\_eq\_top}).  This is the spanning foundation for
the $\hat b$-kernel $\subseteq$ $\alpha$-Fock factorisation (the remaining
$\beta$-annihilator peel is deferred to a follow-up).
