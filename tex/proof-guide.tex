...
\begin{itemize}
  ...
  \item Leaf-Casimir spectral maximum bound:
        ...
        therefore remove the leaf upper-bound hypothesis from the
        lower-bound bridge ($\gamma$-5 step 329).
\end{itemize}
...
showing the spectrum is exhausted by joint Casimir sectors and proving
the remaining total-Casimir sector bound that places $\alpha$ above
$\alpha_{\rm pred}$ for every sector (the leaf bound
$\beta \le \beta_{\max}$ now follows from the sublattice spectral maximum
bound). Both
