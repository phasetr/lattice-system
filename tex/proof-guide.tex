...
the remaining case~(ii) shifted-matrix work is reachability/irreducibility and
PF/min identification, together with the boundary move-set choices when a
strict local coefficient vanishes.
...
remaining case~(ii) task is to prove reachability/irreducibility, handle the
boundary move sets where a strict local coefficient vanishes, and prove PF/min
