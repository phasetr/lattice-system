...
for $z\notin I$.  The coefficient extraction (no double occupancy + filling $\Rightarrow$ one spin
per index, eq.~(11.3.47)) and the sign propagation (eqs.~(11.3.48)/(11.3.49)) toward the connectivity
capstone are the subsequent PRs.
