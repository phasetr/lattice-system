...
case~(ii) deformation path; the remaining pathwise case~(ii) task is to
supply the appropriate strict or zero-coefficient reachability hypotheses
along the path, together with the explicit \((\lambda,D)=(1,0)\) corner
PF/min callback.
