...
$c\,c^\dagger$). This establishes the polynomial functional
calculus on the two rank-one projectors: any non-zero polynomial
in $n$ collapses to a linear combination of $1$ and $n$, and
similarly for $c\,c^\dagger$. Useful for matrix-exponential
expansions and spectral computations.
