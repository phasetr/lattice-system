...
lowering component and filtered local sign-sum layer is isolated in
\texttt{LatticeSystem/Quantum/SpinS/Theorem23LocalLowering.lean}.  The lowered
...
\(\texttt{LatticeSystem.Quantum.SpinS.Theorem23LocalLowering}\).  The
