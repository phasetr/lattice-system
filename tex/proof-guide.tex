...
main \texttt{Theorem23.lean} module now starts from the adjacent
common-energy chain while importing those APIs.  The local adjacent-sector
energy comparison suffix is isolated in
