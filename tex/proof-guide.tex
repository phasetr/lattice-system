...
The remaining case~(ii) task is to build the parity-gauged shifted PF matrix
and prove pathwise PF simplicity and PF/min identification for the two bare
axis-swapped parity blocks in the \(\lambda\ge1\), \(D\le0\) region.
