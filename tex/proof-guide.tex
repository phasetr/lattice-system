...
The result is deep; Tasaki proves it via Lemma 11.16 (a special basis $\{\mu_z\}$ of $h_0$) and
Theorem 11.17 (connectedness of that basis).  It is recorded as the documented axiom
\texttt{tasaki\_theorem\_11\_15}, matching the policy for Theorems 11.8 / 11.13; the proof and
the §11.3.4 companion results are deferred to later work.
