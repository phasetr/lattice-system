...
then gives the required \(\mu\le\mu_M\).  The final named predecessor-difference
boundaries
\[
\begin{gathered}
...
\end{gathered}
\]
use this bridge to replace the outside-ground lower-family hypothesis by
