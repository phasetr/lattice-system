...
\texttt{mathlib} supports is proved axiom-free: A.4--A.6, A.9--A.11, A.13--A.18 (including the
simultaneous-diagonalization step of A.17 and Perron--Frobenius for a real symmetric matrix A.18).
The remaining items---A.1, A.7/A.8, A.12, A.19/A.20, and the operator-algebraic A.21--A.28 (Wigner,
