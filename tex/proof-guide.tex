...
which is hard-core, injective and orthonormal, with $\hat N$/$\hat S^z$ eigenvalues placing it in
the $N_e$-electron, $\hat S^z=\tfrac12$ sector.  \emph{(iii) Sign-free hopping.}  Acting
$\hat c^\dagger_{b\sigma}\hat c_{a\sigma}$ on $|\Phi_s\rangle$ produces, up to a Jordan--Wigner
sign, $|\Phi_{\texttt{tJSiteHop}\,s\,a\,b}\rangle$; the forward parity
...
occupation is $N_e-1$).  Hence every kinetic matrix element
$\langle\Phi_{s'}|\hat c^\dagger_{b\sigma}\hat c_{a\sigma}|\Phi_s\rangle=[\,s'=\texttt{tJSiteHop}\,
s\,a\,b\,]\in\{0,1\}$.  \emph{(iv) Sign-free exchange.}  The ladder $\hat S^+_i\hat S^-_j=\hat
...
\langle\Phi_{s'}|\hat c^\dagger_{i\sigma}\hat c_{j\sigma}|\Phi_s\rangle$.  Every off-diagonal
contribution is thus $-\tau$ (hopping), $-J/2$ (exchange), or $0$ (diagonal) --- all
\emph{non-positive}, the hypothesis of the Perron--Frobenius Theorem A.18.  Remaining: the
$\langle\hat K\rangle\geq0$ assembly, the real-symmetric sector matrix and its irreducibility, the
A.18 application, and the SU(2)-tower capstone that replaces the axiom.  All discharge lemmas are
axiom-free.
