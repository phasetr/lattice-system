...
the new file \texttt{Quantum/SpinS/Problem25dLadderDotReduction.lean}
packages the algebraic reduction from the positive signed ladder correlation
to positive signed dot-product correlation.  It introduces
\texttt{twoSpinMinusPlusCorrelationS} and \texttt{twoSpinZZCorrelationS}, and
lifts
\[
  \hat S_x\cdot\hat S_y
  =
