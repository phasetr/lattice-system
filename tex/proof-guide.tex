...
strictly positive summand.  These bounds decompose the remaining strict
site-sum positivity problem into the non-negative off-\(A\) part and
the non-positive on-\(A\) part, without yet proving that the former
