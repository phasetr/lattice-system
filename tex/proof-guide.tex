...
local ladder, signed site-contribution, and adjacent-sector energy
comparison layer is factored into
\texttt{LatticeSystem/Quantum/SpinS/Theorem23Local.lean}, with the
predecessor-difference and raised/lowered site-sum tail split into
...
common-energy chain while importing those APIs.  The local
...
\[
  ...
  \bigl(\hat S^-_x\,\mathrm{magSectorEmbedding}(\Phi_M)\bigr)(\tau)
\]
as \texttt{tasaki23SignedLoweringSiteContribution}.  Since \(A(x)\) is
