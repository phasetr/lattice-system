...
irreducibility layer.  The remaining case~(ii) shifted-matrix work is the raw
total-Hamiltonian support/sign split, PF/min identification, and the boundary
move-set choices when a strict local coefficient vanishes.
...
zero-support pairs.  The remaining case~(ii) task is to prove the raw
total-Hamiltonian support/sign split, handle the boundary move sets where a
strict local coefficient vanishes, and prove PF/min identification for the
shifted matrix on the two bare axis-swapped parity blocks.
