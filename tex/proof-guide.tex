...
bubble target).
Remaining: the selection-sort bubble $+$ disagreement induction assembling these into
$\text{same-counts}\Rightarrow\texttt{AdjacentSwapReachable}$, the
irreducibility of $-M$ + A.18 application, and the SU(2)-tower capstone that replaces the axiom.
