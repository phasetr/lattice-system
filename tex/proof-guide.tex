...
Issue \#4363, \texttt{GeneralFlatBandSignPropagation.lean}).}  To compare list orderings (the opaque
...
\#4363, \texttt{GeneralFlatBandSignPropagation.lean}).}  The orbital-ordered creation list of a spin
...
\#4363, \texttt{GeneralFlatBandSignPropagation.lean}).}  On the orbital-ordered form, site
...
\#4363, \texttt{GeneralFlatBandSignPropagation.lean}).}  On the swapped down--up head pair, the
...
\#4363, \texttt{GeneralFlatBandSignPropagation.lean}).}  To extract an \emph{arbitrary} occupied pair
...
§11.3.4, Issue \#4363, \texttt{GeneralFlatBandSignPropagation.lean}).}  Composing the move-pair-front
...
§11.3.4, Issue \#4363, \texttt{GeneralFlatBandSignPropagation.lean}).}  The sign-relation comparison
...
split from \texttt{GeneralFlatBandSignPropagation.lean} for build speed.)  The double-annihilation expansion and sign relation
