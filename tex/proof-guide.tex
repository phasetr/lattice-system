...
path-global finrank bridge, and the block-path finrank bridge described above.
The remaining case~(ii) task is to prove the pathwise axis-swapped
parity-block submatrix \(\texttt{finrank}\le1\) input along the case~(ii)
deformation path.
