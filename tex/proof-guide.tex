...
The remaining callback is only balanced-sector PF simplicity.  References:
...
boundary.  The remaining explicit callback is the balanced-sector
Perron--Frobenius simplicity at the Theorem~2.3 common Hermitian minimum.
