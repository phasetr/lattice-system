...
\(2\hat S_A^3\hat S_{\bar A}^3\).  Thus the cross-sublattice spin-dot
constraint is available in the ladder-term form needed for the remaining
comparison between \(\hat S_A^-\Phi\) and
\(\hat S_{\bar A}^-\Phi\).
