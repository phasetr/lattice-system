...
predicted-Casimir interval-chain and minimality callback suffix is isolated in
\texttt{LatticeSystem/Quantum/SpinS/Theorem23IntervalCasimir.lean}. The
...
predicted-Casimir interval-chain and minimality callback suffix split further
into
\(\texttt{LatticeSystem.Quantum.SpinS.Theorem23IntervalCasimir}\).  The
