...
strict positivity of the lowered single-site sum.  Thus the next final
wrapper can feed the fully threaded predecessor-difference callback
directly into the lowered site-sum successor chain, rather than first
restating it as a raising-source dominance callback.
