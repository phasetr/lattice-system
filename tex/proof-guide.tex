...
$c_i + c_i^\dagger = \mathrm{jwString}_i \cdot \sigma_x_i$, and
$(\mathrm{jwString}_i \cdot \sigma_x_i)^2 = 1$ since
...
\sigma_x_i$ pick up the JW string sign and anticommute across
sites.
