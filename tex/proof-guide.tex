...
so does the ground state --- \texttt{flatBand\_groundState\_mem\_generalFlatBandFockSubmodule}.  The
spin representation (eq.~(11.3.47), via no double occupancy and $\mu$'s site-localisation) and the
