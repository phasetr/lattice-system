...
coefficient and predecessor raising-source layer is isolated in
\texttt{LatticeSystem/Quantum/SpinS/Theorem23LocalCoefficient.lean}, with
the predecessor-difference callback layer split into
...
\(\texttt{LatticeSystem.Quantum.SpinS.Theorem23LocalCoefficient}\).  The
