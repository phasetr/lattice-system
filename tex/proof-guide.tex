...
$-(J/2)\cdot(\geq0)\leq0$.  Every off-diagonal
contribution is thus $-\tau$ (hopping), $-J/2$ (exchange), or $0$ (diagonal) --- all
\emph{non-positive}, the hypothesis of the Perron--Frobenius Theorem A.18.  Remaining: the exchange
$\langle\hat S^+\hat S^-+\hat S^-\hat S^+\rangle$ bond-sum assembly, the
real-symmetric sector matrix and its irreducibility, the
