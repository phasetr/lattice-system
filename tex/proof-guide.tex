...
What remains for the full theorem is the existence of such a ground state \(v\),
namely the Perron--Frobenius ferromagnetic ground state of the one-hole hopping
problem in the all-up sector.

\medskip
\noindent The Lean development
(file \texttt{Fermion/JordanWigner/Hubbard/WeakNagaokaTheorem.lean}):
...
\texttt{fermionTotalSpinZ\_mulVec\_spinMinusPow},
\texttt{fermionTotalSpinSquared\_mulVec\_spinMinusPow},
\texttt{spinMinusPow\_ne\_zero}, \texttt{spinMinusPow\_linearIndependent},
\texttt{hubbardEffectiveHamiltonian\_mulVec\_spinMinusPow}, and the capstone
\texttt{weakNagaoka\_spinMultiplet}.
