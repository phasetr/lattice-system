...
the explicit corner PF/min callbacks.
...
parity-block boundedness.  The remaining pathwise case~(ii) input is therefore
the appropriate strict, ion-only, or bond-only reachability totality for both
parity blocks, together with the explicit \((\lambda,D)=(1,0)\) corner PF/min
callbacks.
