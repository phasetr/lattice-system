...
Thus the remaining case~(ii) input is the strict-gap derivation itself.
...
has the conditional path/target bridge, the strict-gap bridge, and the
no-full-finrank bridge described above.  The remaining case~(ii) task is to
derive the strict sector gap.
