...
\item \texttt{spinOneOpPlus}, \texttt{spinOneOpMinus},
  ...
  \texttt{spinOneOpPlus/Minus\_conjTranspose}, \texttt{spinOneRot3}:
  $S = 1$ basis, raising/lowering, adjoints, and closed-form rotation
  (axis 3) (Tasaki eq.~(2.1.2)-(2.1.6) for $S=1$, Problem 2.1.c).
