...
Remaining: the A.18 application (\texttt{perronFrobenius\_real\_symmetric} on $B$, with a
nonempty-sector witness) giving the unique positive sector ground state, and the
SU(2)-tower capstone that replaces the axiom.
