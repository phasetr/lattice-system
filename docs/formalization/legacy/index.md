...
> `docs/index.md` theorem catalogue. They remain authoritative for formalization
> status and capstone identification for as long as the version 2 catalogue is
> published as a non-authoritative prototype. The version 2 JSON records are
> still a non-authoritative prototype.
