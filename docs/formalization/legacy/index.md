...
- [Multi-mode fermion via Jordan–Wigner (P2 backbone) — part 1 of 4](/lattice-system/formalization/legacy/30-multi-mode-fermion-via-jordan-wigner-p2-backbone-part-01/)
- [Multi-mode fermion via Jordan–Wigner (P2 backbone) — part 2 of 4](/lattice-system/formalization/legacy/30-multi-mode-fermion-via-jordan-wigner-p2-backbone-part-02/)
- [Multi-mode fermion via Jordan–Wigner (P2 backbone) — part 3 of 4](/lattice-system/formalization/legacy/30-multi-mode-fermion-via-jordan-wigner-p2-backbone-part-03/)
- [Multi-mode fermion via Jordan–Wigner (P2 backbone) — part 4 of 4](/lattice-system/formalization/legacy/30-multi-mode-fermion-via-jordan-wigner-p2-backbone-part-04/)
