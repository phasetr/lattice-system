...
| `singleClusterGSEnergyS_six_fifteen` / `singleClusterMaxEnergyS_six_fifteen` | **Spin-15/2 7-vertex star numerics**: `GS 6 15 = -345 = -S(1+zS)`, `Max 6 15 = 675/2 = zS²` for `S = 15/2, z = 6` (γ-5 step 390) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
