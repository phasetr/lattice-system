...
| `singleClusterGSEnergyS_five_twentynine` / `singleClusterMaxEnergyS_five_twentynine` | **Spin-29/2 6-vertex star numerics**: `GS 5 29 = -4263/4 = -S(1+zS)`, `Max 5 29 = 4205/4 = zS²` for `S = 29/2, z = 5` (γ-5 step 472) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
