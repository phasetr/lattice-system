...
| `singleClusterGSEnergyS_three_twentyseven` / `singleClusterMaxEnergyS_three_twentyseven` | **Spin-27/2 4-vertex star numerics**: `GS 3 27 = -2241/4 = -S(1+zS)`, `Max 3 27 = 2187/4 = zS²` for `S = 27/2, z = 3` (γ-5 step 458) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
