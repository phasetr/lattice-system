...
| `singleClusterGSEnergyS_six_twentyfour` / `singleClusterMaxEnergyS_six_twentyfour` | **Spin-12 7-vertex star numerics**: `GS 6 24 = -876 = -S(1+zS)`, `Max 6 24 = 864 = zS²` for `S = 12, z = 6` (γ-5 step 443) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
