...
| `singleClusterGSEnergyS_one_twelve` / `singleClusterMaxEnergyS_one_twelve` | **Spin-6 dimer numerics**: `GS 1 12 = -42 = -S(S+1)`, `Max 1 12 = 36 = S²` for `S = 6` (γ-5 step 366) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
