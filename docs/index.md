...
| `singleClusterGSEnergyS_one_eight` / `singleClusterMaxEnergyS_one_eight` | **Spin-4 dimer numerics**: `GS 1 8 = -20 = -S(S+1)`, `Max 1 8 = 16 = S²` for `S = 4` (γ-5 step 319) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
