...
| `singleClusterGSEnergyS_four_twentysix` / `singleClusterMaxEnergyS_four_twentysix` | **Spin-13 5-vertex star numerics**: `GS 4 26 = -689 = -S(1+zS)`, `Max 4 26 = 676 = zS²` for `S = 13, z = 4` (γ-5 step 453) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
