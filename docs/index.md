...
| `singleClusterGSEnergyS_one_seven` / `singleClusterMaxEnergyS_one_seven` | **Spin-7/2 dimer numerics**: `GS 1 7 = -63/4 = -S(S+1)`, `Max 1 7 = 49/4 = S²` for `S = 7/2` (γ-5 step 337) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
