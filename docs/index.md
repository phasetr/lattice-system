...
| `singleClusterGSEnergyS_one_five` / `singleClusterMaxEnergyS_one_five` | **Spin-5/2 dimer numerics**: `GS 1 5 = -35/4 = -S(S+1)`, `Max 1 5 = 25/4 = S²` for `S = 5/2` (γ-5 step 291) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
