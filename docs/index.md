...
| `singleClusterGSEnergyS_one_twentyone` / `singleClusterMaxEnergyS_one_twentyone` | **Spin-21/2 dimer numerics**: `GS 1 21 = -483/4 = -S(S+1)`, `Max 1 21 = 441/4 = S²` for `S = 21/2` (γ-5 step 420) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
