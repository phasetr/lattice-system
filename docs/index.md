...
| `singleClusterGSEnergyS_five_twentytwo` / `singleClusterMaxEnergyS_five_twentytwo` | **Spin-11 6-vertex star numerics**: `GS 5 22 = -616 = -S(1+zS)`, `Max 5 22 = 605 = zS²` for `S = 11, z = 5` (γ-5 step 430) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
