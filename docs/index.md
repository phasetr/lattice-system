...
| `singleClusterGSEnergyS_four_nine` / `singleClusterMaxEnergyS_four_nine` | **Spin-9/2 5-vertex star numerics**: `GS 4 9 = -171/2 = -S(1+zS)`, `Max 4 9 = 81 = zS²` for `S = 9/2, z = 4` (γ-5 step 351) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
