...
| `singleClusterGSEnergyS_six_twentyeight` / `singleClusterMaxEnergyS_six_twentyeight` | **Spin-14 7-vertex star numerics**: `GS 6 28 = -1190 = -S(1+zS)`, `Max 6 28 = 1176 = zS²` for `S = 14, z = 6` (γ-5 step 467) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
