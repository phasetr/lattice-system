...
| `singleClusterGSEnergyS_six_thirty` / `singleClusterMaxEnergyS_six_thirty` | **Spin-15 7-vertex star numerics**: `GS 6 30 = -1365 = -S(1+zS)`, `Max 6 30 = 1350 = zS²` for `S = 15, z = 6` (γ-5 step 479) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
