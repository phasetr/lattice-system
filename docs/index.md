...
| `singleClusterGSEnergyS_five_twelve` / `singleClusterMaxEnergyS_five_twelve` | **Spin-6 6-vertex star numerics**: `GS 5 12 = -186 = -S(1+zS)`, `Max 5 12 = 180 = zS²` for `S = 6, z = 5` (γ-5 step 370) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
