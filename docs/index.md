...
| `singleClusterGSEnergyS_five_ten` / `singleClusterMaxEnergyS_five_ten` | **Spin-5 6-vertex star numerics**: `GS 5 10 = -130 = -S(1+zS)`, `Max 5 10 = 125 = zS²` for `S = 5, z = 5` (γ-5 step 358) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
