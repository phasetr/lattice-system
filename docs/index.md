...
| `singleClusterGSEnergyS_three_nineteen` / `singleClusterMaxEnergyS_three_nineteen` | **Spin-19/2 4-vertex star numerics**: `GS 3 19 = -1121/4 = -S(1+zS)`, `Max 3 19 = 1083/4 = zS²` for `S = 19/2, z = 3` (γ-5 step 410) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
