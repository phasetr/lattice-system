...
| `singleClusterGSEnergyS_four_fourteen` / `singleClusterMaxEnergyS_four_fourteen` | **Spin-7 5-vertex star numerics**: `GS 4 14 = -203 = -S(1+zS)`, `Max 4 14 = 196 = zS²` for `S = 7, z = 4` (γ-5 step 378) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
