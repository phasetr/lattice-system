...
| `singleClusterGSEnergyS_one_thirtyfour` / `singleClusterMaxEnergyS_one_thirtyfour` | **Spin-17 dimer numerics**: `GS 1 34 = -306 = -S(S+1)`, `Max 1 34 = 289 = S²` for `S = 17` (γ-5 step 498) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
