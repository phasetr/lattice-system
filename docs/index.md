...
| `singleClusterGSEnergyS_six_twentyseven` / `singleClusterMaxEnergyS_six_twentyseven` | **Spin-27/2 7-vertex star numerics**: `GS 6 27 = -1107 = -S(1+zS)`, `Max 6 27 = 2187/2 = zS²` for `S = 27/2, z = 6` (γ-5 step 461) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
