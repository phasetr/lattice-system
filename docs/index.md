...
| `singleClusterGSEnergyS_one_thirtytwo` / `singleClusterMaxEnergyS_one_thirtytwo` | **Spin-16 dimer numerics**: `GS 1 32 = -272 = -S(S+1)`, `Max 1 32 = 256 = S²` for `S = 16` (γ-5 step 486) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
