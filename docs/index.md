...
| `singleClusterGSEnergyS_six_five` / `singleClusterMaxEnergyS_six_five` | **Spin-5/2 7-vertex star numerics**: `GS 6 5 = -40 = -S(1+zS)`, `Max 6 5 = 75/2 = zS²` for `S = 5/2, z = 6` (γ-5 step 333) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
