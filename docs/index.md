...
| `singleClusterGSEnergyS_five_eighteen` / `singleClusterMaxEnergyS_five_eighteen` | **Spin-9 6-vertex star numerics**: `GS 5 18 = -414 = -S(1+zS)`, `Max 5 18 = 405 = zS²` for `S = 9, z = 5` (γ-5 step 406) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
