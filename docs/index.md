...
| `singleClusterGSEnergyS_six_seventeen` / `singleClusterMaxEnergyS_six_seventeen` | **Spin-17/2 7-vertex star numerics**: `GS 6 17 = -442 = -S(1+zS)`, `Max 6 17 = 867/2 = zS²` for `S = 17/2, z = 6` (γ-5 step 401) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
