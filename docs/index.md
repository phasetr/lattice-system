...
| `singleClusterGSEnergyS_three_thirtytwo` / `singleClusterMaxEnergyS_three_thirtytwo` | **Spin-16 4-vertex star numerics**: `GS 3 32 = -784 = -S(1+zS)`, `Max 3 32 = 768 = zS²` for `S = 16, z = 3` (γ-5 step 488) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
