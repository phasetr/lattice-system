...
| `singleClusterGSEnergyS_one_sixteen` / `singleClusterMaxEnergyS_one_sixteen` | **Spin-8 dimer numerics**: `GS 1 16 = -72 = -S(S+1)`, `Max 1 16 = 64 = S²` for `S = 8` (γ-5 step 375) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
