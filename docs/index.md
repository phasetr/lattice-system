...
| `singleClusterGSEnergyS_one_thirtythree` / `singleClusterMaxEnergyS_one_thirtythree` | **Spin-33/2 dimer numerics**: `GS 1 33 = -1155/4 = -S(S+1)`, `Max 1 33 = 1089/4 = S²` for `S = 33/2` (γ-5 step 492) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
