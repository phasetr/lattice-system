...
| `singleClusterGSEnergyS_one_twenty` / `singleClusterMaxEnergyS_one_twenty` | **Spin-10 dimer numerics**: `GS 1 20 = -110 = -S(S+1)`, `Max 1 20 = 100 = S²` for `S = 10` (γ-5 step 414) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
