...
| `singleClusterGSEnergyS_three_twentysix` / `singleClusterMaxEnergyS_three_twentysix` | **Spin-13 4-vertex star numerics**: `GS 3 26 = -520 = -S(1+zS)`, `Max 3 26 = 507 = zS²` for `S = 13, z = 3` (γ-5 step 452) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
