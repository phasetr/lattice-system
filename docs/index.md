...
| `neelStateOfS_heisenbergHamiltonianOnGraphS_expectation_bipartiteCompleteGraph_re_neg` | **Strict ℝ-negativity** on `bipartiteCompleteGraphOf A` for real positive `J`, `\|A\| > 0`, `\|¬A\| > 0`, `0 < N`: `Re <Φ_Néel \| H \| Φ_Néel> < 0`. Specializes γ-4 step 168 using γ-4 step 198 edge count (γ-4 step 200) | `Quantum/SpinS/SublatticeCasimirNeel.lean` |
