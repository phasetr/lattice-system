...
| `singleClusterGSEnergyS_four_eighteen` / `singleClusterMaxEnergyS_four_eighteen` | **Spin-9 5-vertex star numerics**: `GS 4 18 = -333 = -S(1+zS)`, `Max 4 18 = 324 = zS²` for `S = 9, z = 4` (γ-5 step 405) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
