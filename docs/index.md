...
| `singleClusterGSEnergyS_one_one` / `singleClusterMaxEnergyS_one_one` | **Spin-1/2 dimer numerical values**: `GS 1 1 = -3/4` (canonical singlet); `Max 1 1 = 1/4` (canonical triplet) of `Ŝ_0·Ŝ_1` (γ-5 step 277) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
