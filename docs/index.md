...
| `singleClusterGSEnergyS_one_nineteen` / `singleClusterMaxEnergyS_one_nineteen` | **Spin-19/2 dimer numerics**: `GS 1 19 = -399/4 = -S(S+1)`, `Max 1 19 = 361/4 = S²` for `S = 19/2` (γ-5 step 408) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
