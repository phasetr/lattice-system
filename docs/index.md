...
| `singleClusterGSEnergyS_two_eight` / `singleClusterMaxEnergyS_two_eight` | **Spin-4 3-vertex star numerics**: `GS 2 8 = -36 = -S(1+zS)`, `Max 2 8 = 32 = zS²` for `S = 4, z = 2` (γ-5 step 339) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
