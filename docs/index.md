...
| `singleClusterGSEnergyS_three_one` / `singleClusterMaxEnergyS_three_one` | **Spin-1/2 4-vertex star numerics**: `GS 3 1 = -5/4 = -S(1+zS)`, `Max 3 1 = 3/4 = zS²` for `S = 1/2, z = 3` (γ-5 step 298) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
