...
| `singleClusterGSEnergyS_three_sixteen` / `singleClusterMaxEnergyS_three_sixteen` | **Spin-8 4-vertex star numerics**: `GS 3 16 = -200 = -S(1+zS)`, `Max 3 16 = 192 = zS²` for `S = 8, z = 3` (γ-5 step 392) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
