...
| `singleClusterGSEnergyS_four_thirty` / `singleClusterMaxEnergyS_four_thirty` | **Spin-15 5-vertex star numerics**: `GS 4 30 = -915 = -S(1+zS)`, `Max 4 30 = 900 = zS²` for `S = 15, z = 4` (γ-5 step 477) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
