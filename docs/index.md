...
| `singleClusterHamiltonianS_eigenvalue_quartet_gs` | **Quartet GS-sector at GS energy**: for z=3, joint eigenvector at `Stot²·v=N(N+1)·v` (`s_tot=N`) and leaf-leaf sum `(3N²/4)·v` (max leaf-spin `s_R=3N/2`) gives `H · v = singleClusterGSEnergyS 3 N · v = -N(3N+2)/4 · v` (γ-5 step 305) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
