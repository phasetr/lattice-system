...
| `singleClusterGSEnergyS_three_three` / `singleClusterMaxEnergyS_three_three` | **Spin-3/2 4-vertex star numerics**: `GS 3 3 = -33/4 = -S(1+zS)`, `Max 3 3 = 27/4 = zS²` for `S = 3/2, z = 3` (γ-5 step 301) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
