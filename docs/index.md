...
| `singleClusterGSEnergyS_re_neg_of_pos` / `singleClusterMaxEnergyS_re_pos_of_pos` | **Strict sign**: `Re(GS) < 0` for `N ≥ 1`; `0 < Re(Max)` for `z ≥ 1, N ≥ 1`. Strengthens γ-5 step 272 (γ-5 step 283) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
