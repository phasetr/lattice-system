...
| `singleClusterGSEnergyS_six_two` / `singleClusterMaxEnergyS_six_two` | **Spin-1 7-vertex star numerics**: `GS 6 2 = -7 = -S(1+zS)`, `Max 6 2 = 6 = zS²` for `S = 1, z = 6` (γ-5 step 326) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
