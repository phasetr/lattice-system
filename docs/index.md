...
| `singleClusterGSEnergyS_six_eighteen` / `singleClusterMaxEnergyS_six_eighteen` | **Spin-9 7-vertex star numerics**: `GS 6 18 = -495 = -S(1+zS)`, `Max 6 18 = 486 = zS²` for `S = 9, z = 6` (γ-5 step 407) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
