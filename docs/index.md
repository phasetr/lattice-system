...
| `singleClusterGSEnergyS_four_twentynine` / `singleClusterMaxEnergyS_four_twentynine` | **Spin-29/2 5-vertex star numerics**: `GS 4 29 = -1711/2 = -S(1+zS)`, `Max 4 29 = 841 = zS²` for `S = 29/2, z = 4` (γ-5 step 471) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
