...
| `singleClusterGSEnergyS_one_thirtyone` / `singleClusterMaxEnergyS_one_thirtyone` | **Spin-31/2 dimer numerics**: `GS 1 31 = -1023/4 = -S(S+1)`, `Max 1 31 = 961/4 = S²` for `S = 31/2` (γ-5 step 480) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
