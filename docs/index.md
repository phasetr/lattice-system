...
| `singleClusterGSEnergyS_five_fourteen` / `singleClusterMaxEnergyS_five_fourteen` | **Spin-7 6-vertex star numerics**: `GS 5 14 = -252 = -S(1+zS)`, `Max 5 14 = 245 = zS²` for `S = 7, z = 5` (γ-5 step 379) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
