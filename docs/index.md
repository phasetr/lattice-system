...
| `singleClusterGSEnergyS_two_thirteen` / `singleClusterMaxEnergyS_two_thirteen` | **Spin-13/2 3-vertex star numerics**: `GS 2 13 = -91 = -S(1+zS)`, `Max 2 13 = 169/2 = zS²` for `S = 13/2, z = 2` (γ-5 step 381) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
