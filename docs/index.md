...
| `singleClusterGSEnergyS_two_one` / `singleClusterMaxEnergyS_two_one` | **Spin-1/2 3-vertex star numerics**: `GS 2 1 = -1`, `Max 2 1 = 1/2` for `Ŝ_0·Ŝ_1 + Ŝ_0·Ŝ_2` on three spin-1/2 sites (γ-5 step 279) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
