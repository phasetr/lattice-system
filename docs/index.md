...
| `singleClusterGSEnergyS_one_twentynine` / `singleClusterMaxEnergyS_one_twentynine` | **Spin-29/2 dimer numerics**: `GS 1 29 = -899/4 = -S(S+1)`, `Max 1 29 = 841/4 = S²` for `S = 29/2` (γ-5 step 468) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1516) |
| `singleClusterGSEnergyS_two_twentynine` / `singleClusterMaxEnergyS_two_twentynine` | **Spin-29/2 3-vertex star numerics**: `GS 2 29 = -435 = -S(1+zS)`, `Max 2 29 = 841/2 = zS²` for `S = 29/2, z = 2` (γ-5 step 469) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1517) |
| `singleClusterGSEnergyS_three_twentynine` / `singleClusterMaxEnergyS_three_twentynine` | **Spin-29/2 4-vertex star numerics**: `GS 3 29 = -2581/4 = -S(1+zS)`, `Max 3 29 = 2523/4 = zS²` for `S = 29/2, z = 3` (γ-5 step 470) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1518) |
| `singleClusterGSEnergyS_four_twentynine` / `singleClusterMaxEnergyS_four_twentynine` | **Spin-29/2 5-vertex star numerics**: `GS 4 29 = -1711/2 = -S(1+zS)`, `Max 4 29 = 841 = zS²` for `S = 29/2, z = 4` (γ-5 step 471) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1519) |
| `singleClusterGSEnergyS_five_twentynine` / `singleClusterMaxEnergyS_five_twentynine` | **Spin-29/2 6-vertex star numerics**: `GS 5 29 = -4263/4 = -S(1+zS)`, `Max 5 29 = 4205/4 = zS²` for `S = 29/2, z = 5` (γ-5 step 472) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1520) |
| `singleClusterGSEnergyS_six_twentynine` / `singleClusterMaxEnergyS_six_twentynine` | **Spin-29/2 7-vertex star numerics**: `GS 6 29 = -1276 = -S(1+zS)`, `Max 6 29 = 2523/2 = zS²` for `S = 29/2, z = 6` (γ-5 step 473) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1521) |
| `singleClusterGSEnergyS_one_thirty` / `singleClusterMaxEnergyS_one_thirty` | **Spin-15 dimer numerics**: `GS 1 30 = -240 = -S(S+1)`, `Max 1 30 = 225 = S²` for `S = 15` (γ-5 step 474) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1522) |
| `singleClusterGSEnergyS_two_thirty` / `singleClusterMaxEnergyS_two_thirty` | **Spin-15 3-vertex star numerics**: `GS 2 30 = -465 = -S(1+zS)`, `Max 2 30 = 450 = zS²` for `S = 15, z = 2` (γ-5 step 475) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1523) |
| `singleClusterGSEnergyS_three_thirty` / `singleClusterMaxEnergyS_three_thirty` | **Spin-15 4-vertex star numerics**: `GS 3 30 = -690 = -S(1+zS)`, `Max 3 30 = 675 = zS²` for `S = 15, z = 3` (γ-5 step 476) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1524) |
| `singleClusterGSEnergyS_four_thirty` / `singleClusterMaxEnergyS_four_thirty` | **Spin-15 5-vertex star numerics**: `GS 4 30 = -915 = -S(1+zS)`, `Max 4 30 = 900 = zS²` for `S = 15, z = 4` (γ-5 step 477) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1525) |
| `singleClusterGSEnergyS_five_thirty` / `singleClusterMaxEnergyS_five_thirty` | **Spin-15 6-vertex star numerics**: `GS 5 30 = -1140 = -S(1+zS)`, `Max 5 30 = 1125 = zS²` for `S = 15, z = 5` (γ-5 step 478) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1526) |
| `singleClusterGSEnergyS_six_thirty` / `singleClusterMaxEnergyS_six_thirty` | **Spin-15 7-vertex star numerics**: `GS 6 30 = -1365 = -S(1+zS)`, `Max 6 30 = 1350 = zS²` for `S = 15, z = 6` (γ-5 step 479) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1527) |
| `singleClusterGSEnergyS_one_thirtyone` / `singleClusterMaxEnergyS_one_thirtyone` | **Spin-31/2 dimer numerics**: `GS 1 31 = -1023/4 = -S(S+1)`, `Max 1 31 = 961/4 = S²` for `S = 31/2` (γ-5 step 480) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1528) |
| `singleClusterGSEnergyS_two_thirtyone` / `singleClusterMaxEnergyS_two_thirtyone` | **Spin-31/2 3-vertex star numerics**: `GS 2 31 = -496 = -S(1+zS)`, `Max 2 31 = 961/2 = zS²` for `S = 31/2, z = 2` (γ-5 step 481) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1529) |
| `singleClusterGSEnergyS_three_thirtyone` / `singleClusterMaxEnergyS_three_thirtyone` | **Spin-31/2 4-vertex star numerics**: `GS 3 31 = -2945/4 = -S(1+zS)`, `Max 3 31 = 2883/4 = zS²` for `S = 31/2, z = 3` (γ-5 step 482) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1530) |
| `singleClusterGSEnergyS_four_thirtyone` / `singleClusterMaxEnergyS_four_thirtyone` | **Spin-31/2 5-vertex star numerics**: `GS 4 31 = -1953/2 = -S(1+zS)`, `Max 4 31 = 961 = zS²` for `S = 31/2, z = 4` (γ-5 step 483) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1531) |
| `singleClusterGSEnergyS_five_thirtyone` / `singleClusterMaxEnergyS_five_thirtyone` | **Spin-31/2 6-vertex star numerics**: `GS 5 31 = -4867/4 = -S(1+zS)`, `Max 5 31 = 4805/4 = zS²` for `S = 31/2, z = 5` (γ-5 step 484) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1532) |
| `singleClusterGSEnergyS_six_thirtyone` / `singleClusterMaxEnergyS_six_thirtyone` | **Spin-31/2 7-vertex star numerics**: `GS 6 31 = -1457 = -S(1+zS)`, `Max 6 31 = 2883/2 = zS²` for `S = 31/2, z = 6` (γ-5 step 485) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1533) |
| `singleClusterGSEnergyS_one_thirtytwo` / `singleClusterMaxEnergyS_one_thirtytwo` | **Spin-16 dimer numerics**: `GS 1 32 = -272 = -S(S+1)`, `Max 1 32 = 256 = S²` for `S = 16` (γ-5 step 486) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1534) |
| `singleClusterGSEnergyS_two_thirtytwo` / `singleClusterMaxEnergyS_two_thirtytwo` | **Spin-16 3-vertex star numerics**: `GS 2 32 = -528 = -S(1+zS)`, `Max 2 32 = 512 = zS²` for `S = 16, z = 2` (γ-5 step 487) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1535) |
| `singleClusterGSEnergyS_three_thirtytwo` / `singleClusterMaxEnergyS_three_thirtytwo` | **Spin-16 4-vertex star numerics**: `GS 3 32 = -784 = -S(1+zS)`, `Max 3 32 = 768 = zS²` for `S = 16, z = 3` (γ-5 step 488) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1536) |
| `singleClusterGSEnergyS_four_thirtytwo` / `singleClusterMaxEnergyS_four_thirtytwo` | **Spin-16 5-vertex star numerics**: `GS 4 32 = -1040 = -S(1+zS)`, `Max 4 32 = 1024 = zS²` for `S = 16, z = 4` (γ-5 step 489) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1537) |
| `singleClusterGSEnergyS_five_thirtytwo` / `singleClusterMaxEnergyS_five_thirtytwo` | **Spin-16 6-vertex star numerics**: `GS 5 32 = -1296 = -S(1+zS)`, `Max 5 32 = 1280 = zS²` for `S = 16, z = 5` (γ-5 step 490) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1538) |
| `singleClusterGSEnergyS_six_thirtytwo` / `singleClusterMaxEnergyS_six_thirtytwo` | **Spin-16 7-vertex star numerics**: `GS 6 32 = -1552 = -S(1+zS)`, `Max 6 32 = 1536 = zS²` for `S = 16, z = 6` (γ-5 step 491) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1539) |
| `singleClusterGSEnergyS_one_thirtythree` / `singleClusterMaxEnergyS_one_thirtythree` | **Spin-33/2 dimer numerics**: `GS 1 33 = -1155/4 = -S(S+1)`, `Max 1 33 = 1089/4 = S²` for `S = 33/2` (γ-5 step 492) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1540) |
| `singleClusterGSEnergyS_two_thirtythree` / `singleClusterMaxEnergyS_two_thirtythree` | **Spin-33/2 3-vertex star numerics**: `GS 2 33 = -561 = -S(1+zS)`, `Max 2 33 = 1089/2 = zS²` for `S = 33/2, z = 2` (γ-5 step 493) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1541) |
| `singleClusterGSEnergyS_three_thirtythree` / `singleClusterMaxEnergyS_three_thirtythree` | **Spin-33/2 4-vertex star numerics**: `GS 3 33 = -3333/4 = -S(1+zS)`, `Max 3 33 = 3267/4 = zS²` for `S = 33/2, z = 3` (γ-5 step 494) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1542) |
| `singleClusterGSEnergyS_four_thirtythree` / `singleClusterMaxEnergyS_four_thirtythree` | **Spin-33/2 5-vertex star numerics**: `GS 4 33 = -2211/2 = -S(1+zS)`, `Max 4 33 = 1089 = zS²` for `S = 33/2, z = 4` (γ-5 step 495) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1543) |
| `singleClusterGSEnergyS_five_thirtythree` / `singleClusterMaxEnergyS_five_thirtythree` | **Spin-33/2 6-vertex star numerics**: `GS 5 33 = -5511/4 = -S(1+zS)`, `Max 5 33 = 5445/4 = zS²` for `S = 33/2, z = 5` (γ-5 step 496) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1544) |
| `singleClusterGSEnergyS_six_thirtythree` / `singleClusterMaxEnergyS_six_thirtythree` | **Spin-33/2 7-vertex star numerics**: `GS 6 33 = -1650 = -S(1+zS)`, `Max 6 33 = 3267/2 = zS²` for `S = 33/2, z = 6` (γ-5 step 497) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1545) |
| `singleClusterGSEnergyS_one_thirtyfour` / `singleClusterMaxEnergyS_one_thirtyfour` | **Spin-17 dimer numerics**: `GS 1 34 = -306 = -S(S+1)`, `Max 1 34 = 289 = S²` for `S = 17` (γ-5 step 498) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR #1546) |
| `singleClusterGSEnergyS_two_thirtyfour` / `singleClusterMaxEnergyS_two_thirtyfour` | **Spin-17 3-vertex star numerics**: `GS 2 34 = -595 = -S(1+zS)`, `Max 2 34 = 578 = zS²` for `S = 17, z = 2` (γ-5 step 499) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
