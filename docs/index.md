...
| `singleClusterGSEnergyS_re_lt_singleClusterMaxEnergyS_re_of_pos` | **Strict gap for `N ≥ 1`**: `Re(GS) < Re(Max)` whenever spin is non-trivial (γ-5 step 281) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
