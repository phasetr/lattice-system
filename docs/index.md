...
| `singleClusterGSEnergyS_six_twenty` / `singleClusterMaxEnergyS_six_twenty` | **Spin-10 7-vertex star numerics**: `GS 6 20 = -610 = -S(1+zS)`, `Max 6 20 = 600 = zS²` for `S = 10, z = 6` (γ-5 step 419) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
