...
| `singleClusterGSEnergyS_five_twentythree` / `singleClusterMaxEnergyS_five_twentythree` | **Spin-23/2 6-vertex star numerics**: `GS 5 23 = -2691/4 = -S(1+zS)`, `Max 5 23 = 2645/4 = zS²` for `S = 23/2, z = 5` (γ-5 step 436) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
