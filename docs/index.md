...
| `singleClusterGSEnergyS_five_twentyfive` / `singleClusterMaxEnergyS_five_twentyfive` | **Spin-25/2 6-vertex star numerics**: `GS 5 25 = -3175/4 = -S(1+zS)`, `Max 5 25 = 3125/4 = zS²` for `S = 25/2, z = 5` (γ-5 step 448) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
