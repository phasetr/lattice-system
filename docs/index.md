...
| `singleClusterGSEnergyS_five_thirteen` / `singleClusterMaxEnergyS_five_thirteen` | **Spin-13/2 6-vertex star numerics**: `GS 5 13 = -871/4 = -S(1+zS)`, `Max 5 13 = 845/4 = zS²` for `S = 13/2, z = 5` (γ-5 step 384) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
