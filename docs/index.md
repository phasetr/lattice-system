...
| `singleClusterGSEnergyS_one_twentynine` / `singleClusterMaxEnergyS_one_twentynine` | **Spin-29/2 dimer numerics**: `GS 1 29 = -899/4 = -S(S+1)`, `Max 1 29 = 841/4 = S²` for `S = 29/2` (γ-5 step 468) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
