...
| `singleClusterGSEnergyS_two_thirtytwo` / `singleClusterMaxEnergyS_two_thirtytwo` | **Spin-16 3-vertex star numerics**: `GS 2 32 = -528 = -S(1+zS)`, `Max 2 32 = 512 = zS²` for `S = 16, z = 2` (γ-5 step 487) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
