...
| `singleClusterGSEnergyS_four_thirtyone` / `singleClusterMaxEnergyS_four_thirtyone` | **Spin-31/2 5-vertex star numerics**: `GS 4 31 = -1953/2 = -S(1+zS)`, `Max 4 31 = 961 = zS²` for `S = 31/2, z = 4` (γ-5 step 483) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
