...
| `singleClusterGSEnergyS_four_twentyseven` / `singleClusterMaxEnergyS_four_twentyseven` | **Spin-27/2 5-vertex star numerics**: `GS 4 27 = -1485/2 = -S(1+zS)`, `Max 4 27 = 729 = zS²` for `S = 27/2, z = 4` (γ-5 step 459) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
