...
| `singleClusterGSEnergyS_four_twentyfive` / `singleClusterMaxEnergyS_four_twentyfive` | **Spin-25/2 5-vertex star numerics**: `GS 4 25 = -1275/2 = -S(1+zS)`, `Max 4 25 = 625 = zS²` for `S = 25/2, z = 4` (γ-5 step 447) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
