...
| `singleClusterGSEnergyS_re_le_singleClusterMaxEnergyS_re` | **Energy ordering**: `Re(GS) ≤ Re(Max)`. Consistency check between γ-5 steps 268 and 269 (γ-5 step 273) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
