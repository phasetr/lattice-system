...
| `singleClusterGSEnergyS_three_twentyfive` / `singleClusterMaxEnergyS_three_twentyfive` | **Spin-25/2 4-vertex star numerics**: `GS 3 25 = -1925/4 = -S(1+zS)`, `Max 3 25 = 1875/4 = zS²` for `S = 25/2, z = 3` (γ-5 step 446) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
