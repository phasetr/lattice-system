...
| `fermionNumber_mul_fermionAnnihilation_sub_fermionAnnihilation_mul_fermionNumber` / `fermionNumber_mul_fermionCreation_sub_fermionCreation_mul_fermionNumber` | `[n, c] = −c`; `[n, c†] = c†` (ladder commutators) | `Fermion/NumberLadderCommutators.lean` (PR #988) |
