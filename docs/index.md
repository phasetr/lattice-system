...
| `singleClusterGSEnergyS_one_thirty` / `singleClusterMaxEnergyS_one_thirty` | **Spin-15 dimer numerics**: `GS 1 30 = -240 = -S(S+1)`, `Max 1 30 = 225 = S²` for `S = 15` (γ-5 step 474) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
