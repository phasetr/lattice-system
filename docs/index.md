...
| `singleClusterGSEnergyS_two_five` / `singleClusterMaxEnergyS_two_five` | **Spin-5/2 3-vertex star numerics**: `GS 2 5 = -15 = -S(1+zS)`, `Max 2 5 = 25/2 = zS²` for `S = 5/2, z = 2` (γ-5 step 329) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
