...
| `singleClusterGSEnergyS_five_thirty` / `singleClusterMaxEnergyS_five_thirty` | **Spin-15 6-vertex star numerics**: `GS 5 30 = -1140 = -S(1+zS)`, `Max 5 30 = 1125 = zS²` for `S = 15, z = 5` (γ-5 step 478) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
