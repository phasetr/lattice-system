...
| `singleClusterGSEnergyS_three_eighteen` / `singleClusterMaxEnergyS_three_eighteen` | **Spin-9 4-vertex star numerics**: `GS 3 18 = -252 = -S(1+zS)`, `Max 3 18 = 243 = zS²` for `S = 9, z = 3` (γ-5 step 404) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
