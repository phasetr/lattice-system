...
| `singleClusterGSEnergyS_five_twentyeight` / `singleClusterMaxEnergyS_five_twentyeight` | **Spin-14 6-vertex star numerics**: `GS 5 28 = -994 = -S(1+zS)`, `Max 5 28 = 980 = zS²` for `S = 14, z = 5` (γ-5 step 466) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
