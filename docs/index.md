...
| `singleClusterGSEnergyS_three_fourteen` / `singleClusterMaxEnergyS_three_fourteen` | **Spin-7 4-vertex star numerics**: `GS 3 14 = -154 = -S(1+zS)`, `Max 3 14 = 147 = zS²` for `S = 7, z = 3` (γ-5 step 377) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
