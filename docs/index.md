...
| `singleClusterGSEnergyS_three_thirtythree` / `singleClusterMaxEnergyS_three_thirtythree` | **Spin-33/2 4-vertex star numerics**: `GS 3 33 = -3333/4 = -S(1+zS)`, `Max 3 33 = 3267/4 = zS²` for `S = 33/2, z = 3` (γ-5 step 494) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
