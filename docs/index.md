...
| `singleClusterGSEnergyS_three_four` / `singleClusterMaxEnergyS_three_four` | **Spin-2 4-vertex star numerics**: `GS 3 4 = -14 = -S(1+zS)`, `Max 3 4 = 12 = zS²` for `S = 2, z = 3` (γ-5 step 302) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
