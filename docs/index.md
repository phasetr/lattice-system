...
| `singleClusterGSEnergyS_two_sixteen` / `singleClusterMaxEnergyS_two_sixteen` | **Spin-8 3-vertex star numerics**: `GS 2 16 = -136 = -S(1+zS)`, `Max 2 16 = 128 = zS²` for `S = 8, z = 2` (γ-5 step 391) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
