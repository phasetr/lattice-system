...
| `singleClusterHamiltonianS_eigenvalue_dimer_top` | **Dimer top-spin attains Max energy**: for z=1, any `Stot² = N(N+1)` eigenvector (`s_tot = 2S`) is an `H`-eigenvector at `singleClusterMaxEnergyS 1 N` (γ-5 step 288) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
