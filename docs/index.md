...
| `singleClusterGSEnergyS_five_sixteen` / `singleClusterMaxEnergyS_five_sixteen` | **Spin-8 6-vertex star numerics**: `GS 5 16 = -328 = -S(1+zS)`, `Max 5 16 = 320 = zS²` for `S = 8, z = 5` (γ-5 step 394) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
