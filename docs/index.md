...
| `singleClusterGSEnergyS_four_twentyeight` / `singleClusterMaxEnergyS_four_twentyeight` | **Spin-14 5-vertex star numerics**: `GS 4 28 = -798 = -S(1+zS)`, `Max 4 28 = 784 = zS²` for `S = 14, z = 4` (γ-5 step 465) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
