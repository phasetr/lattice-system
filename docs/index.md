...
| `singleClusterGSEnergyS_one_twentyseven` / `singleClusterMaxEnergyS_one_twentyseven` | **Spin-27/2 dimer numerics**: `GS 1 27 = -783/4 = -S(S+1)`, `Max 1 27 = 729/4 = S²` for `S = 27/2` (γ-5 step 456) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
