...
| `singleClusterGSEnergyS_four_fifteen` / `singleClusterMaxEnergyS_four_fifteen` | **Spin-15/2 5-vertex star numerics**: `GS 4 15 = -465/2 = -S(1+zS)`, `Max 4 15 = 225 = zS²` for `S = 15/2, z = 4` (γ-5 step 388) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
