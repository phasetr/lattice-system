...
| `singleClusterGSEnergyS_one_one` / `singleClusterMaxEnergyS_one_one` | **Spin-1/2 dimer numerical values**: `GS 1 1 = -3/4` (canonical singlet); `Max 1 1 = 1/4` (canonical triplet) of `Ŝ_0·Ŝ_1` (γ-5 step 277) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1324) |
...
| `singleClusterGSEnergyS_two_one` / `singleClusterMaxEnergyS_two_one` | **Spin-1/2 3-vertex star numerics**: `GS 2 1 = -1`, `Max 2 1 = 1/2` for `Ŝ_0·Ŝ_1 + Ŝ_0·Ŝ_2` on three spin-1/2 sites (γ-5 step 279) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1326) |
...
| `singleClusterGSEnergyS_one_two` / `singleClusterMaxEnergyS_one_two` / `singleClusterGSEnergyS_two_two` / `singleClusterMaxEnergyS_two_two` | **Spin-1 numerical values**: dimer `GS 1 2 = -2`, `Max 1 2 = 1`; 3-vertex star `GS 2 2 = -3`, `Max 2 2 = 2` (γ-5 step 282) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1329) |
...
| `singleClusterGSEnergyS_one_three` / `singleClusterMaxEnergyS_one_three` / `singleClusterGSEnergyS_two_three` / `singleClusterMaxEnergyS_two_three` | **Spin-3/2 numerical values**: dimer `GS 1 3 = -15/4`, `Max 1 3 = 9/4`; 3-vertex star `GS 2 3 = -6`, `Max 2 3 = 9/2` (γ-5 step 284) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1331) |
...
| `singleClusterGSEnergyS_one_four` / `singleClusterMaxEnergyS_one_four` | **Spin-2 dimer numerics**: `GS 1 4 = -6 = -S(S+1)`, `Max 1 4 = 4 = S²` for `S = 2` (γ-5 step 289) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1336) |
| `singleClusterGSEnergyS_two_four` / `singleClusterMaxEnergyS_two_four` | **Spin-2 3-vertex star numerics**: `GS 2 4 = -10 = -S(1+2S)`, `Max 2 4 = 8 = zS²` for `S = 2, z = 2` (γ-5 step 290) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1337) |
| `singleClusterGSEnergyS_one_five` / `singleClusterMaxEnergyS_one_five` | **Spin-5/2 dimer numerics**: `GS 1 5 = -35/4 = -S(S+1)`, `Max 1 5 = 25/4 = S²` for `S = 5/2` (γ-5 step 291) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1338) |
...
| `singleClusterGSEnergyS_three_two` / `singleClusterMaxEnergyS_three_two` | **Spin-1 4-vertex star numerics**: `GS 3 2 = -4 = -S(1+zS)`, `Max 3 2 = 3 = zS²` for `S = 1, z = 3` (γ-5 step 297) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1344) |
| `singleClusterGSEnergyS_three_one` / `singleClusterMaxEnergyS_three_one` | **Spin-1/2 4-vertex star numerics**: `GS 3 1 = -5/4 = -S(1+zS)`, `Max 3 1 = 3/4 = zS²` for `S = 1/2, z = 3` (γ-5 step 298) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1345) |
| `singleClusterGSEnergyS_one_six` / `singleClusterMaxEnergyS_one_six` | **Spin-3 dimer numerics**: `GS 1 6 = -12 = -S(S+1)`, `Max 1 6 = 9 = S²` for `S = 3` (γ-5 step 300) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1347) |
| `singleClusterGSEnergyS_three_three` / `singleClusterMaxEnergyS_three_three` | **Spin-3/2 4-vertex star numerics**: `GS 3 3 = -33/4 = -S(1+zS)`, `Max 3 3 = 27/4 = zS²` for `S = 3/2, z = 3` (γ-5 step 301) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1348) |
| `singleClusterGSEnergyS_three_four` / `singleClusterMaxEnergyS_three_four` | **Spin-2 4-vertex star numerics**: `GS 3 4 = -14 = -S(1+zS)`, `Max 3 4 = 12 = zS²` for `S = 2, z = 3` (γ-5 step 302) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1349) |
...
| `singleClusterGSEnergyS_two_six` / `singleClusterMaxEnergyS_two_six` | **Spin-3 3-vertex star numerics**: `GS 2 6 = -21 = -S(1+zS)`, `Max 2 6 = 18 = zS²` for `S = 3, z = 2` (γ-5 step 307) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1354) |
| `singleClusterGSEnergyS_four_one` / `singleClusterMaxEnergyS_four_one` | **Spin-1/2 5-vertex star numerics**: `GS 4 1 = -3/2 = -S(1+zS)`, `Max 4 1 = 1 = zS²` for `S = 1/2, z = 4` (γ-5 step 308) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1355) |
| `singleClusterGSEnergyS_four_two` / `singleClusterMaxEnergyS_four_two` | **Spin-1 5-vertex star numerics**: `GS 4 2 = -5 = -S(1+zS)`, `Max 4 2 = 4 = zS²` for `S = 1, z = 4` (γ-5 step 309) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1356) |
| `singleClusterGSEnergyS_five_one` / `singleClusterMaxEnergyS_five_one` | **Spin-1/2 6-vertex star numerics**: `GS 5 1 = -7/4 = -S(1+zS)`, `Max 5 1 = 5/4 = zS²` for `S = 1/2, z = 5` (γ-5 step 310) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1357) |
| `singleClusterGSEnergyS_four_four` / `singleClusterMaxEnergyS_four_four` | **Spin-2 5-vertex star numerics**: `GS 4 4 = -18 = -S(1+zS)`, `Max 4 4 = 16 = zS²` for `S = 2, z = 4` (γ-5 step 311) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1358) |
...
| `singleClusterGSEnergyS_three_six` / `singleClusterMaxEnergyS_three_six` | **Spin-3 4-vertex star numerics**: `GS 3 6 = -30 = -S(1+zS)`, `Max 3 6 = 27 = zS²` for `S = 3, z = 3` (γ-5 step 316) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1363) |
| `singleClusterGSEnergyS_five_three` / `singleClusterMaxEnergyS_five_three` | **Spin-3/2 6-vertex star numerics**: `GS 5 3 = -51/4 = -S(1+zS)`, `Max 5 3 = 45/4 = zS²` for `S = 3/2, z = 5` (γ-5 step 317) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1364) |
| `singleClusterGSEnergyS_five_four` / `singleClusterMaxEnergyS_five_four` | **Spin-2 6-vertex star numerics**: `GS 5 4 = -22 = -S(1+zS)`, `Max 5 4 = 20 = zS²` for `S = 2, z = 5` (γ-5 step 318) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1365) |
| `singleClusterGSEnergyS_one_eight` / `singleClusterMaxEnergyS_one_eight` | **Spin-4 dimer numerics**: `GS 1 8 = -20 = -S(S+1)`, `Max 1 8 = 16 = S²` for `S = 4` (γ-5 step 319) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1366) |
| `singleClusterGSEnergyS_five_two` / `singleClusterMaxEnergyS_five_two` | **Spin-1 6-vertex star numerics**: `GS 5 2 = -6 = -S(1+zS)`, `Max 5 2 = 5 = zS²` for `S = 1, z = 5` (γ-5 step 320) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1367) |
...
| `singleClusterGSEnergyS_four_three` / `singleClusterMaxEnergyS_four_three` | **Spin-3/2 5-vertex star numerics**: `GS 4 3 = -21/2 = -S(1+zS)`, `Max 4 3 = 9 = zS²` for `S = 3/2, z = 4` (γ-5 step 324) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1371) |
| `singleClusterGSEnergyS_six_one` / `singleClusterMaxEnergyS_six_one` | **Spin-1/2 7-vertex star numerics**: `GS 6 1 = -2 = -S(1+zS)`, `Max 6 1 = 3/2 = zS²` for `S = 1/2, z = 6` (γ-5 step 325) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1372) |
| `singleClusterGSEnergyS_six_two` / `singleClusterMaxEnergyS_six_two` | **Spin-1 7-vertex star numerics**: `GS 6 2 = -7 = -S(1+zS)`, `Max 6 2 = 6 = zS²` for `S = 1, z = 6` (γ-5 step 326) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1373) |
| `singleClusterGSEnergyS_six_three` / `singleClusterMaxEnergyS_six_three` | **Spin-3/2 7-vertex star numerics**: `GS 6 3 = -15 = -S(1+zS)`, `Max 6 3 = 27/2 = zS²` for `S = 3/2, z = 6` (γ-5 step 327) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1374) |
| `singleClusterGSEnergyS_six_four` / `singleClusterMaxEnergyS_six_four` | **Spin-2 7-vertex star numerics**: `GS 6 4 = -26 = -S(1+zS)`, `Max 6 4 = 24 = zS²` for `S = 2, z = 6` (γ-5 step 328) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1375) |
| `singleClusterGSEnergyS_two_five` / `singleClusterMaxEnergyS_two_five` | **Spin-5/2 3-vertex star numerics**: `GS 2 5 = -15 = -S(1+zS)`, `Max 2 5 = 25/2 = zS²` for `S = 5/2, z = 2` (γ-5 step 329) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1376) |
| `singleClusterGSEnergyS_three_five` / `singleClusterMaxEnergyS_three_five` | **Spin-5/2 4-vertex star numerics**: `GS 3 5 = -85/4 = -S(1+zS)`, `Max 3 5 = 75/4 = zS²` for `S = 5/2, z = 3` (γ-5 step 330) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1377) |
| `singleClusterGSEnergyS_four_five` / `singleClusterMaxEnergyS_four_five` | **Spin-5/2 5-vertex star numerics**: `GS 4 5 = -55/2 = -S(1+zS)`, `Max 4 5 = 25 = zS²` for `S = 5/2, z = 4` (γ-5 step 331) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1378) |
| `singleClusterGSEnergyS_five_five` / `singleClusterMaxEnergyS_five_five` | **Spin-5/2 6-vertex star numerics**: `GS 5 5 = -135/4 = -S(1+zS)`, `Max 5 5 = 125/4 = zS²` for `S = 5/2, z = 5` (γ-5 step 332) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1379) |
| `singleClusterGSEnergyS_six_five` / `singleClusterMaxEnergyS_six_five` | **Spin-5/2 7-vertex star numerics**: `GS 6 5 = -40 = -S(1+zS)`, `Max 6 5 = 75/2 = zS²` for `S = 5/2, z = 6` (γ-5 step 333) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1380) |
| `singleClusterGSEnergyS_four_six` / `singleClusterMaxEnergyS_four_six` | **Spin-3 5-vertex star numerics**: `GS 4 6 = -39 = -S(1+zS)`, `Max 4 6 = 36 = zS²` for `S = 3, z = 4` (γ-5 step 334) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1381) |
| `singleClusterGSEnergyS_five_six` / `singleClusterMaxEnergyS_five_six` | **Spin-3 6-vertex star numerics**: `GS 5 6 = -48 = -S(1+zS)`, `Max 5 6 = 45 = zS²` for `S = 3, z = 5` (γ-5 step 335) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1382) |
| `singleClusterGSEnergyS_six_six` / `singleClusterMaxEnergyS_six_six` | **Spin-3 7-vertex star numerics**: `GS 6 6 = -57 = -S(1+zS)`, `Max 6 6 = 54 = zS²` for `S = 3, z = 6` (γ-5 step 336) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1383) |
| `singleClusterGSEnergyS_one_seven` / `singleClusterMaxEnergyS_one_seven` | **Spin-7/2 dimer numerics**: `GS 1 7 = -63/4 = -S(S+1)`, `Max 1 7 = 49/4 = S²` for `S = 7/2` (γ-5 step 337) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1384) |
| `singleClusterGSEnergyS_two_seven` / `singleClusterMaxEnergyS_two_seven` | **Spin-7/2 3-vertex star numerics**: `GS 2 7 = -28 = -S(1+zS)`, `Max 2 7 = 49/2 = zS²` for `S = 7/2, z = 2` (γ-5 step 338) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1385) |
| `singleClusterGSEnergyS_two_eight` / `singleClusterMaxEnergyS_two_eight` | **Spin-4 3-vertex star numerics**: `GS 2 8 = -36 = -S(1+zS)`, `Max 2 8 = 32 = zS²` for `S = 4, z = 2` (γ-5 step 339) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1386) |
| `singleClusterGSEnergyS_three_eight` / `singleClusterMaxEnergyS_three_eight` | **Spin-4 4-vertex star numerics**: `GS 3 8 = -52 = -S(1+zS)`, `Max 3 8 = 48 = zS²` for `S = 4, z = 3` (γ-5 step 340) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1387) |
| `singleClusterGSEnergyS_four_eight` / `singleClusterMaxEnergyS_four_eight` | **Spin-4 5-vertex star numerics**: `GS 4 8 = -68 = -S(1+zS)`, `Max 4 8 = 64 = zS²` for `S = 4, z = 4` (γ-5 step 341) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1388) |
| `singleClusterGSEnergyS_five_eight` / `singleClusterMaxEnergyS_five_eight` | **Spin-4 6-vertex star numerics**: `GS 5 8 = -84 = -S(1+zS)`, `Max 5 8 = 80 = zS²` for `S = 4, z = 5` (γ-5 step 342) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1389) |
| `singleClusterGSEnergyS_six_eight` / `singleClusterMaxEnergyS_six_eight` | **Spin-4 7-vertex star numerics**: `GS 6 8 = -100 = -S(1+zS)`, `Max 6 8 = 96 = zS²` for `S = 4, z = 6` (γ-5 step 343) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1390) |
| `singleClusterGSEnergyS_three_seven` / `singleClusterMaxEnergyS_three_seven` | **Spin-7/2 4-vertex star numerics**: `GS 3 7 = -161/4 = -S(1+zS)`, `Max 3 7 = 147/4 = zS²` for `S = 7/2, z = 3` (γ-5 step 344) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1391) |
| `singleClusterGSEnergyS_four_seven` / `singleClusterMaxEnergyS_four_seven` | **Spin-7/2 5-vertex star numerics**: `GS 4 7 = -105/2 = -S(1+zS)`, `Max 4 7 = 49 = zS²` for `S = 7/2, z = 4` (γ-5 step 345) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1392) |
| `singleClusterGSEnergyS_five_seven` / `singleClusterMaxEnergyS_five_seven` | **Spin-7/2 6-vertex star numerics**: `GS 5 7 = -259/4 = -S(1+zS)`, `Max 5 7 = 245/4 = zS²` for `S = 7/2, z = 5` (γ-5 step 346) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1393) |
| `singleClusterGSEnergyS_six_seven` / `singleClusterMaxEnergyS_six_seven` | **Spin-7/2 7-vertex star numerics**: `GS 6 7 = -77 = -S(1+zS)`, `Max 6 7 = 147/2 = zS²` for `S = 7/2, z = 6` (γ-5 step 347) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1394) |
| `singleClusterGSEnergyS_one_nine` / `singleClusterMaxEnergyS_one_nine` | **Spin-9/2 dimer numerics**: `GS 1 9 = -99/4 = -S(S+1)`, `Max 1 9 = 81/4 = S²` for `S = 9/2` (γ-5 step 348) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1395) |
| `singleClusterGSEnergyS_two_nine` / `singleClusterMaxEnergyS_two_nine` | **Spin-9/2 3-vertex star numerics**: `GS 2 9 = -45 = -S(1+zS)`, `Max 2 9 = 81/2 = zS²` for `S = 9/2, z = 2` (γ-5 step 349) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1396) |
| `singleClusterGSEnergyS_three_nine` / `singleClusterMaxEnergyS_three_nine` | **Spin-9/2 4-vertex star numerics**: `GS 3 9 = -261/4 = -S(1+zS)`, `Max 3 9 = 243/4 = zS²` for `S = 9/2, z = 3` (γ-5 step 350 milestone) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1397) |
| `singleClusterGSEnergyS_four_nine` / `singleClusterMaxEnergyS_four_nine` | **Spin-9/2 5-vertex star numerics**: `GS 4 9 = -171/2 = -S(1+zS)`, `Max 4 9 = 81 = zS²` for `S = 9/2, z = 4` (γ-5 step 351) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1398) |
| `singleClusterGSEnergyS_five_nine` / `singleClusterMaxEnergyS_five_nine` | **Spin-9/2 6-vertex star numerics**: `GS 5 9 = -423/4 = -S(1+zS)`, `Max 5 9 = 405/4 = zS²` for `S = 9/2, z = 5` (γ-5 step 352) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1399) |
| `singleClusterGSEnergyS_six_nine` / `singleClusterMaxEnergyS_six_nine` | **Spin-9/2 7-vertex star numerics**: `GS 6 9 = -126 = -S(1+zS)`, `Max 6 9 = 243/2 = zS²` for `S = 9/2, z = 6` (γ-5 step 353) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1400) |
| `singleClusterGSEnergyS_one_ten` / `singleClusterMaxEnergyS_one_ten` | **Spin-5 dimer numerics**: `GS 1 10 = -30 = -S(S+1)`, `Max 1 10 = 25 = S²` for `S = 5` (γ-5 step 354) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1401) |
| `singleClusterGSEnergyS_two_ten` / `singleClusterMaxEnergyS_two_ten` | **Spin-5 3-vertex star numerics**: `GS 2 10 = -55 = -S(1+zS)`, `Max 2 10 = 50 = zS²` for `S = 5, z = 2` (γ-5 step 355) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1402) |
| `singleClusterGSEnergyS_three_ten` / `singleClusterMaxEnergyS_three_ten` | **Spin-5 4-vertex star numerics**: `GS 3 10 = -80 = -S(1+zS)`, `Max 3 10 = 75 = zS²` for `S = 5, z = 3` (γ-5 step 356) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1403) |
| `singleClusterGSEnergyS_four_ten` / `singleClusterMaxEnergyS_four_ten` | **Spin-5 5-vertex star numerics**: `GS 4 10 = -105 = -S(1+zS)`, `Max 4 10 = 100 = zS²` for `S = 5, z = 4` (γ-5 step 357) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1404) |
| `singleClusterGSEnergyS_five_ten` / `singleClusterMaxEnergyS_five_ten` | **Spin-5 6-vertex star numerics**: `GS 5 10 = -130 = -S(1+zS)`, `Max 5 10 = 125 = zS²` for `S = 5, z = 5` (γ-5 step 358) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1405) |
| `singleClusterGSEnergyS_six_ten` / `singleClusterMaxEnergyS_six_ten` | **Spin-5 7-vertex star numerics**: `GS 6 10 = -155 = -S(1+zS)`, `Max 6 10 = 150 = zS²` for `S = 5, z = 6` (γ-5 step 359) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1406) |
| `singleClusterGSEnergyS_one_eleven` / `singleClusterMaxEnergyS_one_eleven` | **Spin-11/2 dimer numerics**: `GS 1 11 = -143/4 = -S(S+1)`, `Max 1 11 = 121/4 = S²` for `S = 11/2` (γ-5 step 360 milestone) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1407) |
| `singleClusterGSEnergyS_two_eleven` / `singleClusterMaxEnergyS_two_eleven` | **Spin-11/2 3-vertex star numerics**: `GS 2 11 = -66 = -S(1+zS)`, `Max 2 11 = 121/2 = zS²` for `S = 11/2, z = 2` (γ-5 step 361) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1408) |
| `singleClusterGSEnergyS_three_eleven` / `singleClusterMaxEnergyS_three_eleven` | **Spin-11/2 4-vertex star numerics**: `GS 3 11 = -385/4 = -S(1+zS)`, `Max 3 11 = 363/4 = zS²` for `S = 11/2, z = 3` (γ-5 step 362) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1409) |
| `singleClusterGSEnergyS_four_eleven` / `singleClusterMaxEnergyS_four_eleven` | **Spin-11/2 5-vertex star numerics**: `GS 4 11 = -253/2 = -S(1+zS)`, `Max 4 11 = 121 = zS²` for `S = 11/2, z = 4` (γ-5 step 363) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1410) |
| `singleClusterGSEnergyS_five_eleven` / `singleClusterMaxEnergyS_five_eleven` | **Spin-11/2 6-vertex star numerics**: `GS 5 11 = -627/4 = -S(1+zS)`, `Max 5 11 = 605/4 = zS²` for `S = 11/2, z = 5` (γ-5 step 364) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1411) |
| `singleClusterGSEnergyS_six_eleven` / `singleClusterMaxEnergyS_six_eleven` | **Spin-11/2 7-vertex star numerics**: `GS 6 11 = -187 = -S(1+zS)`, `Max 6 11 = 363/2 = zS²` for `S = 11/2, z = 6` (γ-5 step 365) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1412) |
| `singleClusterGSEnergyS_one_twelve` / `singleClusterMaxEnergyS_one_twelve` | **Spin-6 dimer numerics**: `GS 1 12 = -42 = -S(S+1)`, `Max 1 12 = 36 = S²` for `S = 6` (γ-5 step 366) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1413) |
| `singleClusterGSEnergyS_two_twelve` / `singleClusterMaxEnergyS_two_twelve` | **Spin-6 3-vertex star numerics**: `GS 2 12 = -78 = -S(1+zS)`, `Max 2 12 = 72 = zS²` for `S = 6, z = 2` (γ-5 step 367) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1414) |
| `singleClusterGSEnergyS_three_twelve` / `singleClusterMaxEnergyS_three_twelve` | **Spin-6 4-vertex star numerics**: `GS 3 12 = -114 = -S(1+zS)`, `Max 3 12 = 108 = zS²` for `S = 6, z = 3` (γ-5 step 368) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1415) |
| `singleClusterGSEnergyS_four_twelve` / `singleClusterMaxEnergyS_four_twelve` | **Spin-6 5-vertex star numerics**: `GS 4 12 = -150 = -S(1+zS)`, `Max 4 12 = 144 = zS²` for `S = 6, z = 4` (γ-5 step 369) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1416) |
| `singleClusterGSEnergyS_five_twelve` / `singleClusterMaxEnergyS_five_twelve` | **Spin-6 6-vertex star numerics**: `GS 5 12 = -186 = -S(1+zS)`, `Max 5 12 = 180 = zS²` for `S = 6, z = 5` (γ-5 step 370) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1417) |
| `singleClusterGSEnergyS_six_twelve` / `singleClusterMaxEnergyS_six_twelve` | **Spin-6 7-vertex star numerics**: `GS 6 12 = -222 = -S(1+zS)`, `Max 6 12 = 216 = zS²` for `S = 6, z = 6` (γ-5 step 371) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1418) |
| `singleClusterGSEnergyS_one_thirteen` / `singleClusterMaxEnergyS_one_thirteen` | **Spin-13/2 dimer numerics**: `GS 1 13 = -195/4 = -S(S+1)`, `Max 1 13 = 169/4 = S²` for `S = 13/2` (γ-5 step 372) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1419) |
| `singleClusterGSEnergyS_one_fourteen` / `singleClusterMaxEnergyS_one_fourteen` | **Spin-7 dimer numerics**: `GS 1 14 = -56 = -S(S+1)`, `Max 1 14 = 49 = S²` for `S = 7` (γ-5 step 373) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1420) |
| `singleClusterGSEnergyS_one_fifteen` / `singleClusterMaxEnergyS_one_fifteen` | **Spin-15/2 dimer numerics**: `GS 1 15 = -255/4 = -S(S+1)`, `Max 1 15 = 225/4 = S²` for `S = 15/2` (γ-5 step 374) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1421) |
| `singleClusterGSEnergyS_one_sixteen` / `singleClusterMaxEnergyS_one_sixteen` | **Spin-8 dimer numerics**: `GS 1 16 = -72 = -S(S+1)`, `Max 1 16 = 64 = S²` for `S = 8` (γ-5 step 375) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1422) |
| `singleClusterGSEnergyS_two_fourteen` / `singleClusterMaxEnergyS_two_fourteen` | **Spin-7 3-vertex star numerics**: `GS 2 14 = -105 = -S(1+zS)`, `Max 2 14 = 98 = zS²` for `S = 7, z = 2` (γ-5 step 376) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1423) |
| `singleClusterGSEnergyS_three_fourteen` / `singleClusterMaxEnergyS_three_fourteen` | **Spin-7 4-vertex star numerics**: `GS 3 14 = -154 = -S(1+zS)`, `Max 3 14 = 147 = zS²` for `S = 7, z = 3` (γ-5 step 377) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1424) |
| `singleClusterGSEnergyS_four_fourteen` / `singleClusterMaxEnergyS_four_fourteen` | **Spin-7 5-vertex star numerics**: `GS 4 14 = -203 = -S(1+zS)`, `Max 4 14 = 196 = zS²` for `S = 7, z = 4` (γ-5 step 378) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1425) |
| `singleClusterGSEnergyS_five_fourteen` / `singleClusterMaxEnergyS_five_fourteen` | **Spin-7 6-vertex star numerics**: `GS 5 14 = -252 = -S(1+zS)`, `Max 5 14 = 245 = zS²` for `S = 7, z = 5` (γ-5 step 379) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1426) |
| `singleClusterGSEnergyS_six_fourteen` / `singleClusterMaxEnergyS_six_fourteen` | **Spin-7 7-vertex star numerics**: `GS 6 14 = -301 = -S(1+zS)`, `Max 6 14 = 294 = zS²` for `S = 7, z = 6` (γ-5 step 380 milestone) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1427) |
| `singleClusterGSEnergyS_two_thirteen` / `singleClusterMaxEnergyS_two_thirteen` | **Spin-13/2 3-vertex star numerics**: `GS 2 13 = -91 = -S(1+zS)`, `Max 2 13 = 169/2 = zS²` for `S = 13/2, z = 2` (γ-5 step 381) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1428) |
| `singleClusterGSEnergyS_three_thirteen` / `singleClusterMaxEnergyS_three_thirteen` | **Spin-13/2 4-vertex star numerics**: `GS 3 13 = -533/4 = -S(1+zS)`, `Max 3 13 = 507/4 = zS²` for `S = 13/2, z = 3` (γ-5 step 382) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1429) |
| `singleClusterGSEnergyS_four_thirteen` / `singleClusterMaxEnergyS_four_thirteen` | **Spin-13/2 5-vertex star numerics**: `GS 4 13 = -351/2 = -S(1+zS)`, `Max 4 13 = 169 = zS²` for `S = 13/2, z = 4` (γ-5 step 383) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1430) |
| `singleClusterGSEnergyS_five_thirteen` / `singleClusterMaxEnergyS_five_thirteen` | **Spin-13/2 6-vertex star numerics**: `GS 5 13 = -871/4 = -S(1+zS)`, `Max 5 13 = 845/4 = zS²` for `S = 13/2, z = 5` (γ-5 step 384) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1431) |
| `singleClusterGSEnergyS_six_thirteen` / `singleClusterMaxEnergyS_six_thirteen` | **Spin-13/2 7-vertex star numerics**: `GS 6 13 = -260 = -S(1+zS)`, `Max 6 13 = 507/2 = zS²` for `S = 13/2, z = 6` (γ-5 step 385) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1432) |
| `singleClusterGSEnergyS_two_fifteen` / `singleClusterMaxEnergyS_two_fifteen` | **Spin-15/2 3-vertex star numerics**: `GS 2 15 = -120 = -S(1+zS)`, `Max 2 15 = 225/2 = zS²` for `S = 15/2, z = 2` (γ-5 step 386) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1433) |
| `singleClusterGSEnergyS_three_fifteen` / `singleClusterMaxEnergyS_three_fifteen` | **Spin-15/2 4-vertex star numerics**: `GS 3 15 = -705/4 = -S(1+zS)`, `Max 3 15 = 675/4 = zS²` for `S = 15/2, z = 3` (γ-5 step 387) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1434) |
| `singleClusterGSEnergyS_four_fifteen` / `singleClusterMaxEnergyS_four_fifteen` | **Spin-15/2 5-vertex star numerics**: `GS 4 15 = -465/2 = -S(1+zS)`, `Max 4 15 = 225 = zS²` for `S = 15/2, z = 4` (γ-5 step 388) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1435) |
| `singleClusterGSEnergyS_five_fifteen` / `singleClusterMaxEnergyS_five_fifteen` | **Spin-15/2 6-vertex star numerics**: `GS 5 15 = -1155/4 = -S(1+zS)`, `Max 5 15 = 1125/4 = zS²` for `S = 15/2, z = 5` (γ-5 step 389) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1436) |
| `singleClusterGSEnergyS_six_fifteen` / `singleClusterMaxEnergyS_six_fifteen` | **Spin-15/2 7-vertex star numerics**: `GS 6 15 = -345 = -S(1+zS)`, `Max 6 15 = 675/2 = zS²` for `S = 15/2, z = 6` (γ-5 step 390) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1437) |
| `singleClusterGSEnergyS_two_sixteen` / `singleClusterMaxEnergyS_two_sixteen` | **Spin-8 3-vertex star numerics**: `GS 2 16 = -136 = -S(1+zS)`, `Max 2 16 = 128 = zS²` for `S = 8, z = 2` (γ-5 step 391) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1438) |
| `singleClusterGSEnergyS_three_sixteen` / `singleClusterMaxEnergyS_three_sixteen` | **Spin-8 4-vertex star numerics**: `GS 3 16 = -200 = -S(1+zS)`, `Max 3 16 = 192 = zS²` for `S = 8, z = 3` (γ-5 step 392) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1439) |
| `singleClusterGSEnergyS_four_sixteen` / `singleClusterMaxEnergyS_four_sixteen` | **Spin-8 5-vertex star numerics**: `GS 4 16 = -264 = -S(1+zS)`, `Max 4 16 = 256 = zS²` for `S = 8, z = 4` (γ-5 step 393) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1440) |
| `singleClusterGSEnergyS_five_sixteen` / `singleClusterMaxEnergyS_five_sixteen` | **Spin-8 6-vertex star numerics**: `GS 5 16 = -328 = -S(1+zS)`, `Max 5 16 = 320 = zS²` for `S = 8, z = 5` (γ-5 step 394) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1441) |
| `singleClusterGSEnergyS_six_sixteen` / `singleClusterMaxEnergyS_six_sixteen` | **Spin-8 7-vertex star numerics**: `GS 6 16 = -392 = -S(1+zS)`, `Max 6 16 = 384 = zS²` for `S = 8, z = 6` (γ-5 step 395) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1442) |
| `singleClusterGSEnergyS_one_seventeen` / `singleClusterMaxEnergyS_one_seventeen` | **Spin-17/2 dimer numerics**: `GS 1 17 = -323/4 = -S(S+1)`, `Max 1 17 = 289/4 = S²` for `S = 17/2` (γ-5 step 396) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1443) |
| `singleClusterGSEnergyS_two_seventeen` / `singleClusterMaxEnergyS_two_seventeen` | **Spin-17/2 3-vertex star numerics**: `GS 2 17 = -153 = -S(1+zS)`, `Max 2 17 = 289/2 = zS²` for `S = 17/2, z = 2` (γ-5 step 397) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1444) |
| `singleClusterGSEnergyS_three_seventeen` / `singleClusterMaxEnergyS_three_seventeen` | **Spin-17/2 4-vertex star numerics**: `GS 3 17 = -901/4 = -S(1+zS)`, `Max 3 17 = 867/4 = zS²` for `S = 17/2, z = 3` (γ-5 step 398) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1445) |
| `singleClusterGSEnergyS_four_seventeen` / `singleClusterMaxEnergyS_four_seventeen` | **Spin-17/2 5-vertex star numerics**: `GS 4 17 = -595/2 = -S(1+zS)`, `Max 4 17 = 289 = zS²` for `S = 17/2, z = 4` (γ-5 step 399) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1446) |
| `singleClusterGSEnergyS_five_seventeen` / `singleClusterMaxEnergyS_five_seventeen` | **Spin-17/2 6-vertex star numerics**: `GS 5 17 = -1479/4 = -S(1+zS)`, `Max 5 17 = 1445/4 = zS²` for `S = 17/2, z = 5` (γ-5 step 400) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1447) |
| `singleClusterGSEnergyS_six_seventeen` / `singleClusterMaxEnergyS_six_seventeen` | **Spin-17/2 7-vertex star numerics**: `GS 6 17 = -442 = -S(1+zS)`, `Max 6 17 = 867/2 = zS²` for `S = 17/2, z = 6` (γ-5 step 401) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1448) |
| `singleClusterGSEnergyS_one_eighteen` / `singleClusterMaxEnergyS_one_eighteen` | **Spin-9 dimer numerics**: `GS 1 18 = -90 = -S(S+1)`, `Max 1 18 = 81 = S²` for `S = 9` (γ-5 step 402) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1449) |
| `singleClusterGSEnergyS_two_eighteen` / `singleClusterMaxEnergyS_two_eighteen` | **Spin-9 3-vertex star numerics**: `GS 2 18 = -171 = -S(1+zS)`, `Max 2 18 = 162 = zS²` for `S = 9, z = 2` (γ-5 step 403) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1450) |
| `singleClusterGSEnergyS_three_eighteen` / `singleClusterMaxEnergyS_three_eighteen` | **Spin-9 4-vertex star numerics**: `GS 3 18 = -252 = -S(1+zS)`, `Max 3 18 = 243 = zS²` for `S = 9, z = 3` (γ-5 step 404) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1451) |
| `singleClusterGSEnergyS_four_eighteen` / `singleClusterMaxEnergyS_four_eighteen` | **Spin-9 5-vertex star numerics**: `GS 4 18 = -333 = -S(1+zS)`, `Max 4 18 = 324 = zS²` for `S = 9, z = 4` (γ-5 step 405) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1452) |
| `singleClusterGSEnergyS_five_eighteen` / `singleClusterMaxEnergyS_five_eighteen` | **Spin-9 6-vertex star numerics**: `GS 5 18 = -414 = -S(1+zS)`, `Max 5 18 = 405 = zS²` for `S = 9, z = 5` (γ-5 step 406) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1453) |
| `singleClusterGSEnergyS_six_eighteen` / `singleClusterMaxEnergyS_six_eighteen` | **Spin-9 7-vertex star numerics**: `GS 6 18 = -495 = -S(1+zS)`, `Max 6 18 = 486 = zS²` for `S = 9, z = 6` (γ-5 step 407) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1454) |
| `singleClusterGSEnergyS_one_nineteen` / `singleClusterMaxEnergyS_one_nineteen` | **Spin-19/2 dimer numerics**: `GS 1 19 = -399/4 = -S(S+1)`, `Max 1 19 = 361/4 = S²` for `S = 19/2` (γ-5 step 408) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1455) |
| `singleClusterGSEnergyS_two_nineteen` / `singleClusterMaxEnergyS_two_nineteen` | **Spin-19/2 3-vertex star numerics**: `GS 2 19 = -190 = -S(1+zS)`, `Max 2 19 = 361/2 = zS²` for `S = 19/2, z = 2` (γ-5 step 409) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1456) |
| `singleClusterGSEnergyS_three_nineteen` / `singleClusterMaxEnergyS_three_nineteen` | **Spin-19/2 4-vertex star numerics**: `GS 3 19 = -1121/4 = -S(1+zS)`, `Max 3 19 = 1083/4 = zS²` for `S = 19/2, z = 3` (γ-5 step 410) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1457) |
| `singleClusterGSEnergyS_four_nineteen` / `singleClusterMaxEnergyS_four_nineteen` | **Spin-19/2 5-vertex star numerics**: `GS 4 19 = -741/2 = -S(1+zS)`, `Max 4 19 = 361 = zS²` for `S = 19/2, z = 4` (γ-5 step 411) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1458) |
| `singleClusterGSEnergyS_five_nineteen` / `singleClusterMaxEnergyS_five_nineteen` | **Spin-19/2 6-vertex star numerics**: `GS 5 19 = -1843/4 = -S(1+zS)`, `Max 5 19 = 1805/4 = zS²` for `S = 19/2, z = 5` (γ-5 step 412) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1459) |
| `singleClusterGSEnergyS_six_nineteen` / `singleClusterMaxEnergyS_six_nineteen` | **Spin-19/2 7-vertex star numerics**: `GS 6 19 = -551 = -S(1+zS)`, `Max 6 19 = 1083/2 = zS²` for `S = 19/2, z = 6` (γ-5 step 413) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1460) |
| `singleClusterGSEnergyS_one_twenty` / `singleClusterMaxEnergyS_one_twenty` | **Spin-10 dimer numerics**: `GS 1 20 = -110 = -S(S+1)`, `Max 1 20 = 100 = S²` for `S = 10` (γ-5 step 414) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1461) |
| `singleClusterGSEnergyS_two_twenty` / `singleClusterMaxEnergyS_two_twenty` | **Spin-10 3-vertex star numerics**: `GS 2 20 = -210 = -S(1+zS)`, `Max 2 20 = 200 = zS²` for `S = 10, z = 2` (γ-5 step 415) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1462) |
| `singleClusterGSEnergyS_three_twenty` / `singleClusterMaxEnergyS_three_twenty` | **Spin-10 4-vertex star numerics**: `GS 3 20 = -310 = -S(1+zS)`, `Max 3 20 = 300 = zS²` for `S = 10, z = 3` (γ-5 step 416) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1463) |
| `singleClusterGSEnergyS_four_twenty` / `singleClusterMaxEnergyS_four_twenty` | **Spin-10 5-vertex star numerics**: `GS 4 20 = -410 = -S(1+zS)`, `Max 4 20 = 400 = zS²` for `S = 10, z = 4` (γ-5 step 417) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1464) |
| `singleClusterGSEnergyS_five_twenty` / `singleClusterMaxEnergyS_five_twenty` | **Spin-10 6-vertex star numerics**: `GS 5 20 = -510 = -S(1+zS)`, `Max 5 20 = 500 = zS²` for `S = 10, z = 5` (γ-5 step 418) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1465) |
| `singleClusterGSEnergyS_six_twenty` / `singleClusterMaxEnergyS_six_twenty` | **Spin-10 7-vertex star numerics**: `GS 6 20 = -610 = -S(1+zS)`, `Max 6 20 = 600 = zS²` for `S = 10, z = 6` (γ-5 step 419) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1466) |
| `singleClusterGSEnergyS_one_twentyone` / `singleClusterMaxEnergyS_one_twentyone` | **Spin-21/2 dimer numerics**: `GS 1 21 = -483/4 = -S(S+1)`, `Max 1 21 = 441/4 = S²` for `S = 21/2` (γ-5 step 420) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1467) |
| `singleClusterGSEnergyS_two_twentyone` / `singleClusterMaxEnergyS_two_twentyone` | **Spin-21/2 3-vertex star numerics**: `GS 2 21 = -231 = -S(1+zS)`, `Max 2 21 = 441/2 = zS²` for `S = 21/2, z = 2` (γ-5 step 421) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1468) |
| `singleClusterGSEnergyS_three_twentyone` / `singleClusterMaxEnergyS_three_twentyone` | **Spin-21/2 4-vertex star numerics**: `GS 3 21 = -1365/4 = -S(1+zS)`, `Max 3 21 = 1323/4 = zS²` for `S = 21/2, z = 3` (γ-5 step 422) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1469) |
| `singleClusterGSEnergyS_four_twentyone` / `singleClusterMaxEnergyS_four_twentyone` | **Spin-21/2 5-vertex star numerics**: `GS 4 21 = -903/2 = -S(1+zS)`, `Max 4 21 = 441 = zS²` for `S = 21/2, z = 4` (γ-5 step 423) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1470) |
| `singleClusterGSEnergyS_five_twentyone` / `singleClusterMaxEnergyS_five_twentyone` | **Spin-21/2 6-vertex star numerics**: `GS 5 21 = -2247/4 = -S(1+zS)`, `Max 5 21 = 2205/4 = zS²` for `S = 21/2, z = 5` (γ-5 step 424) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1471) |
| `singleClusterGSEnergyS_six_twentyone` / `singleClusterMaxEnergyS_six_twentyone` | **Spin-21/2 7-vertex star numerics**: `GS 6 21 = -672 = -S(1+zS)`, `Max 6 21 = 1323/2 = zS²` for `S = 21/2, z = 6` (γ-5 step 425) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1472) |
| `singleClusterGSEnergyS_one_twentytwo` / `singleClusterMaxEnergyS_one_twentytwo` | **Spin-11 dimer numerics**: `GS 1 22 = -132 = -S(S+1)`, `Max 1 22 = 121 = S²` for `S = 11` (γ-5 step 426) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1473) |
| `singleClusterGSEnergyS_two_twentytwo` / `singleClusterMaxEnergyS_two_twentytwo` | **Spin-11 3-vertex star numerics**: `GS 2 22 = -253 = -S(1+zS)`, `Max 2 22 = 242 = zS²` for `S = 11, z = 2` (γ-5 step 427) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1474) |
| `singleClusterGSEnergyS_three_twentytwo` / `singleClusterMaxEnergyS_three_twentytwo` | **Spin-11 4-vertex star numerics**: `GS 3 22 = -374 = -S(1+zS)`, `Max 3 22 = 363 = zS²` for `S = 11, z = 3` (γ-5 step 428) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1475) |
| `singleClusterGSEnergyS_four_twentytwo` / `singleClusterMaxEnergyS_four_twentytwo` | **Spin-11 5-vertex star numerics**: `GS 4 22 = -495 = -S(1+zS)`, `Max 4 22 = 484 = zS²` for `S = 11, z = 4` (γ-5 step 429) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1476) |
| `singleClusterGSEnergyS_five_twentytwo` / `singleClusterMaxEnergyS_five_twentytwo` | **Spin-11 6-vertex star numerics**: `GS 5 22 = -616 = -S(1+zS)`, `Max 5 22 = 605 = zS²` for `S = 11, z = 5` (γ-5 step 430) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1477) |
| `singleClusterGSEnergyS_six_twentytwo` / `singleClusterMaxEnergyS_six_twentytwo` | **Spin-11 7-vertex star numerics**: `GS 6 22 = -737 = -S(1+zS)`, `Max 6 22 = 726 = zS²` for `S = 11, z = 6` (γ-5 step 431) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1478) |
| `singleClusterGSEnergyS_one_twentythree` / `singleClusterMaxEnergyS_one_twentythree` | **Spin-23/2 dimer numerics**: `GS 1 23 = -575/4 = -S(S+1)`, `Max 1 23 = 529/4 = S²` for `S = 23/2` (γ-5 step 432) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1479) |
| `singleClusterGSEnergyS_two_twentythree` / `singleClusterMaxEnergyS_two_twentythree` | **Spin-23/2 3-vertex star numerics**: `GS 2 23 = -276 = -S(1+zS)`, `Max 2 23 = 529/2 = zS²` for `S = 23/2, z = 2` (γ-5 step 433) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1480) |
| `singleClusterGSEnergyS_three_twentythree` / `singleClusterMaxEnergyS_three_twentythree` | **Spin-23/2 4-vertex star numerics**: `GS 3 23 = -1633/4 = -S(1+zS)`, `Max 3 23 = 1587/4 = zS²` for `S = 23/2, z = 3` (γ-5 step 434) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1481) |
| `singleClusterGSEnergyS_four_twentythree` / `singleClusterMaxEnergyS_four_twentythree` | **Spin-23/2 5-vertex star numerics**: `GS 4 23 = -1081/2 = -S(1+zS)`, `Max 4 23 = 529 = zS²` for `S = 23/2, z = 4` (γ-5 step 435) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1482) |
| `singleClusterGSEnergyS_five_twentythree` / `singleClusterMaxEnergyS_five_twentythree` | **Spin-23/2 6-vertex star numerics**: `GS 5 23 = -2691/4 = -S(1+zS)`, `Max 5 23 = 2645/4 = zS²` for `S = 23/2, z = 5` (γ-5 step 436) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1483) |
| `singleClusterGSEnergyS_six_twentythree` / `singleClusterMaxEnergyS_six_twentythree` | **Spin-23/2 7-vertex star numerics**: `GS 6 23 = -805 = -S(1+zS)`, `Max 6 23 = 1587/2 = zS²` for `S = 23/2, z = 6` (γ-5 step 437) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1484) |
| `singleClusterGSEnergyS_one_twentyfour` / `singleClusterMaxEnergyS_one_twentyfour` | **Spin-12 dimer numerics**: `GS 1 24 = -156 = -S(S+1)`, `Max 1 24 = 144 = S²` for `S = 12` (γ-5 step 438) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1485) |
| `singleClusterGSEnergyS_two_twentyfour` / `singleClusterMaxEnergyS_two_twentyfour` | **Spin-12 3-vertex star numerics**: `GS 2 24 = -300 = -S(1+zS)`, `Max 2 24 = 288 = zS²` for `S = 12, z = 2` (γ-5 step 439) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1486) |
| `singleClusterGSEnergyS_three_twentyfour` / `singleClusterMaxEnergyS_three_twentyfour` | **Spin-12 4-vertex star numerics**: `GS 3 24 = -444 = -S(1+zS)`, `Max 3 24 = 432 = zS²` for `S = 12, z = 3` (γ-5 step 440) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1487) |
| `singleClusterGSEnergyS_four_twentyfour` / `singleClusterMaxEnergyS_four_twentyfour` | **Spin-12 5-vertex star numerics**: `GS 4 24 = -588 = -S(1+zS)`, `Max 4 24 = 576 = zS²` for `S = 12, z = 4` (γ-5 step 441) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1488) |
| `singleClusterGSEnergyS_five_twentyfour` / `singleClusterMaxEnergyS_five_twentyfour` | **Spin-12 6-vertex star numerics**: `GS 5 24 = -732 = -S(1+zS)`, `Max 5 24 = 720 = zS²` for `S = 12, z = 5` (γ-5 step 442) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1489) |
| `singleClusterGSEnergyS_six_twentyfour` / `singleClusterMaxEnergyS_six_twentyfour` | **Spin-12 7-vertex star numerics**: `GS 6 24 = -876 = -S(1+zS)`, `Max 6 24 = 864 = zS²` for `S = 12, z = 6` (γ-5 step 443) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1490) |
| `singleClusterGSEnergyS_one_twentyfive` / `singleClusterMaxEnergyS_one_twentyfive` | **Spin-25/2 dimer numerics**: `GS 1 25 = -675/4 = -S(S+1)`, `Max 1 25 = 625/4 = S²` for `S = 25/2` (γ-5 step 444) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1491) |
| `singleClusterGSEnergyS_two_twentyfive` / `singleClusterMaxEnergyS_two_twentyfive` | **Spin-25/2 3-vertex star numerics**: `GS 2 25 = -325 = -S(1+zS)`, `Max 2 25 = 625/2 = zS²` for `S = 25/2, z = 2` (γ-5 step 445) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1492) |
| `singleClusterGSEnergyS_three_twentyfive` / `singleClusterMaxEnergyS_three_twentyfive` | **Spin-25/2 4-vertex star numerics**: `GS 3 25 = -1925/4 = -S(1+zS)`, `Max 3 25 = 1875/4 = zS²` for `S = 25/2, z = 3` (γ-5 step 446) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1493) |
| `singleClusterGSEnergyS_four_twentyfive` / `singleClusterMaxEnergyS_four_twentyfive` | **Spin-25/2 5-vertex star numerics**: `GS 4 25 = -1275/2 = -S(1+zS)`, `Max 4 25 = 625 = zS²` for `S = 25/2, z = 4` (γ-5 step 447) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1494) |
| `singleClusterGSEnergyS_five_twentyfive` / `singleClusterMaxEnergyS_five_twentyfive` | **Spin-25/2 6-vertex star numerics**: `GS 5 25 = -3175/4 = -S(1+zS)`, `Max 5 25 = 3125/4 = zS²` for `S = 25/2, z = 5` (γ-5 step 448) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1495) |
| `singleClusterGSEnergyS_six_twentyfive` / `singleClusterMaxEnergyS_six_twentyfive` | **Spin-25/2 7-vertex star numerics**: `GS 6 25 = -950 = -S(1+zS)`, `Max 6 25 = 1875/2 = zS²` for `S = 25/2, z = 6` (γ-5 step 449) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1496) |
| `singleClusterGSEnergyS_one_twentysix` / `singleClusterMaxEnergyS_one_twentysix` | **Spin-13 dimer numerics**: `GS 1 26 = -182 = -S(S+1)`, `Max 1 26 = 169 = S²` for `S = 13` (γ-5 step 450) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1497) |
| `singleClusterGSEnergyS_two_twentysix` / `singleClusterMaxEnergyS_two_twentysix` | **Spin-13 3-vertex star numerics**: `GS 2 26 = -351 = -S(1+zS)`, `Max 2 26 = 338 = zS²` for `S = 13, z = 2` (γ-5 step 451) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1498) |
| `singleClusterGSEnergyS_three_twentysix` / `singleClusterMaxEnergyS_three_twentysix` | **Spin-13 4-vertex star numerics**: `GS 3 26 = -520 = -S(1+zS)`, `Max 3 26 = 507 = zS²` for `S = 13, z = 3` (γ-5 step 452) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1499) |
| `singleClusterGSEnergyS_four_twentysix` / `singleClusterMaxEnergyS_four_twentysix` | **Spin-13 5-vertex star numerics**: `GS 4 26 = -689 = -S(1+zS)`, `Max 4 26 = 676 = zS²` for `S = 13, z = 4` (γ-5 step 453) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1500) |
| `singleClusterGSEnergyS_five_twentysix` / `singleClusterMaxEnergyS_five_twentysix` | **Spin-13 6-vertex star numerics**: `GS 5 26 = -858 = -S(1+zS)`, `Max 5 26 = 845 = zS²` for `S = 13, z = 5` (γ-5 step 454) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1501) |
| `singleClusterGSEnergyS_six_twentysix` / `singleClusterMaxEnergyS_six_twentysix` | **Spin-13 7-vertex star numerics**: `GS 6 26 = -1027 = -S(1+zS)`, `Max 6 26 = 1014 = zS²` for `S = 13, z = 6` (γ-5 step 455) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1502) |
| `singleClusterGSEnergyS_one_twentyseven` / `singleClusterMaxEnergyS_one_twentyseven` | **Spin-27/2 dimer numerics**: `GS 1 27 = -783/4 = -S(S+1)`, `Max 1 27 = 729/4 = S²` for `S = 27/2` (γ-5 step 456) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1503) |
| `singleClusterGSEnergyS_two_twentyseven` / `singleClusterMaxEnergyS_two_twentyseven` | **Spin-27/2 3-vertex star numerics**: `GS 2 27 = -378 = -S(1+zS)`, `Max 2 27 = 729/2 = zS²` for `S = 27/2, z = 2` (γ-5 step 457) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1504) |
| `singleClusterGSEnergyS_three_twentyseven` / `singleClusterMaxEnergyS_three_twentyseven` | **Spin-27/2 4-vertex star numerics**: `GS 3 27 = -2241/4 = -S(1+zS)`, `Max 3 27 = 2187/4 = zS²` for `S = 27/2, z = 3` (γ-5 step 458) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1505) |
| `singleClusterGSEnergyS_four_twentyseven` / `singleClusterMaxEnergyS_four_twentyseven` | **Spin-27/2 5-vertex star numerics**: `GS 4 27 = -1485/2 = -S(1+zS)`, `Max 4 27 = 729 = zS²` for `S = 27/2, z = 4` (γ-5 step 459) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1506) |
| `singleClusterGSEnergyS_five_twentyseven` / `singleClusterMaxEnergyS_five_twentyseven` | **Spin-27/2 6-vertex star numerics**: `GS 5 27 = -3699/4 = -S(1+zS)`, `Max 5 27 = 3645/4 = zS²` for `S = 27/2, z = 5` (γ-5 step 460) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1507) |
| `singleClusterGSEnergyS_six_twentyseven` / `singleClusterMaxEnergyS_six_twentyseven` | **Spin-27/2 7-vertex star numerics**: `GS 6 27 = -1107 = -S(1+zS)`, `Max 6 27 = 2187/2 = zS²` for `S = 27/2, z = 6` (γ-5 step 461) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1508) |
| `singleClusterGSEnergyS_one_twentyeight` / `singleClusterMaxEnergyS_one_twentyeight` | **Spin-14 dimer numerics**: `GS 1 28 = -210 = -S(S+1)`, `Max 1 28 = 196 = S²` for `S = 14` (γ-5 step 462) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR #1509) |
| `singleClusterGSEnergyS_two_twentyeight` / `singleClusterMaxEnergyS_two_twentyeight` | **Spin-14 3-vertex star numerics**: `GS 2 28 = -406 = -S(1+zS)`, `Max 2 28 = 392 = zS²` for `S = 14, z = 2` (γ-5 step 463) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
