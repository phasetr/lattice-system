...
| `singleClusterGSEnergyS_six_twentythree` / `singleClusterMaxEnergyS_six_twentythree` | **Spin-23/2 7-vertex star numerics**: `GS 6 23 = -805 = -S(1+zS)`, `Max 6 23 = 1587/2 = zS²` for `S = 23/2, z = 6` (γ-5 step 437) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
