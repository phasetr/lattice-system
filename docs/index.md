...
| `singleClusterGSEnergyS_five_two` / `singleClusterMaxEnergyS_five_two` | **Spin-1 6-vertex star numerics**: `GS 5 2 = -6 = -S(1+zS)`, `Max 5 2 = 5 = zS²` for `S = 1, z = 5` (γ-5 step 320) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
