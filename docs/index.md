...
| `singleClusterGSEnergyS_four_nineteen` / `singleClusterMaxEnergyS_four_nineteen` | **Spin-19/2 5-vertex star numerics**: `GS 4 19 = -741/2 = -S(1+zS)`, `Max 4 19 = 361 = zS²` for `S = 19/2, z = 4` (γ-5 step 411) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
