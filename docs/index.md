...
| `singleClusterGSEnergyS_six_twentytwo` / `singleClusterMaxEnergyS_six_twentytwo` | **Spin-11 7-vertex star numerics**: `GS 6 22 = -737 = -S(1+zS)`, `Max 6 22 = 726 = zS²` for `S = 11, z = 6` (γ-5 step 431) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
