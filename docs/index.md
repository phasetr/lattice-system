...
| `singleClusterGSEnergyS_one_eleven` / `singleClusterMaxEnergyS_one_eleven` | **Spin-11/2 dimer numerics**: `GS 1 11 = -143/4 = -S(S+1)`, `Max 1 11 = 121/4 = S²` for `S = 11/2` (γ-5 step 360 milestone) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
