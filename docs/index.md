...
| `singleClusterGSEnergyS_five_thirtythree` / `singleClusterMaxEnergyS_five_thirtythree` | **Spin-33/2 6-vertex star numerics**: `GS 5 33 = -5511/4 = -S(1+zS)`, `Max 5 33 = 5445/4 = zS²` for `S = 33/2, z = 5` (γ-5 step 496) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
