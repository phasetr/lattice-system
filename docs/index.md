...
| `singleClusterGSEnergyS_six_seven` / `singleClusterMaxEnergyS_six_seven` | **Spin-7/2 7-vertex star numerics**: `GS 6 7 = -77 = -S(1+zS)`, `Max 6 7 = 147/2 = zS²` for `S = 7/2, z = 6` (γ-5 step 347) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
