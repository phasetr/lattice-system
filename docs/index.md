...
| `singleClusterGSEnergyS_two_twentynine` / `singleClusterMaxEnergyS_two_twentynine` | **Spin-29/2 3-vertex star numerics**: `GS 2 29 = -435 = -S(1+zS)`, `Max 2 29 = 841/2 = zS²` for `S = 29/2, z = 2` (γ-5 step 469) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
