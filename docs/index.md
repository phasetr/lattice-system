...
| `singleClusterGSEnergyS_four_twentythree` / `singleClusterMaxEnergyS_four_twentythree` | **Spin-23/2 5-vertex star numerics**: `GS 4 23 = -1081/2 = -S(1+zS)`, `Max 4 23 = 529 = zS²` for `S = 23/2, z = 4` (γ-5 step 435) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
