...
| `singleClusterGSEnergyS_two_twenty` / `singleClusterMaxEnergyS_two_twenty` | **Spin-10 3-vertex star numerics**: `GS 2 20 = -210 = -S(1+zS)`, `Max 2 20 = 200 = zS²` for `S = 10, z = 2` (γ-5 step 415) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
