...
| `singleClusterGSEnergyS_six_four` / `singleClusterMaxEnergyS_six_four` | **Spin-2 7-vertex star numerics**: `GS 6 4 = -26 = -S(1+zS)`, `Max 6 4 = 24 = zS²` for `S = 2, z = 6` (γ-5 step 328) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
