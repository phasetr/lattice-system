...
| `singleClusterGSEnergyS_two_twentyone` / `singleClusterMaxEnergyS_two_twentyone` | **Spin-21/2 3-vertex star numerics**: `GS 2 21 = -231 = -S(1+zS)`, `Max 2 21 = 441/2 = zS²` for `S = 21/2, z = 2` (γ-5 step 421) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
