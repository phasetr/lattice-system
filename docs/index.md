...
| `singleClusterGSEnergyS_three_twentytwo` / `singleClusterMaxEnergyS_three_twentytwo` | **Spin-11 4-vertex star numerics**: `GS 3 22 = -374 = -S(1+zS)`, `Max 3 22 = 363 = zS²` for `S = 11, z = 3` (γ-5 step 428) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
