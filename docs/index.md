...
| `singleClusterGSEnergyS_three_eleven` / `singleClusterMaxEnergyS_three_eleven` | **Spin-11/2 4-vertex star numerics**: `GS 3 11 = -385/4 = -S(1+zS)`, `Max 3 11 = 363/4 = zS²` for `S = 11/2, z = 3` (γ-5 step 362) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
