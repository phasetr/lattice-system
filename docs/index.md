...
| `singleClusterGSEnergyS_three_thirteen` / `singleClusterMaxEnergyS_three_thirteen` | **Spin-13/2 4-vertex star numerics**: `GS 3 13 = -533/4 = -S(1+zS)`, `Max 3 13 = 507/4 = zS²` for `S = 13/2, z = 3` (γ-5 step 382) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
