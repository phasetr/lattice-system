...
| `singleClusterGSEnergyS_five_twentyfour` / `singleClusterMaxEnergyS_five_twentyfour` | **Spin-12 6-vertex star numerics**: `GS 5 24 = -732 = -S(1+zS)`, `Max 5 24 = 720 = zS²` for `S = 12, z = 5` (γ-5 step 442) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
