...
| `singleClusterGSEnergyS_six_twentyfive` / `singleClusterMaxEnergyS_six_twentyfive` | **Spin-25/2 7-vertex star numerics**: `GS 6 25 = -950 = -S(1+zS)`, `Max 6 25 = 1875/2 = zS²` for `S = 25/2, z = 6` (γ-5 step 449) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
