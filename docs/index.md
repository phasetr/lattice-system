...
| `singleClusterGSEnergyS_six_sixteen` / `singleClusterMaxEnergyS_six_sixteen` | **Spin-8 7-vertex star numerics**: `GS 6 16 = -392 = -S(1+zS)`, `Max 6 16 = 384 = zS²` for `S = 8, z = 6` (γ-5 step 395) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
