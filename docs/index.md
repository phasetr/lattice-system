...
| `singleClusterGSEnergyS_three_nine` / `singleClusterMaxEnergyS_three_nine` | **Spin-9/2 4-vertex star numerics**: `GS 3 9 = -261/4 = -S(1+zS)`, `Max 3 9 = 243/4 = zS²` for `S = 9/2, z = 3` (γ-5 step 350 milestone) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
