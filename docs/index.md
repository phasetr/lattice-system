...
| `singleClusterGSEnergyS_three_twentythree` / `singleClusterMaxEnergyS_three_twentythree` | **Spin-23/2 4-vertex star numerics**: `GS 3 23 = -1633/4 = -S(1+zS)`, `Max 3 23 = 1587/4 = zS²` for `S = 23/2, z = 3` (γ-5 step 434) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
