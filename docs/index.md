...
| `singleClusterGSEnergyS_three_twentyeight` / `singleClusterMaxEnergyS_three_twentyeight` | **Spin-14 4-vertex star numerics**: `GS 3 28 = -602 = -S(1+zS)`, `Max 3 28 = 588 = zS²` for `S = 14, z = 3` (γ-5 step 464) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
