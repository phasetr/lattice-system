...
| `basisVec_const_totalSpinHalfSquared_expectation` | **Spin-`1/2` constant-state `(Ŝ_tot)²` expectation**: `<basisVec(const s) \| (Ŝ_tot)² \| basisVec(const s)> = \|Λ\|·(\|Λ\|+2)/4` for any `s : Fin 2` (γ-4 step 201) | `Quantum/SpinDot/Hamiltonian.lean` |
