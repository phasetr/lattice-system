...
| `singleClusterGSEnergyS_one_twentyfive` / `singleClusterMaxEnergyS_one_twentyfive` | **Spin-25/2 dimer numerics**: `GS 1 25 = -675/4 = -S(S+1)`, `Max 1 25 = 625/4 = S²` for `S = 25/2` (γ-5 step 444) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
