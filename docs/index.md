...
| `singleClusterGSEnergyS_one_twentyfour` / `singleClusterMaxEnergyS_one_twentyfour` | **Spin-12 dimer numerics**: `GS 1 24 = -156 = -S(S+1)`, `Max 1 24 = 144 = S²` for `S = 12` (γ-5 step 438) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
