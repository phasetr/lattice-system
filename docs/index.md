...
| `singleClusterGSEnergyS_five_fifteen` / `singleClusterMaxEnergyS_five_fifteen` | **Spin-15/2 6-vertex star numerics**: `GS 5 15 = -1155/4 = -S(1+zS)`, `Max 5 15 = 1125/4 = zS²` for `S = 15/2, z = 5` (γ-5 step 389) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
