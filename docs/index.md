...
| `singleClusterHamiltonianS_eigenvalue_pentamer_gs` | **Pentamer GS-sector at GS energy**: for z=4, joint eigenvector at `Stot²·v=(3N/2)(3N/2+1)·v` (`s_tot=3N/2`) and 6-pair sum `(3N²/2)·v` (max leaf-spin `s_R=2N`) gives `H · v = singleClusterGSEnergyS 4 N · v = -N(2N+1)/2 · v` (γ-5 step 314) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
