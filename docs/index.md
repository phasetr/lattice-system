...
| `singleClusterGSEnergyS_four_eight` / `singleClusterMaxEnergyS_four_eight` | **Spin-4 5-vertex star numerics**: `GS 4 8 = -68 = -S(1+zS)`, `Max 4 8 = 64 = zS²` for `S = 4, z = 4` (γ-5 step 341) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
