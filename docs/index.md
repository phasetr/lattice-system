...
| `allAlignedStateS_span_le_magSubspaceS` | **All-aligned singleton span ⊆ magnetization subspace**: `span ℂ {allAlignedStateS V N c} ≤ magSubspaceS V N (|V|·N/2 - |V|·c.val)`. Direct from `allAlignedStateS_mem_magSubspaceS` (γ-4 step 195) | `Quantum/SpinS/AllAlignedStateMagSubspace.lean` |
