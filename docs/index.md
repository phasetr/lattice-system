...
| `singleClusterGSEnergyS_five_seventeen` / `singleClusterMaxEnergyS_five_seventeen` | **Spin-17/2 6-vertex star numerics**: `GS 5 17 = -1479/4 = -S(1+zS)`, `Max 5 17 = 1445/4 = zS²` for `S = 17/2, z = 5` (γ-5 step 400) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
