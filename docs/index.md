...
| `singleClusterGSEnergyS_two_thirtythree` / `singleClusterMaxEnergyS_two_thirtythree` | **Spin-33/2 3-vertex star numerics**: `GS 2 33 = -561 = -S(1+zS)`, `Max 2 33 = 1089/2 = zS²` for `S = 33/2, z = 2` (γ-5 step 493) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
