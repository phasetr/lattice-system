...
| `singleClusterGSEnergyS_five_seven` / `singleClusterMaxEnergyS_five_seven` | **Spin-7/2 6-vertex star numerics**: `GS 5 7 = -259/4 = -S(1+zS)`, `Max 5 7 = 245/4 = zS²` for `S = 7/2, z = 5` (γ-5 step 346) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
