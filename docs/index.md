...
| `singleClusterGSEnergyS_five_eleven` / `singleClusterMaxEnergyS_five_eleven` | **Spin-11/2 6-vertex star numerics**: `GS 5 11 = -627/4 = -S(1+zS)`, `Max 5 11 = 605/4 = zS²` for `S = 11/2, z = 5` (γ-5 step 364) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
