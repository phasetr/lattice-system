...
| `singleClusterGSEnergyS_two_twentythree` / `singleClusterMaxEnergyS_two_twentythree` | **Spin-23/2 3-vertex star numerics**: `GS 2 23 = -276 = -S(1+zS)`, `Max 2 23 = 529/2 = zS²` for `S = 23/2, z = 2` (γ-5 step 433) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
