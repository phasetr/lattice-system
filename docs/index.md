...
| `fermionNumber_pow_succ` / `fermionAnnihilation_mul_fermionCreation_pow_succ` | `n^(k+1) = n`; `(c · c†)^(k+1) = c · c†` for any `k : ℕ` (polynomial functional calculus on the idempotent projections) | `Fermion/ProjectionPow.lean` (PR #992) |
