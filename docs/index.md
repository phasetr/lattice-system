...
| `singleClusterGSEnergyS_four_two` / `singleClusterMaxEnergyS_four_two` | **Spin-1 5-vertex star numerics**: `GS 4 2 = -5 = -S(1+zS)`, `Max 4 2 = 4 = zS²` for `S = 1, z = 4` (γ-5 step 309) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
