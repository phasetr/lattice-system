...
| `singleClusterGSEnergyS_three_thirtyone` / `singleClusterMaxEnergyS_three_thirtyone` | **Spin-31/2 4-vertex star numerics**: `GS 3 31 = -2945/4 = -S(1+zS)`, `Max 3 31 = 2883/4 = zS²` for `S = 31/2, z = 3` (γ-5 step 482) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
