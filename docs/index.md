...
| `singleClusterGSEnergyS_two_four` / `singleClusterMaxEnergyS_two_four` | **Spin-2 3-vertex star numerics**: `GS 2 4 = -10 = -S(1+2S)`, `Max 2 4 = 8 = zS²` for `S = 2, z = 2` (γ-5 step 290) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
