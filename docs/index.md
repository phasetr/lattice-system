...
| `singleClusterGSEnergyS_six_thirtythree` / `singleClusterMaxEnergyS_six_thirtythree` | **Spin-33/2 7-vertex star numerics**: `GS 6 33 = -1650 = -S(1+zS)`, `Max 6 33 = 3267/2 = zS²` for `S = 33/2, z = 6` (γ-5 step 497) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
