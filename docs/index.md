...
| `singleClusterGSEnergyS_two_eighteen` / `singleClusterMaxEnergyS_two_eighteen` | **Spin-9 3-vertex star numerics**: `GS 2 18 = -171 = -S(1+zS)`, `Max 2 18 = 162 = zS²` for `S = 9, z = 2` (γ-5 step 403) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
