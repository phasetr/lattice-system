...
| `singleClusterGSEnergyS_four_ten` / `singleClusterMaxEnergyS_four_ten` | **Spin-5 5-vertex star numerics**: `GS 4 10 = -105 = -S(1+zS)`, `Max 4 10 = 100 = zS²` for `S = 5, z = 4` (γ-5 step 357) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
