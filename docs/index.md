...
| `singleClusterGSEnergyS_two_twentyfive` / `singleClusterMaxEnergyS_two_twentyfive` | **Spin-25/2 3-vertex star numerics**: `GS 2 25 = -325 = -S(1+zS)`, `Max 2 25 = 625/2 = zS²` for `S = 25/2, z = 2` (γ-5 step 445) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
