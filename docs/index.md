...
| `singleClusterGSEnergyS_four_twentytwo` / `singleClusterMaxEnergyS_four_twentytwo` | **Spin-11 5-vertex star numerics**: `GS 4 22 = -495 = -S(1+zS)`, `Max 4 22 = 484 = zS²` for `S = 11, z = 4` (γ-5 step 429) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
