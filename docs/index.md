...
| `singleClusterGSEnergyS_three_seven` / `singleClusterMaxEnergyS_three_seven` | **Spin-7/2 4-vertex star numerics**: `GS 3 7 = -161/4 = -S(1+zS)`, `Max 3 7 = 147/4 = zS²` for `S = 7/2, z = 3` (γ-5 step 344) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
