...
| `singleClusterGSEnergyS_two_fourteen` / `singleClusterMaxEnergyS_two_fourteen` | **Spin-7 3-vertex star numerics**: `GS 2 14 = -105 = -S(1+zS)`, `Max 2 14 = 98 = zS²` for `S = 7, z = 2` (γ-5 step 376) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
