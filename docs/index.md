...
| `singleClusterGSEnergyS_four_seven` / `singleClusterMaxEnergyS_four_seven` | **Spin-7/2 5-vertex star numerics**: `GS 4 7 = -105/2 = -S(1+zS)`, `Max 4 7 = 49 = zS²` for `S = 7/2, z = 4` (γ-5 step 345) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
