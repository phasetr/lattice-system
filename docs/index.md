...
| `singleClusterGSEnergyS_six_nine` / `singleClusterMaxEnergyS_six_nine` | **Spin-9/2 7-vertex star numerics**: `GS 6 9 = -126 = -S(1+zS)`, `Max 6 9 = 243/2 = zS²` for `S = 9/2, z = 6` (γ-5 step 353) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
