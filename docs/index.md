...
| `singleClusterGSEnergyS_one_twentythree` / `singleClusterMaxEnergyS_one_twentythree` | **Spin-23/2 dimer numerics**: `GS 1 23 = -575/4 = -S(S+1)`, `Max 1 23 = 529/4 = S²` for `S = 23/2` (γ-5 step 432) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
