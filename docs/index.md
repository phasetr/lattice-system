...
| `singleClusterGSEnergyS_three_seventeen` / `singleClusterMaxEnergyS_three_seventeen` | **Spin-17/2 4-vertex star numerics**: `GS 3 17 = -901/4 = -S(1+zS)`, `Max 3 17 = 867/4 = zS²` for `S = 17/2, z = 3` (γ-5 step 398) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
