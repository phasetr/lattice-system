...
| `singleClusterGSEnergyS_five_six` / `singleClusterMaxEnergyS_five_six` | **Spin-3 6-vertex star numerics**: `GS 5 6 = -48 = -S(1+zS)`, `Max 5 6 = 45 = zS²` for `S = 3, z = 5` (γ-5 step 335) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
