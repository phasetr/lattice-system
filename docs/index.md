...
| `singleClusterGSEnergyS_im_zero` / `singleClusterMaxEnergyS_im_zero` | **Energies are real**: imaginary parts of both named single-cluster energies vanish (γ-5 step 274) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
