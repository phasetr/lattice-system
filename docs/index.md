...
| `singleClusterGSEnergyS_four_twentyfour` / `singleClusterMaxEnergyS_four_twentyfour` | **Spin-12 5-vertex star numerics**: `GS 4 24 = -588 = -S(1+zS)`, `Max 4 24 = 576 = zS²` for `S = 12, z = 4` (γ-5 step 441) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
