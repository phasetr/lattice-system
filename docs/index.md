...
| `singleClusterGSEnergyS_six_thirteen` / `singleClusterMaxEnergyS_six_thirteen` | **Spin-13/2 7-vertex star numerics**: `GS 6 13 = -260 = -S(1+zS)`, `Max 6 13 = 507/2 = zS²` for `S = 13/2, z = 6` (γ-5 step 385) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
