...
| `singleClusterGSEnergyS_two_twentytwo` / `singleClusterMaxEnergyS_two_twentytwo` | **Spin-11 3-vertex star numerics**: `GS 2 22 = -253 = -S(1+zS)`, `Max 2 22 = 242 = zS²` for `S = 11, z = 2` (γ-5 step 427) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
