...
| `singleClusterGSEnergyS_one_twentytwo` / `singleClusterMaxEnergyS_one_twentytwo` | **Spin-11 dimer numerics**: `GS 1 22 = -132 = -S(S+1)`, `Max 1 22 = 121 = S²` for `S = 11` (γ-5 step 426) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
