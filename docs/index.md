...
| `neelStateOf_basisVec_quad_independent` | **Quadruple LI** (spin-`1/2`) of `{basisVec(0), basisVec(1), Φ_Néel(A), Φ_Néel(¬A)}` when `Λ` non-empty and both sublattices non-empty. Spin-`1/2` mirror of γ-4 step 181 (γ-4 step 182) | `Quantum/MarshallLiebMattis/SublatticeCasimirNeel.lean` |
