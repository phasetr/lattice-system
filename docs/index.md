...
| `singleClusterGSEnergyS_two_seven` / `singleClusterMaxEnergyS_two_seven` | **Spin-7/2 3-vertex star numerics**: `GS 2 7 = -28 = -S(1+zS)`, `Max 2 7 = 49/2 = zS²` for `S = 7/2, z = 2` (γ-5 step 338) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
