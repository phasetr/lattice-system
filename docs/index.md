...
| `singleClusterGSEnergyS_two_twentyeight` / `singleClusterMaxEnergyS_two_twentyeight` | **Spin-14 3-vertex star numerics**: `GS 2 28 = -406 = -S(1+zS)`, `Max 2 28 = 392 = zS²` for `S = 14, z = 2` (γ-5 step 463) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
