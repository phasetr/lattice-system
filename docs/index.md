...
| `singleClusterGSEnergyS_five_twentyseven` / `singleClusterMaxEnergyS_five_twentyseven` | **Spin-27/2 6-vertex star numerics**: `GS 5 27 = -3699/4 = -S(1+zS)`, `Max 5 27 = 3645/4 = zS²` for `S = 27/2, z = 5` (γ-5 step 460) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
