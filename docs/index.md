...
| `singleClusterGSEnergyS_one_two` / `singleClusterMaxEnergyS_one_two` / `singleClusterGSEnergyS_two_two` / `singleClusterMaxEnergyS_two_two` | **Spin-1 numerical values**: dimer `GS 1 2 = -2`, `Max 1 2 = 1`; 3-vertex star `GS 2 2 = -3`, `Max 2 2 = 2` (γ-5 step 282) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
