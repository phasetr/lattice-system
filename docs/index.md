...
| `singleClusterGSEnergyS_six_fourteen` / `singleClusterMaxEnergyS_six_fourteen` | **Spin-7 7-vertex star numerics**: `GS 6 14 = -301 = -S(1+zS)`, `Max 6 14 = 294 = zS²` for `S = 7, z = 6` (γ-5 step 380 milestone) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
