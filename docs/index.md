...
| `singleClusterGSEnergyS_five_four` / `singleClusterMaxEnergyS_five_four` | **Spin-2 6-vertex star numerics**: `GS 5 4 = -22 = -S(1+zS)`, `Max 5 4 = 20 = zS²` for `S = 2, z = 5` (γ-5 step 318) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
