...
| `singleClusterGSEnergyS_four_seventeen` / `singleClusterMaxEnergyS_four_seventeen` | **Spin-17/2 5-vertex star numerics**: `GS 4 17 = -595/2 = -S(1+zS)`, `Max 4 17 = 289 = zS²` for `S = 17/2, z = 4` (γ-5 step 399) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
