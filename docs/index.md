...
| `singleClusterGSEnergyS_six_twentysix` / `singleClusterMaxEnergyS_six_twentysix` | **Spin-13 7-vertex star numerics**: `GS 6 26 = -1027 = -S(1+zS)`, `Max 6 26 = 1014 = zS²` for `S = 13, z = 6` (γ-5 step 455) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
