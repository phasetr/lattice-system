...
| `singleClusterGSEnergyS_six_twentynine` / `singleClusterMaxEnergyS_six_twentynine` | **Spin-29/2 7-vertex star numerics**: `GS 6 29 = -1276 = -S(1+zS)`, `Max 6 29 = 2523/2 = zS²` for `S = 29/2, z = 6` (γ-5 step 473) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
