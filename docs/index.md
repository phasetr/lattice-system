...
| `singleClusterGSEnergyS_four_sixteen` / `singleClusterMaxEnergyS_four_sixteen` | **Spin-8 5-vertex star numerics**: `GS 4 16 = -264 = -S(1+zS)`, `Max 4 16 = 256 = zS²` for `S = 8, z = 4` (γ-5 step 393) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
