...
| `singleClusterGSEnergyS_three_twentyfour` / `singleClusterMaxEnergyS_three_twentyfour` | **Spin-12 4-vertex star numerics**: `GS 3 24 = -444 = -S(1+zS)`, `Max 3 24 = 432 = zS²` for `S = 12, z = 3` (γ-5 step 440) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
