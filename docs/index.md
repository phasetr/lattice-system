...
| `singleClusterGSEnergyS_five_twentysix` / `singleClusterMaxEnergyS_five_twentysix` | **Spin-13 6-vertex star numerics**: `GS 5 26 = -858 = -S(1+zS)`, `Max 5 26 = 845 = zS²` for `S = 13, z = 5` (γ-5 step 454) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
