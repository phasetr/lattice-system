...
| `singleClusterGSEnergyS_zero_right` / `singleClusterMaxEnergyS_zero_right` / `singleClusterMaxEnergyS_zero_left` | **Trivial edge cases**: `GS z 0 = 0` (spin-0), `Max z 0 = 0` (spin-0), `Max 0 N = 0` (single-site, no leaves) (γ-5 step 276) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
