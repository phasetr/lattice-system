...
| `singleClusterGSEnergyS_four_thirteen` / `singleClusterMaxEnergyS_four_thirteen` | **Spin-13/2 5-vertex star numerics**: `GS 4 13 = -351/2 = -S(1+zS)`, `Max 4 13 = 169 = zS²` for `S = 13/2, z = 4` (γ-5 step 383) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
