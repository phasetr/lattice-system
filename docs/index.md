...
| `singleClusterGSEnergyS_four_one` / `singleClusterMaxEnergyS_four_one` | **Spin-1/2 5-vertex star numerics**: `GS 4 1 = -3/2 = -S(1+zS)`, `Max 4 1 = 1 = zS²` for `S = 1/2, z = 4` (γ-5 step 308) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
