...
| `singleClusterGSEnergyS_two_ten` / `singleClusterMaxEnergyS_two_ten` | **Spin-5 3-vertex star numerics**: `GS 2 10 = -55 = -S(1+zS)`, `Max 2 10 = 50 = zS²` for `S = 5, z = 2` (γ-5 step 355) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
