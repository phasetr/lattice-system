...
| `singleClusterGSEnergyS_six_nineteen` / `singleClusterMaxEnergyS_six_nineteen` | **Spin-19/2 7-vertex star numerics**: `GS 6 19 = -551 = -S(1+zS)`, `Max 6 19 = 1083/2 = zS²` for `S = 19/2, z = 6` (γ-5 step 413) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
