...
| `singleClusterGSEnergyS_five_twenty` / `singleClusterMaxEnergyS_five_twenty` | **Spin-10 6-vertex star numerics**: `GS 5 20 = -510 = -S(1+zS)`, `Max 5 20 = 500 = zS²` for `S = 10, z = 5` (γ-5 step 418) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
