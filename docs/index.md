...
| `singleClusterGSEnergyS_six_twelve` / `singleClusterMaxEnergyS_six_twelve` | **Spin-6 7-vertex star numerics**: `GS 6 12 = -222 = -S(1+zS)`, `Max 6 12 = 216 = zS²` for `S = 6, z = 6` (γ-5 step 371) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
