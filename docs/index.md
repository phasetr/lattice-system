...
| `singleClusterGSEnergyS_three_fifteen` / `singleClusterMaxEnergyS_three_fifteen` | **Spin-15/2 4-vertex star numerics**: `GS 3 15 = -705/4 = -S(1+zS)`, `Max 3 15 = 675/4 = zS²` for `S = 15/2, z = 3` (γ-5 step 387) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
