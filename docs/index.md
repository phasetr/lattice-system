...
| `singleClusterGSEnergyS_five_five` / `singleClusterMaxEnergyS_five_five` | **Spin-5/2 6-vertex star numerics**: `GS 5 5 = -135/4 = -S(1+zS)`, `Max 5 5 = 125/4 = zS²` for `S = 5/2, z = 5` (γ-5 step 332) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
