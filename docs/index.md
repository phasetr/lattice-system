...
| `singleClusterGSEnergyS_four_twelve` / `singleClusterMaxEnergyS_four_twelve` | **Spin-6 5-vertex star numerics**: `GS 4 12 = -150 = -S(1+zS)`, `Max 4 12 = 144 = zS²` for `S = 6, z = 4` (γ-5 step 369) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
