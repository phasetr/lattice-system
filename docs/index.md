...
| `singleClusterGSEnergyS_three_thirty` / `singleClusterMaxEnergyS_three_thirty` | **Spin-15 4-vertex star numerics**: `GS 3 30 = -690 = -S(1+zS)`, `Max 3 30 = 675 = zS²` for `S = 15, z = 3` (γ-5 step 476) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
