...
| `singleClusterHamiltonianS_eigenvalue_leaf_singlet` | **Generic leaf-singlet decoupling (any z)**: if `Stot²·v = (N(N+2)/4)·v` (s_tot=N/2) and `leafSpinSSquared z N · v = 0` (leaves in singlet), then `H · v = 0`. Generalises γ-5 steps 296 (z=2), 321 (z=3), 322 (z=4) (γ-5 step 323) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
