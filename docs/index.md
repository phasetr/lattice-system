...
| `singleClusterGSEnergyS_six_three` / `singleClusterMaxEnergyS_six_three` | **Spin-3/2 7-vertex star numerics**: `GS 6 3 = -15 = -S(1+zS)`, `Max 6 3 = 27/2 = zS²` for `S = 3/2, z = 6` (γ-5 step 327) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
