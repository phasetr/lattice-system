...
| `singleClusterGSEnergyS_one_nine` / `singleClusterMaxEnergyS_one_nine` | **Spin-9/2 dimer numerics**: `GS 1 9 = -99/4 = -S(S+1)`, `Max 1 9 = 81/4 = S²` for `S = 9/2` (γ-5 step 348) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
