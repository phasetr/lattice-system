...
| `singleClusterGSEnergyS_one_four` / `singleClusterMaxEnergyS_one_four` | **Spin-2 dimer numerics**: `GS 1 4 = -6 = -S(S+1)`, `Max 1 4 = 4 = S²` for `S = 2` (γ-5 step 289) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
