...
| `singleClusterGSEnergyS_two_twentyfour` / `singleClusterMaxEnergyS_two_twentyfour` | **Spin-12 3-vertex star numerics**: `GS 2 24 = -300 = -S(1+zS)`, `Max 2 24 = 288 = zS²` for `S = 12, z = 2` (γ-5 step 439) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
