...
| `singleClusterGSEnergyS_six_eight` / `singleClusterMaxEnergyS_six_eight` | **Spin-4 7-vertex star numerics**: `GS 6 8 = -100 = -S(1+zS)`, `Max 6 8 = 96 = zS²` for `S = 4, z = 6` (γ-5 step 343) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
