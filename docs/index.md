...
| `singleClusterGSEnergyS_five_thirtytwo` / `singleClusterMaxEnergyS_five_thirtytwo` | **Spin-16 6-vertex star numerics**: `GS 5 32 = -1296 = -S(1+zS)`, `Max 5 32 = 1280 = zS²` for `S = 16, z = 5` (γ-5 step 490) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
