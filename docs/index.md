...
| `singleClusterGSEnergyS_six_thirtytwo` / `singleClusterMaxEnergyS_six_thirtytwo` | **Spin-16 7-vertex star numerics**: `GS 6 32 = -1552 = -S(1+zS)`, `Max 6 32 = 1536 = zS²` for `S = 16, z = 6` (γ-5 step 491) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
