...
| `singleClusterGSEnergyS_three_twentynine` / `singleClusterMaxEnergyS_three_twentynine` | **Spin-29/2 4-vertex star numerics**: `GS 3 29 = -2581/4 = -S(1+zS)`, `Max 3 29 = 2523/4 = zS²` for `S = 29/2, z = 3` (γ-5 step 470) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
