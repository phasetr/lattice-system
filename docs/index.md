...
| `singleClusterGSEnergyS_five_nineteen` / `singleClusterMaxEnergyS_five_nineteen` | **Spin-19/2 6-vertex star numerics**: `GS 5 19 = -1843/4 = -S(1+zS)`, `Max 5 19 = 1805/4 = zS²` for `S = 19/2, z = 5` (γ-5 step 412) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
