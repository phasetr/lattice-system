...
| `singleClusterGSEnergyS_one_twentyeight` / `singleClusterMaxEnergyS_one_twentyeight` | **Spin-14 dimer numerics**: `GS 1 28 = -210 = -S(S+1)`, `Max 1 28 = 196 = S²` for `S = 14` (γ-5 step 462) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
