...
| `singleClusterGSEnergyS_one_fourteen` / `singleClusterMaxEnergyS_one_fourteen` | **Spin-7 dimer numerics**: `GS 1 14 = -56 = -S(S+1)`, `Max 1 14 = 49 = S²` for `S = 7` (γ-5 step 373) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
