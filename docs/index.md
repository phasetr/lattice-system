...
| `singleClusterGSEnergyS_one_eq` / `singleClusterMaxEnergyS_one_eq` | **Dimer (z=1) closed forms**: `singleClusterGSEnergyS 1 N = −(N/2)(N/2+1) = −S(S+1)` (canonical singlet eigenvalue of `Ŝ_0·Ŝ_1`); `singleClusterMaxEnergyS 1 N = (N/2)² = S²` (canonical triplet eigenvalue) (γ-5 step 275) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
