...
| `singleClusterGSEnergyS_six_ten` / `singleClusterMaxEnergyS_six_ten` | **Spin-5 7-vertex star numerics**: `GS 6 10 = -155 = -S(1+zS)`, `Max 6 10 = 150 = zS²` for `S = 5, z = 6` (γ-5 step 359) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
