...
| `singleClusterGSEnergyS_six_one` / `singleClusterMaxEnergyS_six_one` | **Spin-1/2 7-vertex star numerics**: `GS 6 1 = -2 = -S(1+zS)`, `Max 6 1 = 3/2 = zS²` for `S = 1/2, z = 6` (γ-5 step 325) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
