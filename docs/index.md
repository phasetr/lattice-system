...
| `singleClusterGSEnergyS_four_twentyone` / `singleClusterMaxEnergyS_four_twentyone` | **Spin-21/2 5-vertex star numerics**: `GS 4 21 = -903/2 = -S(1+zS)`, `Max 4 21 = 441 = zS²` for `S = 21/2, z = 4` (γ-5 step 423) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
