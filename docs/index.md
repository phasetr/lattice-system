...
| `singleClusterGSEnergyS_four_twenty` / `singleClusterMaxEnergyS_four_twenty` | **Spin-10 5-vertex star numerics**: `GS 4 20 = -410 = -S(1+zS)`, `Max 4 20 = 400 = zS²` for `S = 10, z = 4` (γ-5 step 417) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
