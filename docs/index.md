...
| `singleClusterGSEnergyS_four_thirtythree` / `singleClusterMaxEnergyS_four_thirtythree` | **Spin-33/2 5-vertex star numerics**: `GS 4 33 = -2211/2 = -S(1+zS)`, `Max 4 33 = 1089 = zS²` for `S = 33/2, z = 4` (γ-5 step 495) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
