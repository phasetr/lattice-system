...
| `singleClusterGSEnergyS_two_thirtyone` / `singleClusterMaxEnergyS_two_thirtyone` | **Spin-31/2 3-vertex star numerics**: `GS 2 31 = -496 = -S(1+zS)`, `Max 2 31 = 961/2 = zS²` for `S = 31/2, z = 2` (γ-5 step 481) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
