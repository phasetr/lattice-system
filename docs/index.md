...
| `singleClusterGSEnergyS_one_fifteen` / `singleClusterMaxEnergyS_one_fifteen` | **Spin-15/2 dimer numerics**: `GS 1 15 = -255/4 = -S(S+1)`, `Max 1 15 = 225/4 = S²` for `S = 15/2` (γ-5 step 374) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
