...
| `singleClusterGSEnergyS_six_eleven` / `singleClusterMaxEnergyS_six_eleven` | **Spin-11/2 7-vertex star numerics**: `GS 6 11 = -187 = -S(1+zS)`, `Max 6 11 = 363/2 = zS²` for `S = 11/2, z = 6` (γ-5 step 365) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
