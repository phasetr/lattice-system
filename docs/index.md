...
| `singleClusterGSEnergyS_three_ten` / `singleClusterMaxEnergyS_three_ten` | **Spin-5 4-vertex star numerics**: `GS 3 10 = -80 = -S(1+zS)`, `Max 3 10 = 75 = zS²` for `S = 5, z = 3` (γ-5 step 356) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
