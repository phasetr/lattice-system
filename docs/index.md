...
| `singleClusterGSEnergyS_four_three` / `singleClusterMaxEnergyS_four_three` | **Spin-3/2 5-vertex star numerics**: `GS 4 3 = -21/2 = -S(1+zS)`, `Max 4 3 = 9 = zS²` for `S = 3/2, z = 4` (γ-5 step 324) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
