...
| `singleClusterGSEnergyS_one_eighteen` / `singleClusterMaxEnergyS_one_eighteen` | **Spin-9 dimer numerics**: `GS 1 18 = -90 = -S(S+1)`, `Max 1 18 = 81 = S²` for `S = 9` (γ-5 step 402) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
