...
| `singleClusterGSEnergyS_three_twenty` / `singleClusterMaxEnergyS_three_twenty` | **Spin-10 4-vertex star numerics**: `GS 3 20 = -310 = -S(1+zS)`, `Max 3 20 = 300 = zS²` for `S = 10, z = 3` (γ-5 step 416) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
