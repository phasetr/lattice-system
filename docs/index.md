...
| `singleClusterGSEnergyS_two_fifteen` / `singleClusterMaxEnergyS_two_fifteen` | **Spin-15/2 3-vertex star numerics**: `GS 2 15 = -120 = -S(1+zS)`, `Max 2 15 = 225/2 = zS²` for `S = 15/2, z = 2` (γ-5 step 386) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
