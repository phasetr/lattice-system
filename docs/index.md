...
| `singleClusterGSEnergyS_six_twentyone` / `singleClusterMaxEnergyS_six_twentyone` | **Spin-21/2 7-vertex star numerics**: `GS 6 21 = -672 = -S(1+zS)`, `Max 6 21 = 1323/2 = zS²` for `S = 21/2, z = 6` (γ-5 step 425) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
