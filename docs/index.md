...
| `singleClusterGSEnergyS_re_le_zero` / `singleClusterMaxEnergyS_re_nonneg` | **Energy real-part sign hygiene**: `Re(GS) ≤ 0` (AFM physical bound) and `0 ≤ Re(Max)` (extremal aligned-state eigenvalue is non-negative) (γ-5 step 272) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
