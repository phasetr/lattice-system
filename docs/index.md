...
| `singleClusterGSEnergyS_one_six` / `singleClusterMaxEnergyS_one_six` | **Spin-3 dimer numerics**: `GS 1 6 = -12 = -S(S+1)`, `Max 1 6 = 9 = S²` for `S = 3` (γ-5 step 300) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
