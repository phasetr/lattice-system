...
| `singleClusterGSEnergyS_one_three` / `singleClusterMaxEnergyS_one_three` / `singleClusterGSEnergyS_two_three` / `singleClusterMaxEnergyS_two_three` | **Spin-3/2 numerical values**: dimer `GS 1 3 = -15/4`, `Max 1 3 = 9/4`; 3-vertex star `GS 2 3 = -6`, `Max 2 3 = 9/2` (γ-5 step 284) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
