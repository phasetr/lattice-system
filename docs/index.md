...
| `singleClusterGSEnergyS_two_nine` / `singleClusterMaxEnergyS_two_nine` | **Spin-9/2 3-vertex star numerics**: `GS 2 9 = -45 = -S(1+zS)`, `Max 2 9 = 81/2 = zS²` for `S = 9/2, z = 2` (γ-5 step 349) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
