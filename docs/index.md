...
| `singleClusterGSEnergyS_four_four` / `singleClusterMaxEnergyS_four_four` | **Spin-2 5-vertex star numerics**: `GS 4 4 = -18 = -S(1+zS)`, `Max 4 4 = 16 = zS²` for `S = 2, z = 4` (γ-5 step 311) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
