...
| `singleClusterGSEnergyS_five_three` / `singleClusterMaxEnergyS_five_three` | **Spin-3/2 6-vertex star numerics**: `GS 5 3 = -51/4 = -S(1+zS)`, `Max 5 3 = 45/4 = zS²` for `S = 3/2, z = 5` (γ-5 step 317) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
