...
| `singleClusterGSEnergyS_two_seventeen` / `singleClusterMaxEnergyS_two_seventeen` | **Spin-17/2 3-vertex star numerics**: `GS 2 17 = -153 = -S(1+zS)`, `Max 2 17 = 289/2 = zS²` for `S = 17/2, z = 2` (γ-5 step 397) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
