...
| `singleClusterGSEnergyS_five_one` / `singleClusterMaxEnergyS_five_one` | **Spin-1/2 6-vertex star numerics**: `GS 5 1 = -7/4 = -S(1+zS)`, `Max 5 1 = 5/4 = zS²` for `S = 1/2, z = 5` (γ-5 step 310) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
