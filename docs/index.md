...
| `sublatticeSpinHalfOp{1,2,3}_isHermitian` | each sublattice spin operator is Hermitian. Sum of Hermitian operators is Hermitian (`Finset.sum_induction` + `Matrix.IsHermitian.add` + `isHermitian_zero`) | `Quantum/MarshallLiebMattis/SublatticeSpin.lean` |
