...
| `singleClusterGSEnergyS_one_seventeen` / `singleClusterMaxEnergyS_one_seventeen` | **Spin-17/2 dimer numerics**: `GS 1 17 = -323/4 = -S(S+1)`, `Max 1 17 = 289/4 = S²` for `S = 17/2` (γ-5 step 396) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
