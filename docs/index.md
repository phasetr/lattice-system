...
| `singleClusterGSEnergyS_three_five` / `singleClusterMaxEnergyS_three_five` | **Spin-5/2 4-vertex star numerics**: `GS 3 5 = -85/4 = -S(1+zS)`, `Max 3 5 = 75/4 = zS²` for `S = 5/2, z = 3` (γ-5 step 330) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
