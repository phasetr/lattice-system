...
| `singleClusterGSEnergyS_one_twentysix` / `singleClusterMaxEnergyS_one_twentysix` | **Spin-13 dimer numerics**: `GS 1 26 = -182 = -S(S+1)`, `Max 1 26 = 169 = S²` for `S = 13` (γ-5 step 450) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
