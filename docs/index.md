...
| `singleClusterGSEnergyS_two_six` / `singleClusterMaxEnergyS_two_six` | **Spin-3 3-vertex star numerics**: `GS 2 6 = -21 = -S(1+zS)`, `Max 2 6 = 18 = zS²` for `S = 3, z = 2` (γ-5 step 307) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
