...
| `singleClusterGSEnergyS_six_six` / `singleClusterMaxEnergyS_six_six` | **Spin-3 7-vertex star numerics**: `GS 6 6 = -57 = -S(1+zS)`, `Max 6 6 = 54 = zS²` for `S = 3, z = 6` (γ-5 step 336) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
