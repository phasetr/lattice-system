...
| `singleClusterGSEnergyS_two_twentyseven` / `singleClusterMaxEnergyS_two_twentyseven` | **Spin-27/2 3-vertex star numerics**: `GS 2 27 = -378 = -S(1+zS)`, `Max 2 27 = 729/2 = zS²` for `S = 27/2, z = 2` (γ-5 step 457) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
