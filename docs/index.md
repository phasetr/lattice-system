...
| `singleClusterGSEnergyS_one_ten` / `singleClusterMaxEnergyS_one_ten` | **Spin-5 dimer numerics**: `GS 1 10 = -30 = -S(S+1)`, `Max 1 10 = 25 = S²` for `S = 5` (γ-5 step 354) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
