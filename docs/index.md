...
| `singleClusterGSEnergyS_six_thirtyone` / `singleClusterMaxEnergyS_six_thirtyone` | **Spin-31/2 7-vertex star numerics**: `GS 6 31 = -1457 = -S(1+zS)`, `Max 6 31 = 2883/2 = zS²` for `S = 31/2, z = 6` (γ-5 step 485) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
