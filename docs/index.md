...
| `singleClusterGSEnergyS_four_five` / `singleClusterMaxEnergyS_four_five` | **Spin-5/2 5-vertex star numerics**: `GS 4 5 = -55/2 = -S(1+zS)`, `Max 4 5 = 25 = zS²` for `S = 5/2, z = 4` (γ-5 step 331) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
