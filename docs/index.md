...
| `singleClusterGSEnergyS_four_eleven` / `singleClusterMaxEnergyS_four_eleven` | **Spin-11/2 5-vertex star numerics**: `GS 4 11 = -253/2 = -S(1+zS)`, `Max 4 11 = 121 = zS²` for `S = 11/2, z = 4` (γ-5 step 363) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
