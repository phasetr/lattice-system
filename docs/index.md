...
| `singleClusterGSEnergyS_three_eight` / `singleClusterMaxEnergyS_three_eight` | **Spin-4 4-vertex star numerics**: `GS 3 8 = -52 = -S(1+zS)`, `Max 3 8 = 48 = zS²` for `S = 4, z = 3` (γ-5 step 340) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
