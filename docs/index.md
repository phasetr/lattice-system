...
| `singleClusterGSEnergyS_five_eight` / `singleClusterMaxEnergyS_five_eight` | **Spin-4 6-vertex star numerics**: `GS 5 8 = -84 = -S(1+zS)`, `Max 5 8 = 80 = zS²` for `S = 4, z = 5` (γ-5 step 342) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
