...
| `singleClusterGSEnergyS_three_six` / `singleClusterMaxEnergyS_three_six` | **Spin-3 4-vertex star numerics**: `GS 3 6 = -30 = -S(1+zS)`, `Max 3 6 = 27 = zS²` for `S = 3, z = 3` (γ-5 step 316) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
