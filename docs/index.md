...
| `singleClusterGSEnergyS_two_twelve` / `singleClusterMaxEnergyS_two_twelve` | **Spin-6 3-vertex star numerics**: `GS 2 12 = -78 = -S(1+zS)`, `Max 2 12 = 72 = zS²` for `S = 6, z = 2` (γ-5 step 367) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
