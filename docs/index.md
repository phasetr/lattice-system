...
| `singleClusterGSEnergyS_two_nineteen` / `singleClusterMaxEnergyS_two_nineteen` | **Spin-19/2 3-vertex star numerics**: `GS 2 19 = -190 = -S(1+zS)`, `Max 2 19 = 361/2 = zS²` for `S = 19/2, z = 2` (γ-5 step 409) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
