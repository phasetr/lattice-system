...
| `singleClusterGSEnergyS_five_twentyone` / `singleClusterMaxEnergyS_five_twentyone` | **Spin-21/2 6-vertex star numerics**: `GS 5 21 = -2247/4 = -S(1+zS)`, `Max 5 21 = 2205/4 = zS²` for `S = 21/2, z = 5` (γ-5 step 424) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
