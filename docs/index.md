...
| `singleClusterGSEnergyS_two_eleven` / `singleClusterMaxEnergyS_two_eleven` | **Spin-11/2 3-vertex star numerics**: `GS 2 11 = -66 = -S(1+zS)`, `Max 2 11 = 121/2 = zS²` for `S = 11/2, z = 2` (γ-5 step 361) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
