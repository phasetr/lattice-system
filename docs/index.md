...
| `singleClusterGSEnergyS_two_thirty` / `singleClusterMaxEnergyS_two_thirty` | **Spin-15 3-vertex star numerics**: `GS 2 30 = -465 = -S(1+zS)`, `Max 2 30 = 450 = zS²` for `S = 15, z = 2` (γ-5 step 475) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
