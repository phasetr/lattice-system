...
| `singleClusterGSEnergyS_three_twentyone` / `singleClusterMaxEnergyS_three_twentyone` | **Spin-21/2 4-vertex star numerics**: `GS 3 21 = -1365/4 = -S(1+zS)`, `Max 3 21 = 1323/4 = zS²` for `S = 21/2, z = 3` (γ-5 step 422) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
