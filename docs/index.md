...
| `singleClusterGSEnergyS_three_two` / `singleClusterMaxEnergyS_three_two` | **Spin-1 4-vertex star numerics**: `GS 3 2 = -4 = -S(1+zS)`, `Max 3 2 = 3 = zS²` for `S = 1, z = 3` (γ-5 step 297) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
