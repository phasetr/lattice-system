...
| `singleClusterGSEnergyS_four_thirtytwo` / `singleClusterMaxEnergyS_four_thirtytwo` | **Spin-16 5-vertex star numerics**: `GS 4 32 = -1040 = -S(1+zS)`, `Max 4 32 = 1024 = zS²` for `S = 16, z = 4` (γ-5 step 489) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
