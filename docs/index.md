...
| `singleClusterGSEnergyS_five_nine` / `singleClusterMaxEnergyS_five_nine` | **Spin-9/2 6-vertex star numerics**: `GS 5 9 = -423/4 = -S(1+zS)`, `Max 5 9 = 405/4 = zS²` for `S = 9/2, z = 5` (γ-5 step 352) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
