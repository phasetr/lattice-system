...
| `singleClusterGSEnergyS_four_six` / `singleClusterMaxEnergyS_four_six` | **Spin-3 5-vertex star numerics**: `GS 4 6 = -39 = -S(1+zS)`, `Max 4 6 = 36 = zS²` for `S = 3, z = 4` (γ-5 step 334) | `Quantum/SpinS/SingleClusterHamiltonian.lean` (PR pending) |
