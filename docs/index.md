...
| `singleClusterGSEnergyS_five_thirtyone` / `singleClusterMaxEnergyS_five_thirtyone` | **Spin-31/2 6-vertex star numerics**: `GS 5 31 = -4867/4 = -S(1+zS)`, `Max 5 31 = 4805/4 = zS²` for `S = 31/2, z = 5` (γ-5 step 484) | `Quantum/SpinS/SingleClusterHamiltonianNumerics.lean` (PR pending) |
