...
unknown record-like containers on projections. The unique typed generated
container is exact catalogue-derived output: additive tags, text, or whitespace
inside it are invalid, while prose outside the marker remains hand-written.
They reject an
