...
superseding record IDs, and last-present commit, so the published route keeps
resolving after the declaration leaves the Lean tree. Retired records are
excluded from the generated Lean assertion file.
